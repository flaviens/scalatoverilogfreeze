...
module MultiWakeupQueue_2(
  ...
  `ifndef SYNTHESIS
    wire [1:0] _GEN = 2'({1'h0, allValidVec_1} + {1'h0, _pipes_0_io_deq_valid});
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        lastConnect_bits_pdestCopy_0 = _RANDOM[4'h8][7:0];
        lastConnect_bits_pdestCopy_1 = _RANDOM[4'h8][15:8];
        lastConnect_bits_pdestCopy_2 = _RANDOM[4'h8][23:16];
        lastConnect_bits_pdestCopy_3 = _RANDOM[4'h8][31:24];
        lastConnect_bits_pdestCopy_4 = _RANDOM[4'h9][7:0];
        lastConnect_bits_pdestCopy_5 = _RANDOM[4'h9][15:8];
        lastConnect_bits_pdestCopy_6 = _RANDOM[4'h9][23:16];
        lastConnect_bits_rfWenCopy_0 = _RANDOM[4'h9][24];
        lastConnect_bits_rfWenCopy_1 = _RANDOM[4'h9][25];
        lastConnect_bits_rfWenCopy_2 = _RANDOM[4'h9][26];
        lastConnect_bits_rfWenCopy_3 = _RANDOM[4'h9][27];
        lastConnect_bits_rfWenCopy_4 = _RANDOM[4'h9][28];
        lastConnect_bits_rfWenCopy_5 = _RANDOM[4'h9][29];
        lastConnect_bits_rfWenCopy_6 = _RANDOM[4'h9][30];
        lastConnect_bits_loadDependencyCopy_0_0 = _RANDOM[4'hA][28:27];
        lastConnect_bits_loadDependencyCopy_0_1 = _RANDOM[4'hA][30:29];
        lastConnect_bits_loadDependencyCopy_0_2 = {_RANDOM[4'hA][31], _RANDOM[4'hB][0]};
        lastConnect_bits_loadDependencyCopy_1_0 = _RANDOM[4'hB][2:1];
        lastConnect_bits_loadDependencyCopy_1_1 = _RANDOM[4'hB][4:3];
        lastConnect_bits_loadDependencyCopy_1_2 = _RANDOM[4'hB][6:5];
        lastConnect_bits_loadDependencyCopy_2_0 = _RANDOM[4'hB][8:7];
        lastConnect_bits_loadDependencyCopy_2_1 = _RANDOM[4'hB][10:9];
        lastConnect_bits_loadDependencyCopy_2_2 = _RANDOM[4'hB][12:11];
        lastConnect_bits_loadDependencyCopy_3_0 = _RANDOM[4'hB][14:13];
        lastConnect_bits_loadDependencyCopy_3_1 = _RANDOM[4'hB][16:15];
        lastConnect_bits_loadDependencyCopy_3_2 = _RANDOM[4'hB][18:17];
        lastConnect_bits_loadDependencyCopy_4_0 = _RANDOM[4'hB][20:19];
        lastConnect_bits_loadDependencyCopy_4_1 = _RANDOM[4'hB][22:21];
        lastConnect_bits_loadDependencyCopy_4_2 = _RANDOM[4'hB][24:23];
        lastConnect_bits_loadDependencyCopy_5_0 = _RANDOM[4'hB][26:25];
        lastConnect_bits_loadDependencyCopy_5_1 = _RANDOM[4'hB][28:27];
        lastConnect_bits_loadDependencyCopy_5_2 = _RANDOM[4'hB][30:29];
        lastConnect_bits_loadDependencyCopy_6_0 = {_RANDOM[4'hB][31], _RANDOM[4'hC][0]};
        lastConnect_bits_loadDependencyCopy_6_1 = _RANDOM[4'hC][2:1];
        lastConnect_bits_loadDependencyCopy_6_2 = _RANDOM[4'hC][4:3];
        lastConnect_bits_pdest = _RANDOM[4'hC][12:5];
        lastConnect_bits_rfWen = _RANDOM[4'hC][18];
        lastConnect_bits_vecWen = _RANDOM[4'hC][20];
        lastConnect_bits_v0Wen = _RANDOM[4'hC][21];
        lastConnect_bits_loadDependency_0 = _RANDOM[4'hF][5:4];
        lastConnect_bits_loadDependency_1 = _RANDOM[4'hF][7:6];
        lastConnect_bits_loadDependency_2 = _RANDOM[4'hF][9:8];
      `endif // RANDOMIZE_REG_INIT
    end // initial
