...
module DuplicatedTagArray(
  ...
  wire        _array_3_io_read_ready;
  wire        _array_2_io_read_ready;
  wire        _array_1_io_read_ready;
  wire        _array_0_io_read_ready;
  ...
  wire [63:0] _GEN =
    64'({63'h0, _array_3_io_read_ready & io_read_3_valid}
        + 64'({63'h0, _array_2_io_read_ready & io_read_2_valid}
              + {62'h0,
                 2'({1'h0, _array_1_io_read_ready & io_read_1_valid}
                    + {1'h0, _array_0_io_read_ready & io_read_0_valid})}));
  ...
  assign io_read_3_ready = _array_3_io_read_ready;
