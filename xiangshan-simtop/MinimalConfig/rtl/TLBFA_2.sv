...
module TLBFA_2(
  ...
  wire             _GEN_18 =
    ~(~io_r_resp_1_valid_REG | _GEN_17 == 3'h0 | _GEN_17 == 3'h1);
  wire [3:0]       _io_access_1_touch_ways_valid_T =
    {hitVecReg_1_0, hitVecReg_1_1, hitVecReg_1_2, hitVecReg_1_3};
  reg  [37:0]      reqVpn_1;
  wire             _GEN_19 = io_w_valid & io_w_bits_wayIdx == 2'h0;
  wire             _GEN_20 = io_w_valid & io_w_bits_wayIdx == 2'h1;
  wire             _GEN_21 = io_w_valid & io_w_bits_wayIdx == 2'h2;
  wire             _GEN_22 = io_w_valid & (&io_w_bits_wayIdx);
  ...
  wire [7:0]       _GEN_23 = {5'h0, io_w_bits_data_s2_entry_tag[2:0]};
  ...
  wire [7:0]       _w_hit_vec_T_3 = 8'h1 << _GEN_23;
  ...
  wire [7:0]       _w_hit_vec_pteidx_hit_T_12 =
    {entries_1_pteidx_7,
     ...
     entries_1_pteidx_1,
     entries_1_pteidx_0};
  wire [7:0]       _w_hit_vec_T_64 = 8'h1 << _GEN_23;
  ...
  wire [7:0]       _w_hit_vec_pteidx_hit_T_20 =
    {entries_2_pteidx_7,
     ...
     entries_2_pteidx_1,
     entries_2_pteidx_0};
  wire [7:0]       _w_hit_vec_T_125 = 8'h1 << _GEN_23;
  ...
  wire [7:0]       _w_hit_vec_pteidx_hit_T_28 =
    {entries_3_pteidx_7,
     ...
     entries_3_pteidx_1,
     entries_3_pteidx_0};
  wire [7:0]       _w_hit_vec_T_186 = 8'h1 << _GEN_23;
  ...
  wire             _GEN_25 = io_w_valid & (|_GEN_24);
  `ifndef SYNTHESIS
  ...
  wire             _GEN_26 = 1'(io_r_resp_0_valid_REG + io_r_resp_1_valid_REG);
  ...
  wire             _GEN_27 = 1'(_perfEvents_T_6 + _perfEvents_T_4);
  wire [3:0]       _GEN_28 = 4'h1 << io_access_0_touch_ways_bits_0;
  wire [3:0]       _GEN_29 = 4'h1 << io_access_1_touch_ways_bits_0;
  wire             _GEN_30 =
    1'((_perfEvents_T_6 & _GEN_28[0]) + (_perfEvents_T_4 & _GEN_29[0]));
  wire             _GEN_31 =
    1'((_perfEvents_T_6 & _GEN_28[1]) + (_perfEvents_T_4 & _GEN_29[1]));
  wire             _GEN_32 =
    1'((_perfEvents_T_6 & _GEN_28[2]) + (_perfEvents_T_4 & _GEN_29[2]));
  wire             _GEN_33 =
    1'((_perfEvents_T_6 & _GEN_28[3]) + (_perfEvents_T_4 & _GEN_29[3]));
  wire             sfence_valid =
    io_sfence_valid & ~io_sfence_bits_hg & ~io_sfence_bits_hv;
  wire             _v_0_T_39 = entries_0_asid == io_sfence_bits_id;
  wire             _GEN_34 = _GEN_0[io_sfence_bits_addr[14:12]];
  wire             _GEN_35 = _GEN_1[io_sfence_bits_addr[14:12]];
  wire             _v_1_T_39 = entries_1_asid == io_sfence_bits_id;
  wire             _GEN_36 = _GEN_3[io_sfence_bits_addr[14:12]];
  wire             _GEN_37 = _GEN_4[io_sfence_bits_addr[14:12]];
  wire             _v_2_T_39 = entries_2_asid == io_sfence_bits_id;
  wire             _GEN_38 = _GEN_6[io_sfence_bits_addr[14:12]];
  wire             _GEN_39 = _GEN_7[io_sfence_bits_addr[14:12]];
  wire             _v_3_T_39 = entries_3_asid == io_sfence_bits_id;
  wire             _GEN_40 = _GEN_9[io_sfence_bits_addr[14:12]];
  wire             _GEN_41 = _GEN_10[io_sfence_bits_addr[14:12]];
  wire             _GEN_42 =
                       ...
                       : io_sfence_bits_rs2
                           ...
                           : v_0
                             & ~((_v_0_T_39 | entries_0_perm_g)
                                 ...
                                 & (~io_csr_priv_virt | _v_0_T_41)
                                 & (~(io_csr_priv_virt & ~(|entries_0_level)
                                      & ~entries_0_n) | _GEN_34) & ~entries_0_perm_g))
                  : _GEN_19 | v_0;
      v_1 <=
        hfenceg_valid
          ? (io_sfence_bits_rs2
                       ...
                       : io_sfence_bits_rs2
                           ...
                           : v_1
                             & ~((_v_1_T_39 | entries_1_perm_g)
                                 ...
                                 & (~io_csr_priv_virt | _v_1_T_41)
                                 & (~(io_csr_priv_virt & ~(|entries_1_level)
                                      & ~entries_1_n) | _GEN_36) & ~entries_1_perm_g))
                  : _GEN_20 | v_1;
      v_2 <=
        hfenceg_valid
          ? (io_sfence_bits_rs2
                       ...
                       : io_sfence_bits_rs2
                           ...
                           : v_2
                             & ~((_v_2_T_39 | entries_2_perm_g)
                                 ...
                                 & (~io_csr_priv_virt | _v_2_T_41)
                                 & (~(io_csr_priv_virt & ~(|entries_2_level)
                                      & ~entries_2_n) | _GEN_38) & ~entries_2_perm_g))
                  : _GEN_21 | v_2;
      v_3 <=
        hfenceg_valid
          ? (io_sfence_bits_rs2
                       ...
                       : io_sfence_bits_rs2
                           ...
                           : v_3
                             & ~((_v_3_T_39 | entries_3_perm_g)
                                 ...
                                 & (~io_csr_priv_virt | _v_3_T_41)
                                 & (~(io_csr_priv_virt & ~(|entries_3_level)
                                      & ~entries_3_n) | _GEN_40) & ~entries_3_perm_g))
                  : _GEN_22 | v_3;
    end
    ...
    io_w_bits_data_s2xlate != 2'h3
      ...
      : (io_w_bits_data_s1_pf | io_w_bits_data_s1_af) & ~_allStage_level_T_3
        ...
        & ~((io_w_bits_data_s1_entry_perm_r | io_w_bits_data_s1_entry_perm_x
          ...
          ? io_w_bits_data_s1_entry_level
          : s2_exception & _allStage_level_T_3 ? 2'h3 : _GEN_43[io_w_bits_data_s2xlate];
  ...
  wire [32:0]      _entries_ppn_T_3 =
    _inner_n_T_4 | _entries_ppn_T_1
      ...
      : _GEN_45[io_w_bits_data_s2_entry_level];
  wire             _GEN_46 = _inner_n_T_4 | _entries_ppn_T_1;
  wire [2:0]       _GEN_47 =
    _GEN_46 ? io_w_bits_data_s1_ppn_low_0 : _GEN_44[io_w_bits_data_s2_entry_level][2:0];
  wire [2:0]       _GEN_48 =
    _GEN_46 ? io_w_bits_data_s1_ppn_low_1 : _GEN_44[io_w_bits_data_s2_entry_level][2:0];
  wire [2:0]       _GEN_49 =
    _GEN_46 ? io_w_bits_data_s1_ppn_low_2 : _GEN_44[io_w_bits_data_s2_entry_level][2:0];
  wire [2:0]       _GEN_50 =
    _GEN_46 ? io_w_bits_data_s1_ppn_low_3 : _GEN_44[io_w_bits_data_s2_entry_level][2:0];
  wire [2:0]       _GEN_51 =
    _GEN_46 ? io_w_bits_data_s1_ppn_low_4 : _GEN_44[io_w_bits_data_s2_entry_level][2:0];
  wire [2:0]       _GEN_52 =
    _GEN_46 ? io_w_bits_data_s1_ppn_low_5 : _GEN_44[io_w_bits_data_s2_entry_level][2:0];
  wire [2:0]       _GEN_53 =
    _GEN_46 ? io_w_bits_data_s1_ppn_low_6 : _GEN_44[io_w_bits_data_s2_entry_level][2:0];
  wire [2:0]       _GEN_54 =
    _GEN_46 ? io_w_bits_data_s1_ppn_low_7 : _GEN_44[io_w_bits_data_s2_entry_level][2:0];
  wire [3:0]       _GEN_55 =
    {{io_w_bits_data_s1_entry_n & (|io_w_bits_data_s2_entry_level)
     ...
     {io_w_bits_data_s1_entry_n}};
  wire             isSuperPage = (|inner_level) | _GEN_55[io_w_bits_data_s2xlate];
  wire [7:0]       _GEN_56 = 8'h1 << io_w_bits_data_s2_entry_tag[2:0];
  wire             _GEN_57 =
    isSuperPage | (_entries_vmid_T ? _GEN_56[0] : io_w_bits_data_s1_valididx_0);
  wire             _GEN_58 =
    isSuperPage | (_entries_vmid_T ? _GEN_56[1] : io_w_bits_data_s1_valididx_1);
  wire             _GEN_59 =
    isSuperPage | (_entries_vmid_T ? _GEN_56[2] : io_w_bits_data_s1_valididx_2);
  wire             _GEN_60 =
    isSuperPage | (_entries_vmid_T ? _GEN_56[3] : io_w_bits_data_s1_valididx_3);
  wire             _GEN_61 =
    isSuperPage | (_entries_vmid_T ? _GEN_56[4] : io_w_bits_data_s1_valididx_4);
  wire             _GEN_62 =
    isSuperPage | (_entries_vmid_T ? _GEN_56[5] : io_w_bits_data_s1_valididx_5);
  wire             _GEN_63 =
    isSuperPage | (_entries_vmid_T ? _GEN_56[6] : io_w_bits_data_s1_valididx_6);
  wire             _GEN_64 =
    isSuperPage | (_entries_vmid_T ? _GEN_56[7] : io_w_bits_data_s1_valididx_7);
  wire             _GEN_65 = _entries_vmid_T ? _GEN_56[0] : io_w_bits_data_s1_pteidx_0;
  wire             _GEN_66 = _entries_vmid_T ? _GEN_56[1] : io_w_bits_data_s1_pteidx_1;
  wire             _GEN_67 = _entries_vmid_T ? _GEN_56[2] : io_w_bits_data_s1_pteidx_2;
  wire             _GEN_68 = _entries_vmid_T ? _GEN_56[3] : io_w_bits_data_s1_pteidx_3;
  wire             _GEN_69 = _entries_vmid_T ? _GEN_56[4] : io_w_bits_data_s1_pteidx_4;
  wire             _GEN_70 = _entries_vmid_T ? _GEN_56[5] : io_w_bits_data_s1_pteidx_5;
  wire             _GEN_71 = _entries_vmid_T ? _GEN_56[6] : io_w_bits_data_s1_pteidx_6;
  wire             _GEN_72 = _entries_vmid_T ? _GEN_56[7] : io_w_bits_data_s1_pteidx_7;
  ...
  always @(posedge clock) begin
    if (_GEN_19) begin
      ...
      entries_0_n <= _GEN_55[io_w_bits_data_s2xlate];
      ...
      entries_0_ppn_low_0 <= _GEN_47;
      entries_0_ppn_low_1 <= _GEN_48;
      entries_0_ppn_low_2 <= _GEN_49;
      entries_0_ppn_low_3 <= _GEN_50;
      entries_0_ppn_low_4 <= _GEN_51;
      entries_0_ppn_low_5 <= _GEN_52;
      entries_0_ppn_low_6 <= _GEN_53;
      entries_0_ppn_low_7 <= _GEN_54;
    ...
    if (_GEN_20) begin
      ...
      entries_1_n <= _GEN_55[io_w_bits_data_s2xlate];
      ...
      entries_1_ppn_low_0 <= _GEN_47;
      entries_1_ppn_low_1 <= _GEN_48;
      entries_1_ppn_low_2 <= _GEN_49;
      entries_1_ppn_low_3 <= _GEN_50;
      entries_1_ppn_low_4 <= _GEN_51;
      entries_1_ppn_low_5 <= _GEN_52;
      entries_1_ppn_low_6 <= _GEN_53;
      entries_1_ppn_low_7 <= _GEN_54;
    ...
    if (_GEN_21) begin
      ...
      entries_2_n <= _GEN_55[io_w_bits_data_s2xlate];
      ...
      entries_2_ppn_low_0 <= _GEN_47;
      entries_2_ppn_low_1 <= _GEN_48;
      entries_2_ppn_low_2 <= _GEN_49;
      entries_2_ppn_low_3 <= _GEN_50;
      entries_2_ppn_low_4 <= _GEN_51;
      entries_2_ppn_low_5 <= _GEN_52;
      entries_2_ppn_low_6 <= _GEN_53;
      entries_2_ppn_low_7 <= _GEN_54;
    ...
    if (_GEN_22) begin
      ...
      entries_3_n <= _GEN_55[io_w_bits_data_s2xlate];
      ...
      entries_3_ppn_low_0 <= _GEN_47;
      entries_3_ppn_low_1 <= _GEN_48;
      entries_3_ppn_low_2 <= _GEN_49;
      entries_3_ppn_low_3 <= _GEN_50;
      entries_3_ppn_low_4 <= _GEN_51;
      entries_3_ppn_low_5 <= _GEN_52;
      entries_3_ppn_low_6 <= _GEN_53;
      entries_3_ppn_low_7 <= _GEN_54;
       ...
       ? {entries_0_ppn[32:24],
          ...
          (|entries_0_level)
            ...
            : entries_0_n
                ...
                : {entries_0_ppn[5:0], _GEN_13[reqVpn[2:0]]}}
       : 36'h0)
    | (hitVecReg_1
         ? {entries_1_ppn[32:24],
            ...
            (|entries_1_level)
              ...
              : entries_1_n
                  ...
                  : {entries_1_ppn[5:0], _GEN_14[reqVpn[2:0]]}}
         : 36'h0)
    | (hitVecReg_2
         ? {entries_2_ppn[32:24],
            ...
            (|entries_2_level)
              ...
              : entries_2_n
                  ...
                  : {entries_2_ppn[5:0], _GEN_15[reqVpn[2:0]]}}
         : 36'h0)
    | (hitVecReg_3
         ? {entries_3_ppn[32:24],
            ...
            (|entries_3_level)
              ...
              : entries_3_n
                  ...
                  : {entries_3_ppn[5:0], _GEN_16[reqVpn[2:0]]}}
         : 36'h0);
       ...
       ? {entries_0_ppn[32:24],
          ...
          (|entries_0_level)
            ...
            : entries_0_n
                ...
                : {entries_0_ppn[5:0], _GEN_13[reqVpn_1[2:0]]}}
       : 36'h0)
    | (hitVecReg_1_1
         ? {entries_1_ppn[32:24],
            ...
            (|entries_1_level)
              ...
              : entries_1_n
                  ...
                  : {entries_1_ppn[5:0], _GEN_14[reqVpn_1[2:0]]}}
         : 36'h0)
    | (hitVecReg_1_2
         ? {entries_2_ppn[32:24],
            ...
            (|entries_2_level)
              ...
              : entries_2_n
                  ...
                  : {entries_2_ppn[5:0], _GEN_15[reqVpn_1[2:0]]}}
         : 36'h0)
    | (hitVecReg_1_3
         ? {entries_3_ppn[32:24],
            ...
            (|entries_3_level)
              ...
              : entries_3_n
                  ...
                  : {entries_3_ppn[5:0], _GEN_16[reqVpn_1[2:0]]}}
         : 36'h0);
