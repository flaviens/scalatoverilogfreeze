...
module Prefetcher(
  ...
  input  [4:0]  io_resp_0_bits_pfSource,
  ...
  wire [4:0]  _prefetch_resp_arb_io_out_bits_pfSource;
  ...
  wire        reqsFire_2_probe = _GEN[0] & _vbop_io_req_valid;
  wire        reqsFire_3_probe = _GEN[1] & _pbop_io_req_valid;
  wire        _GEN_0 = _vbop_io_req_valid | _pbop_io_req_valid;
  wire        _GEN_1 = reqsFire_2_probe | reqsFire_3_probe;
  ...
  PBestOffsetPrefetch pbop (
    ...
    .io_resp_valid
      (_prefetch_resp_arb_io_out_valid & _prefetch_resp_arb_io_out_bits_pfSource == 5'h9),
  ...
  wire        pbop_io_req_valid_probe;
  assign pbop_io_req_valid_probe = _pbop_io_req_valid;
  ...
  VBestOffsetPrefetch vbop (
    ...
    .io_resp_valid
      (_prefetch_resp_arb_io_out_valid & _prefetch_resp_arb_io_out_bits_pfSource == 5'h8),
  ...
  wire        vbop_io_req_valid_probe;
  assign vbop_io_req_valid_probe = _vbop_io_req_valid;
  ...
  wire        prefetch_train_arb_io_out_valid_probe;
  assign prefetch_train_arb_io_out_valid_probe = _prefetch_train_arb_io_out_valid;
  FastArbiter_9 prefetch_resp_arb (
    .io_in_0_ready         (io_resp_0_ready),
    .io_in_0_valid         (io_resp_0_valid),
    .io_in_0_bits_pfSource (io_resp_0_bits_pfSource),
  ...
  wire        prefetch_resp_arb_io_out_valid_probe;
  assign prefetch_resp_arb_io_out_valid_probe = _prefetch_resp_arb_io_out_valid;
