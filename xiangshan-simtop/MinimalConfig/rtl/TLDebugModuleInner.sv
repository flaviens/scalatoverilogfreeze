...
module TLDebugModuleInner(
  ...
  wire               hartGoingWrEn = out_woready_1_535 & (&_out_womask_T_658);
  ...
  wire               goAbstract = (|ctrlStateReg) & _GEN_4 & ~_GEN_5;
  wire               _GEN_6 = ctrlStateReg == 2'h2;
  `ifndef SYNTHESIS
    wire _GEN_7 = (|ctrlStateReg) & ctrlStateReg != 2'h1;
    always @(posedge clock) begin
      ...
      if (_GEN_7 & _GEN_6 & hartExceptionWrEn & ~reset
          & (|(auto_tl_in_a_bits_data[41:32]))) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_7 & ctrlStateReg != 2'h2 & (&ctrlStateReg) & ~reset) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: Should not be in custom state unless we need it.\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (~reset & ~(~io_dmactive | ~hartExceptionWrEn | _GEN_6)) begin
        if (`ASSERT_VERBOSE_COND_)
  ...
  always @(posedge clock) begin
    ...
    ABSTRACTCSReg_cmderr <=
      io_dmactive
        ? (ABSTRACTCSWrEnMaybe & (|ctrlStateReg) | autoexecdataWrEnMaybe & (|ctrlStateReg)
           ...
           | (dmiAbstractDataAccessVec_0 | dmiAbstractDataWrEnMaybe_1
              ...
              | dmiAbstractDataWrEnMaybe_7 | dmiAbstractDataRdEn_7) & (|ctrlStateReg)
           | (dmiProgramBufferAccessVec_0 | dmiProgramBufferWrEnMaybe_1
              ...
              | dmiProgramBufferWrEnMaybe_63 | dmiProgramBufferRdEn_63) & (|ctrlStateReg)
             ? 3'h1
             : ~(~(|ctrlStateReg) | _GEN_4) & _GEN_6 & hartExceptionWrEn
                 ...
                 : ((|ctrlStateReg)
                     ...
                     ? 3'h2
                     : (|ctrlStateReg) & _GEN_4 & ~commandRegIsUnsupported
