  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        bits_1_pdest = _RANDOM[7'hA][6:1];
        bits_1_fpWen = _RANDOM[7'hA][7];
        bits_1_loadDependency_0 = _RANDOM[7'hB][4:3];
        bits_1_loadDependency_1 = _RANDOM[7'hB][6:5];
        bits_1_loadDependency_2 = _RANDOM[7'hB][8:7];
        bits_2_robIdx_flag = _RANDOM[7'h28][27];
        bits_2_robIdx_value = {_RANDOM[7'h28][31:28], _RANDOM[7'h29][1:0]};
        bits_2_pdest = _RANDOM[7'h29][13:8];
        bits_2_fpWen = _RANDOM[7'h29][14];
        bits_2_loadDependency_0 = _RANDOM[7'h2A][11:10];
        bits_2_loadDependency_1 = _RANDOM[7'h2A][13:12];
        bits_2_loadDependency_2 = _RANDOM[7'h2A][15:14];
        bits_3_robIdx_flag = _RANDOM[7'h48][2];
        bits_3_robIdx_value = _RANDOM[7'h48][8:3];
        bits_3_pdest = _RANDOM[7'h48][20:15];
        bits_3_fpWen = _RANDOM[7'h48][21];
        bits_3_loadDependency_0 = _RANDOM[7'h49][18:17];
        bits_3_loadDependency_1 = _RANDOM[7'h49][20:19];
        bits_3_loadDependency_2 = _RANDOM[7'h49][22:21];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_1 = 1'h0;
        valids_2 = 1'h0;
