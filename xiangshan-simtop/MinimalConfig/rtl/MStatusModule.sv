...
module MStatusModule(
  ...
  reg        reg_MPV;
  reg        reg_MDT;
  wire       _GEN = robCommit_fsDirty | writeFCSR;
  wire       _GEN_0 =
    robCommit_vsDirty | writeVCSR | robCommit_vstart_valid & (|robCommit_vstart_bits);
  `ifndef SYNTHESIS
    always @(posedge clock) begin
      if (_GEN & ~reset & reg_FS == 2'h0) begin
      ...
      if (_GEN_0 & ~reset & reg_VS == 2'h0) begin
        if (`ASSERT_VERBOSE_COND_)
  ...
  wire       _GEN_1 = trapToM_mstatus_valid | retFromM_mstatus_valid;
  wire       _GEN_2 = w_wen | _GEN_1;
  wire       _GEN_3 = w_wen | wAliasSstatus_wen;
  wire       _GEN_4 =
