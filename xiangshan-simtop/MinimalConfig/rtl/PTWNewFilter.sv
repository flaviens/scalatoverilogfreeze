...
module PTWNewFilter(
  ...
  output        io_tlb_resp_bits_vector_5,
  output        io_tlb_resp_bits_getGpa_0,
  output        io_tlb_resp_bits_getGpa_3,
  output        io_tlb_resp_bits_getGpa_5,
  ...
  wire        _prefetch_filter_prefetch_entry_io_rob_head_miss_in_tlb;
  ...
  wire        _store_filter_store_entry_io_rob_head_miss_in_tlb;
  ...
  wire        _load_filter_load_entry_io_rob_head_miss_in_tlb;
  ...
  PTWFilterEntry load_filter_load_entry (
    ...
    .io_ptw_req_0_bits_s2xlate
      (_load_filter_load_entry_io_ptw_req_0_bits_s2xlate),
  ...
  PTWFilterEntry_1 store_filter_store_entry (
    ...
    .io_rob_head_miss_in_tlb
      (_store_filter_store_entry_io_rob_head_miss_in_tlb),
    .io_debugTopDown_robHeadVaddr_valid (io_debugTopDown_robHeadVaddr_valid),
    .io_debugTopDown_robHeadVaddr_bits  (io_debugTopDown_robHeadVaddr_bits),
    .io_flush                           (_flush_delay_io_out),
  ...
  PTWFilterEntry_2 prefetch_filter_prefetch_entry (
    ...
    .io_csr_vsatp_asid                  (io_csr_vsatp_asid),
    .io_csr_hgatp_vmid                  (io_csr_hgatp_vmid),
    .io_tlb_req_0_valid                 (io_tlb_req_5_valid),
    .io_tlb_req_0_bits_vpn              (io_tlb_req_5_bits_vpn),
    .io_tlb_req_0_bits_s2xlate          (io_tlb_req_5_bits_s2xlate),
    .io_tlb_req_0_bits_getGpa           (io_tlb_req_5_bits_getGpa),
    ...
    .io_ptw_resp_bits_s2_entry_level    (ptwResp_s2_entry_level),
    .io_rob_head_miss_in_tlb
      (_prefetch_filter_prefetch_entry_io_rob_head_miss_in_tlb),
    .io_debugTopDown_robHeadVaddr_valid (io_debugTopDown_robHeadVaddr_valid),
    .io_debugTopDown_robHeadVaddr_bits  (io_debugTopDown_robHeadVaddr_bits),
    .io_flush                           (_flush_delay_io_out),
  ...
  assign io_tlb_resp_bits_vector_3 = _store_filter_store_entry_io_refill;
  assign io_tlb_resp_bits_vector_5 = _prefetch_filter_prefetch_entry_io_refill;
  ...
  assign io_rob_head_miss_in_tlb =
    |{_load_filter_load_entry_io_rob_head_miss_in_tlb,
      _store_filter_store_entry_io_rob_head_miss_in_tlb,
      _prefetch_filter_prefetch_entry_io_rob_head_miss_in_tlb};
endmodule
