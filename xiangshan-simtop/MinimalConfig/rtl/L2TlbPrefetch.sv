...
module L2TlbPrefetch(
  ...
  reg  [37:0] next_req;
  wire        input_valid_probe =
    io_in_valid & ~flush
    & {old_reqs_0[37:3] == _next_line_T_1 & old_v_0,
       old_reqs_1[37:3] == _next_line_T_1 & old_v_1,
       old_reqs_2[37:3] == _next_line_T_1 & old_v_2,
       old_reqs_3[37:3] == _next_line_T_1 & old_v_3} == 4'h0;
  wire        _v_T_probe = io_out_ready & v;
  wire        _GEN = _v_T_probe & old_index == 2'h0;
  wire        _GEN_0 = _v_T_probe & old_index == 2'h1;
  wire        _GEN_1 = _v_T_probe & old_index == 2'h2;
  wire        _GEN_2 = _v_T_probe & (&old_index);
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      v <= ~flush & (input_valid_probe | ~_v_T_probe & v);
    end
