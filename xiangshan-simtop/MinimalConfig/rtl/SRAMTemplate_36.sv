...
module SRAMTemplate_36(
  ...
  output [54:0]  io_r_resp_data_0,
  output [54:0]  io_r_resp_data_1,
  output         io_w_req_ready,
  input          io_w_req_valid,
  input  [5:0]   io_w_req_bits_setIdx,
  input  [54:0]  io_w_req_bits_data_0,
  input  [54:0]  io_w_req_bits_data_1,
  ...
  wire [109:0] _array_RW0_rdata;
  wire         _rcg_out_clock;
  wire [6:0]   mbistBd_addr_rd = boreChildrenBd_bore_addr_rd;
  wire [109:0] mbistBd_wdata = boreChildrenBd_bore_wdata;
  ...
  reg          respReg;
  reg          rdata_last_REG;
  reg  [54:0]  rdata_hold_data_0;
  reg  [54:0]  rdata_hold_data_1;
  reg  [109:0] rdataReg;
  wire [109:0] mbistBd_rdata = rdataReg;
  ...
  always @(posedge clock) begin
    if (rdata_last_REG) begin
      rdata_hold_data_0 <= _array_RW0_rdata[54:0];
      rdata_hold_data_1 <= _array_RW0_rdata[109:55];
    end
    if (respReg)
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        respReg = _RANDOM[4'h4][4];
        rdata_last_REG = _RANDOM[4'h8][5];
        rdata_hold_data_0 = {_RANDOM[4'h8][31:6], _RANDOM[4'h9][28:0]};
        rdata_hold_data_1 = {_RANDOM[4'h9][31:29], _RANDOM[4'hA], _RANDOM[4'hB][19:0]};
        rdataReg =
          {_RANDOM[4'hB][31:20],
           _RANDOM[4'hC],
           _RANDOM[4'hD],
  ...
  sram_array_1p64x110m55s1h0l1b_bpu_abtb array (
    ...
    .RW0_wdata
      (mbistBd_ack
         ? mbistBd_wdata
         : _resetState ? 110'h0 : {io_w_req_bits_data_1, io_w_req_bits_data_0}),
    .RW0_rdata              (_array_RW0_rdata)
  );
  assign io_r_req_ready = io_r_req_ready_0;
  assign io_r_resp_data_0 = rdata_last_REG ? _array_RW0_rdata[54:0] : rdata_hold_data_0;
  assign io_r_resp_data_1 = rdata_last_REG ? _array_RW0_rdata[109:55] : rdata_hold_data_1;
