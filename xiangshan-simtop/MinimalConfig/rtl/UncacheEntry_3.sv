...
module UncacheEntry_3(
  ...
  wire        _GEN_2 = uncacheState == 3'h0;
  wire        _GEN_3 = uncacheState == 3'h1;
  wire        _GEN_4 = uncacheState == 3'h2;
  wire        _GEN_5 = needFlush | needFlushReg;
  wire        _GEN_6 = uncacheState == 3'h3;
  wire        _GEN_7 = uncacheState == 3'h4;
  wire        _GEN_8 = needFlush | writeback;
  assign flush =
    _GEN_2 | _GEN_3
      ? needFlush
      : _GEN_4 ? io_uncache_resp_valid & _GEN_5 : _GEN_6 ? _GEN_5 : _GEN_7 & _GEN_8;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_uop_robIdx_flag = _RANDOM[7'h12][17];
        req_uop_robIdx_value = _RANDOM[7'h12][23:18];
        req_uop_lqIdx_flag = _RANDOM[7'h27][25];
        req_uop_lqIdx_value = _RANDOM[7'h27][30:26];
        req_vaddr = {_RANDOM[7'h29][31:17], _RANDOM[7'h2A], _RANDOM[7'h2B][2:0]};
        req_fullva = {_RANDOM[7'h2B][31:3], _RANDOM[7'h2C], _RANDOM[7'h2D][2:0]};
        req_paddr = {_RANDOM[7'h2D][31:3], _RANDOM[7'h2E][18:0]};
        req_gpaddr = {_RANDOM[7'h2E][31:19], _RANDOM[7'h2F], _RANDOM[7'h30][18:0]};
        req_mask = {_RANDOM[7'h30][31:19], _RANDOM[7'h31][2:0]};
        req_nc = _RANDOM[7'h31][3];
        req_mmio = _RANDOM[7'h31][4];
        req_memBackTypeMM = _RANDOM[7'h31][5];
        req_isHyper = _RANDOM[7'h31][6];
        req_isForVSnonLeafPTE = _RANDOM[7'h31][7];
        slaveAccept = _RANDOM[7'h45][31];
        slaveId = _RANDOM[7'h46][3:0];
        uncacheState = _RANDOM[7'h46][6:4];
        uncacheData = {_RANDOM[7'h46][31:7], _RANDOM[7'h47], _RANDOM[7'h48][6:0]};
        nderr = _RANDOM[7'h48][7];
        derr = _RANDOM[7'h48][8];
        needFlushReg = _RANDOM[7'h48][9];
        pendingPtr_next_r_flag = _RANDOM[7'h48][10];
        pendingPtr_next_r_value = _RANDOM[7'h48][16:11];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        req_valid = 1'h0;
        slaveAccept = 1'h0;
