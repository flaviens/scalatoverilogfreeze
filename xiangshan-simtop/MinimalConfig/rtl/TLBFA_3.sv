...
module TLBFA_3(
  ...
  wire             perfEvents_0_2_probe = io_r_resp_0_valid_REG;
  ...
  wire [7:0][2:0]  _GEN_16 =
    {{entries_3_ppn_low_7},
     ...
     {entries_3_ppn_low_1},
     {entries_3_ppn_low_0}};
  wire             _GEN_17 = io_w_valid & io_w_bits_wayIdx == 2'h0;
  wire             _GEN_18 = io_w_valid & io_w_bits_wayIdx == 2'h1;
  wire             _GEN_19 = io_w_valid & io_w_bits_wayIdx == 2'h2;
  wire             _GEN_20 = io_w_valid & (&io_w_bits_wayIdx);
  ...
  wire [7:0]       _GEN_21 = {5'h0, io_w_bits_data_s2_entry_tag[2:0]};
  ...
  wire [7:0]       _w_hit_vec_T_3 = 8'h1 << _GEN_21;
  ...
  wire [7:0]       _w_hit_vec_pteidx_hit_T_12 =
    {entries_1_pteidx_7,
     ...
     entries_1_pteidx_1,
     entries_1_pteidx_0};
  wire [7:0]       _w_hit_vec_T_64 = 8'h1 << _GEN_21;
  ...
  wire [7:0]       _w_hit_vec_pteidx_hit_T_20 =
    {entries_2_pteidx_7,
     ...
     entries_2_pteidx_1,
     entries_2_pteidx_0};
  wire [7:0]       _w_hit_vec_T_125 = 8'h1 << _GEN_21;
  ...
  wire [7:0]       _w_hit_vec_pteidx_hit_T_28 =
    {entries_3_pteidx_7,
     ...
     entries_3_pteidx_1,
     entries_3_pteidx_0};
  wire [7:0]       _w_hit_vec_T_186 = 8'h1 << _GEN_21;
  ...
  wire             _GEN_23 = io_w_valid & (|_GEN_22);
  `ifndef SYNTHESIS
  ...
  wire             perfEvents_1_2_probe =
    io_r_resp_0_valid_REG & (|_io_access_0_touch_ways_valid_T);
  wire [3:0]       _GEN_24 = 4'h1 << io_access_0_touch_ways_bits_0;
  wire             _GEN_25 = perfEvents_1_2_probe & _GEN_24[0];
  wire             _GEN_26 = perfEvents_1_2_probe & _GEN_24[1];
  wire             _GEN_27 = perfEvents_1_2_probe & _GEN_24[2];
  wire             _GEN_28 = perfEvents_1_2_probe & _GEN_24[3];
  wire             sfence_valid =
    io_sfence_valid & ~io_sfence_bits_hg & ~io_sfence_bits_hv;
  wire             _v_0_T_39 = entries_0_asid == io_sfence_bits_id;
  wire             _GEN_29 = _GEN_0[io_sfence_bits_addr[14:12]];
  wire             _GEN_30 = _GEN_1[io_sfence_bits_addr[14:12]];
  wire             _v_1_T_39 = entries_1_asid == io_sfence_bits_id;
  wire             _GEN_31 = _GEN_3[io_sfence_bits_addr[14:12]];
  wire             _GEN_32 = _GEN_4[io_sfence_bits_addr[14:12]];
  wire             _v_2_T_39 = entries_2_asid == io_sfence_bits_id;
  wire             _GEN_33 = _GEN_6[io_sfence_bits_addr[14:12]];
  wire             _GEN_34 = _GEN_7[io_sfence_bits_addr[14:12]];
  wire             _v_3_T_39 = entries_3_asid == io_sfence_bits_id;
  wire             _GEN_35 = _GEN_9[io_sfence_bits_addr[14:12]];
  wire             _GEN_36 = _GEN_10[io_sfence_bits_addr[14:12]];
  wire             _GEN_37 =
                       ...
                       : io_sfence_bits_rs2
                           ...
                           : v_0
                             & ~((_v_0_T_39 | entries_0_perm_g)
                                 ...
                                 & (~io_csr_priv_virt | _v_0_T_41)
                                 & (~(io_csr_priv_virt & ~(|entries_0_level)
                                      & ~entries_0_n) | _GEN_29) & ~entries_0_perm_g))
                  : _GEN_17 | v_0;
      v_1 <=
        hfenceg_valid
          ? (io_sfence_bits_rs2
                       ...
                       : io_sfence_bits_rs2
                           ...
                           : v_1
                             & ~((_v_1_T_39 | entries_1_perm_g)
                                 ...
                                 & (~io_csr_priv_virt | _v_1_T_41)
                                 & (~(io_csr_priv_virt & ~(|entries_1_level)
                                      & ~entries_1_n) | _GEN_31) & ~entries_1_perm_g))
                  : _GEN_18 | v_1;
      v_2 <=
        hfenceg_valid
          ? (io_sfence_bits_rs2
                       ...
                       : io_sfence_bits_rs2
                           ...
                           : v_2
                             & ~((_v_2_T_39 | entries_2_perm_g)
                                 ...
                                 & (~io_csr_priv_virt | _v_2_T_41)
                                 & (~(io_csr_priv_virt & ~(|entries_2_level)
                                      & ~entries_2_n) | _GEN_33) & ~entries_2_perm_g))
                  : _GEN_19 | v_2;
      v_3 <=
        hfenceg_valid
          ? (io_sfence_bits_rs2
                       ...
                       : io_sfence_bits_rs2
                           ...
                           : v_3
                             & ~((_v_3_T_39 | entries_3_perm_g)
                                 ...
                                 & (~io_csr_priv_virt | _v_3_T_41)
                                 & (~(io_csr_priv_virt & ~(|entries_3_level)
                                      & ~entries_3_n) | _GEN_35) & ~entries_3_perm_g))
                  : _GEN_20 | v_3;
    end
  end // always @(posedge, posedge)
  wire [3:0]       refill_mask = io_w_valid ? 4'h1 << io_w_bits_wayIdx : 4'h0;
    ...
    io_w_bits_data_s2xlate != 2'h3
      ...
      : (io_w_bits_data_s1_pf | io_w_bits_data_s1_af) & ~_allStage_level_T_3
        ...
        & ~((io_w_bits_data_s1_entry_perm_r | io_w_bits_data_s1_entry_perm_x
          ...
          ? io_w_bits_data_s1_entry_level
          : s2_exception & _allStage_level_T_3 ? 2'h3 : _GEN_38[io_w_bits_data_s2xlate];
  ...
  wire             _GEN_41 = _inner_n_T_4 | _entries_ppn_T_1;
  wire [2:0]       _GEN_42 =
  ...
  wire [3:0]       _GEN_50 =
    {{io_w_bits_data_s1_entry_n & (|io_w_bits_data_s2_entry_level)
     ...
     {io_w_bits_data_s1_entry_n}};
  wire             isSuperPage = (|inner_level) | _GEN_50[io_w_bits_data_s2xlate];
  wire [7:0]       _GEN_51 = 8'h1 << io_w_bits_data_s2_entry_tag[2:0];
  wire             _GEN_52 =
    isSuperPage | (_entries_vmid_T ? _GEN_51[0] : io_w_bits_data_s1_valididx_0);
  wire             _GEN_53 =
    isSuperPage | (_entries_vmid_T ? _GEN_51[1] : io_w_bits_data_s1_valididx_1);
  wire             _GEN_54 =
    isSuperPage | (_entries_vmid_T ? _GEN_51[2] : io_w_bits_data_s1_valididx_2);
  wire             _GEN_55 =
    isSuperPage | (_entries_vmid_T ? _GEN_51[3] : io_w_bits_data_s1_valididx_3);
  wire             _GEN_56 =
    isSuperPage | (_entries_vmid_T ? _GEN_51[4] : io_w_bits_data_s1_valididx_4);
  wire             _GEN_57 =
    isSuperPage | (_entries_vmid_T ? _GEN_51[5] : io_w_bits_data_s1_valididx_5);
  wire             _GEN_58 =
    isSuperPage | (_entries_vmid_T ? _GEN_51[6] : io_w_bits_data_s1_valididx_6);
  wire             _GEN_59 =
    isSuperPage | (_entries_vmid_T ? _GEN_51[7] : io_w_bits_data_s1_valididx_7);
  wire             _GEN_60 = _entries_vmid_T ? _GEN_51[0] : io_w_bits_data_s1_pteidx_0;
  wire             _GEN_61 = _entries_vmid_T ? _GEN_51[1] : io_w_bits_data_s1_pteidx_1;
  wire             _GEN_62 = _entries_vmid_T ? _GEN_51[2] : io_w_bits_data_s1_pteidx_2;
  wire             _GEN_63 = _entries_vmid_T ? _GEN_51[3] : io_w_bits_data_s1_pteidx_3;
  wire             _GEN_64 = _entries_vmid_T ? _GEN_51[4] : io_w_bits_data_s1_pteidx_4;
  wire             _GEN_65 = _entries_vmid_T ? _GEN_51[5] : io_w_bits_data_s1_pteidx_5;
  wire             _GEN_66 = _entries_vmid_T ? _GEN_51[6] : io_w_bits_data_s1_pteidx_6;
  wire             _GEN_67 = _entries_vmid_T ? _GEN_51[7] : io_w_bits_data_s1_pteidx_7;
  ...
  always @(posedge clock) begin
    if (_GEN_17) begin
      ...
      entries_0_n <= _GEN_50[io_w_bits_data_s2xlate];
      ...
      entries_0_valididx_0 <= _GEN_52;
      entries_0_valididx_1 <= _GEN_53;
      entries_0_valididx_2 <= _GEN_54;
      entries_0_valididx_3 <= _GEN_55;
      entries_0_valididx_4 <= _GEN_56;
      entries_0_valididx_5 <= _GEN_57;
      entries_0_valididx_6 <= _GEN_58;
      entries_0_valididx_7 <= _GEN_59;
      entries_0_pteidx_0 <= _GEN_60;
      entries_0_pteidx_1 <= _GEN_61;
      entries_0_pteidx_2 <= _GEN_62;
      entries_0_pteidx_3 <= _GEN_63;
      entries_0_pteidx_4 <= _GEN_64;
      entries_0_pteidx_5 <= _GEN_65;
      entries_0_pteidx_6 <= _GEN_66;
      entries_0_pteidx_7 <= _GEN_67;
    ...
    if (_GEN_18) begin
      ...
      entries_1_n <= _GEN_50[io_w_bits_data_s2xlate];
      ...
      entries_1_valididx_0 <= _GEN_52;
      entries_1_valididx_1 <= _GEN_53;
      entries_1_valididx_2 <= _GEN_54;
      entries_1_valididx_3 <= _GEN_55;
      entries_1_valididx_4 <= _GEN_56;
      entries_1_valididx_5 <= _GEN_57;
      entries_1_valididx_6 <= _GEN_58;
      entries_1_valididx_7 <= _GEN_59;
      entries_1_pteidx_0 <= _GEN_60;
      entries_1_pteidx_1 <= _GEN_61;
      entries_1_pteidx_2 <= _GEN_62;
      entries_1_pteidx_3 <= _GEN_63;
      entries_1_pteidx_4 <= _GEN_64;
      entries_1_pteidx_5 <= _GEN_65;
      entries_1_pteidx_6 <= _GEN_66;
      entries_1_pteidx_7 <= _GEN_67;
    ...
    if (_GEN_19) begin
      ...
      entries_2_n <= _GEN_50[io_w_bits_data_s2xlate];
      ...
      entries_2_valididx_0 <= _GEN_52;
      entries_2_valididx_1 <= _GEN_53;
      entries_2_valididx_2 <= _GEN_54;
      entries_2_valididx_3 <= _GEN_55;
      entries_2_valididx_4 <= _GEN_56;
      entries_2_valididx_5 <= _GEN_57;
      entries_2_valididx_6 <= _GEN_58;
      entries_2_valididx_7 <= _GEN_59;
      entries_2_pteidx_0 <= _GEN_60;
      entries_2_pteidx_1 <= _GEN_61;
      entries_2_pteidx_2 <= _GEN_62;
      entries_2_pteidx_3 <= _GEN_63;
      entries_2_pteidx_4 <= _GEN_64;
      entries_2_pteidx_5 <= _GEN_65;
      entries_2_pteidx_6 <= _GEN_66;
      entries_2_pteidx_7 <= _GEN_67;
    ...
    if (_GEN_20) begin
      ...
      entries_3_n <= _GEN_50[io_w_bits_data_s2xlate];
      ...
      entries_3_valididx_0 <= _GEN_52;
      entries_3_valididx_1 <= _GEN_53;
      entries_3_valididx_2 <= _GEN_54;
      entries_3_valididx_3 <= _GEN_55;
      entries_3_valididx_4 <= _GEN_56;
      entries_3_valididx_5 <= _GEN_57;
      entries_3_valididx_6 <= _GEN_58;
      entries_3_valididx_7 <= _GEN_59;
      entries_3_pteidx_0 <= _GEN_60;
      entries_3_pteidx_1 <= _GEN_61;
      entries_3_pteidx_2 <= _GEN_62;
      entries_3_pteidx_3 <= _GEN_63;
      entries_3_pteidx_4 <= _GEN_64;
      entries_3_pteidx_5 <= _GEN_65;
      entries_3_pteidx_6 <= _GEN_66;
      entries_3_pteidx_7 <= _GEN_67;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        refill_wayIdx_reg = _RANDOM[5'h18][21:20];
        REG = _RANDOM[5'h18][22];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        v_0 = 1'h0;
        v_1 = 1'h0;
