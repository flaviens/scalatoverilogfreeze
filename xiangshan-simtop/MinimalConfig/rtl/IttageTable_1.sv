...
module IttageTable_1(
  ...
  input  [6:0]  io_req_bits_foldedHist_hist_4_foldedHist,
  input  [5:0]  io_req_bits_foldedHist_hist_3_foldedHist,
  ...
  input  [6:0]  io_update_foldedHist_hist_4_foldedHist,
  input  [5:0]  io_update_foldedHist_hist_3_foldedHist,
  ...
  input  [35:0] boreChildrenBd_bore_indata,
  input         boreChildrenBd_bore_readen,
  input  [7:0]  boreChildrenBd_bore_addr_rd,
  output [35:0] boreChildrenBd_bore_outdata,
  ...
  wire [35:0] bd_outdata;
  wire        bd_ack;
  wire [35:0] childBd_1_rdata;
  wire [35:0] childBd_rdata;
  wire        io_req_ready;
  ...
  wire [35:0] bd_be = boreChildrenBd_bore_be;
  wire [7:0]  bd_addr = boreChildrenBd_bore_addr;
  wire [35:0] bd_indata = boreChildrenBd_bore_indata;
  wire        bd_readen = boreChildrenBd_bore_readen;
  wire [7:0]  bd_addr_rd = boreChildrenBd_bore_addr_rd;
  wire [6:0]  s0_setIdx =
    io_req_bits_startPc_addr[7:1] ^ io_req_bits_foldedHist_hist_4_foldedHist;
  ...
  wire [6:0]  updateTag =
    ...
    ^ {io_update_foldedHist_hist_3_foldedHist, 1'h0};
  ...
  wire [6:0]  ittage_write_buffer_bank1_io_write_0_bits_setIdx =
    usefulCanReset
      ? resetSet
      : io_update_startPc_addr[7:1] ^ io_update_foldedHist_hist_4_foldedHist;
  ...
  always @(posedge clock) begin
    if (_usefulCanReset_T) begin
      s1_tag <=
        ...
        ^ {io_req_bits_foldedHist_hist_3_foldedHist, 1'h0};
  ...
  wire [35:0] childBd_wdata;
  wire [35:0] childBd_wmask;
  wire        childBd_re;
  wire        childBd_we;
  wire        childBd_ack;
  ...
  wire [35:0] childBd_1_wdata;
  wire [35:0] childBd_1_wmask;
  wire        childBd_1_re;
  wire        childBd_1_we;
  wire        childBd_1_ack;
