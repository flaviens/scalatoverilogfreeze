...
module MultiWakeupQueue_3(
  ...
  input  [5:0] io_enqAppend_bits_uop_pdest,
  ...
  output [5:0] io_deq_bits_pdestCopy_6,
  ...
  reg  [5:0] lastConnect_bits_pdestCopy_6;
  ...
  `ifndef SYNTHESIS
    wire [1:0] _GEN =
      2'({1'h0, _pipes_0_io_deq_valid}
         + 2'({1'h0, allValidVec_1} + {1'h0, allValidVec_2}));
    always @(posedge clock) begin
      if (~reset & _GEN[1]) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: PopCount(allValidVec) should be no more than 1\n");
        if (`STOP_COND_)
  ...
  wire [5:0] pipesOut_bits_pdest =
    ...
    | (allValidVec_1 ? _pipes_1_io_deq_bits_pdest : 6'h0)
    | (allValidVec_2 ? io_enqAppend_bits_uop_pdest : 6'h0);
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        lastConnect_bits_pdestCopy_0 = {_RANDOM[4'h7][31], _RANDOM[4'h8][4:0]};
        lastConnect_bits_pdestCopy_1 = _RANDOM[4'h8][10:5];
        lastConnect_bits_pdestCopy_2 = _RANDOM[4'h8][16:11];
        lastConnect_bits_pdestCopy_3 = _RANDOM[4'h8][22:17];
        lastConnect_bits_pdestCopy_4 = _RANDOM[4'h8][28:23];
        lastConnect_bits_pdestCopy_5 = {_RANDOM[4'h8][31:29], _RANDOM[4'h9][2:0]};
        lastConnect_bits_pdestCopy_6 = _RANDOM[4'h9][8:3];
        lastConnect_bits_rfWenCopy_0 = _RANDOM[4'h9][9];
        lastConnect_bits_rfWenCopy_1 = _RANDOM[4'h9][10];
        lastConnect_bits_rfWenCopy_2 = _RANDOM[4'h9][11];
        lastConnect_bits_rfWenCopy_3 = _RANDOM[4'h9][12];
        lastConnect_bits_rfWenCopy_4 = _RANDOM[4'h9][13];
        lastConnect_bits_rfWenCopy_5 = _RANDOM[4'h9][14];
        lastConnect_bits_rfWenCopy_6 = _RANDOM[4'h9][15];
        lastConnect_bits_loadDependencyCopy_0_0 = _RANDOM[4'h9][17:16];
        lastConnect_bits_loadDependencyCopy_0_1 = _RANDOM[4'h9][19:18];
        lastConnect_bits_loadDependencyCopy_0_2 = _RANDOM[4'h9][21:20];
        lastConnect_bits_loadDependencyCopy_1_0 = _RANDOM[4'h9][23:22];
        lastConnect_bits_loadDependencyCopy_1_1 = _RANDOM[4'h9][25:24];
        lastConnect_bits_loadDependencyCopy_1_2 = _RANDOM[4'h9][27:26];
        lastConnect_bits_loadDependencyCopy_2_0 = _RANDOM[4'h9][29:28];
        lastConnect_bits_loadDependencyCopy_2_1 = _RANDOM[4'h9][31:30];
        lastConnect_bits_loadDependencyCopy_2_2 = _RANDOM[4'hA][1:0];
        lastConnect_bits_loadDependencyCopy_3_0 = _RANDOM[4'hA][3:2];
        lastConnect_bits_loadDependencyCopy_3_1 = _RANDOM[4'hA][5:4];
        lastConnect_bits_loadDependencyCopy_3_2 = _RANDOM[4'hA][7:6];
        lastConnect_bits_loadDependencyCopy_4_0 = _RANDOM[4'hA][9:8];
        lastConnect_bits_loadDependencyCopy_4_1 = _RANDOM[4'hA][11:10];
        lastConnect_bits_loadDependencyCopy_4_2 = _RANDOM[4'hA][13:12];
        lastConnect_bits_loadDependencyCopy_5_0 = _RANDOM[4'hA][15:14];
        lastConnect_bits_loadDependencyCopy_5_1 = _RANDOM[4'hA][17:16];
        lastConnect_bits_loadDependencyCopy_5_2 = _RANDOM[4'hA][19:18];
        lastConnect_bits_loadDependencyCopy_6_0 = _RANDOM[4'hA][21:20];
        lastConnect_bits_loadDependencyCopy_6_1 = _RANDOM[4'hA][23:22];
        lastConnect_bits_loadDependencyCopy_6_2 = _RANDOM[4'hA][25:24];
        lastConnect_bits_pdest = _RANDOM[4'hA][31:26];
        lastConnect_bits_rfWen = _RANDOM[4'hB][0];
        lastConnect_bits_loadDependency_0 = _RANDOM[4'hB][18:17];
        lastConnect_bits_loadDependency_1 = _RANDOM[4'hB][20:19];
        lastConnect_bits_loadDependency_2 = _RANDOM[4'hB][22:21];
      `endif // RANDOMIZE_REG_INIT
    end // initial
