...
module MainBtbInternalBank_3(
  ...
  output [2:0]  io_read_resp_entries_0_position,
  ...
  output [2:0]  io_read_resp_entries_1_position,
  ...
  output [2:0]  io_read_resp_entries_2_position,
  ...
  output [2:0]  io_read_resp_entries_3_position,
  ...
  input  [2:0]  io_writeEntry_req_bits_entry_position,
  ...
  wire [2:0]  _entryWriteBuffer_io_read_0_bits_entry_position;
  ...
  wire [2:0]  _entryWriteBuffer_io_read_1_bits_entry_position;
  ...
  wire [2:0]  _entryWriteBuffer_io_read_2_bits_entry_position;
  ...
  wire [2:0]  _entryWriteBuffer_io_read_3_bits_entry_position;
  ...
  wire        _mbtb_sram_counter_align0_bank3_io_resetDone;
  wire        _mbtb_sram_entry_align0_bank3_way3_io_w_req_ready;
  wire        _mbtb_sram_entry_align0_bank3_way3_io_resetDone;
  wire        _mbtb_sram_entry_align0_bank3_way2_io_w_req_ready;
  wire        _mbtb_sram_entry_align0_bank3_way2_io_resetDone;
  wire        _mbtb_sram_entry_align0_bank3_way1_io_w_req_ready;
  wire        _mbtb_sram_entry_align0_bank3_way1_io_resetDone;
  wire        _mbtb_sram_entry_align0_bank3_way0_io_w_req_ready;
  wire        _mbtb_sram_entry_align0_bank3_way0_io_resetDone;
  ...
  reg  [2:0]  entryWriteBuffer_io_write_0_bits_entry_r_position;
  ...
  reg  [2:0]  entryWriteBuffer_io_write_1_bits_entry_r_position;
  ...
  reg  [2:0]  entryWriteBuffer_io_write_2_bits_entry_r_position;
  ...
  reg  [2:0]  entryWriteBuffer_io_write_3_bits_entry_r_position;
  ...
  always @(posedge clock) begin
    if (valid) begin
      ...
      entryWriteBuffer_io_write_0_bits_entry_r_position <=
        writeValid ? io_writeEntry_req_bits_entry_position : 3'h0;
    ...
    if (valid_1) begin
      ...
      entryWriteBuffer_io_write_1_bits_entry_r_position <=
        writeValid_1 ? io_writeEntry_req_bits_entry_position : 3'h0;
    ...
    if (valid_2) begin
      ...
      entryWriteBuffer_io_write_2_bits_entry_r_position <=
        writeValid_2 ? io_writeEntry_req_bits_entry_position : 3'h0;
    ...
    if (valid_3) begin
      ...
      entryWriteBuffer_io_write_3_bits_entry_r_position <=
        writeValid_3 ? io_writeEntry_req_bits_entry_position : 3'h0;
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        entryWriteBuffer_io_write_0_bits_entry_r_attribute_rasAction =
          _RANDOM[3'h0][29:28];
        entryWriteBuffer_io_write_0_bits_entry_r_position =
          {_RANDOM[3'h0][31:30], _RANDOM[3'h1][0]};
        entryWriteBuffer_io_write_0_bits_entry_r_targetCarry_value = _RANDOM[3'h1][2:1];
        entryWriteBuffer_io_write_0_bits_entry_r_targetLowerBits = _RANDOM[3'h1][22:3];
        entryWriteBuffer_io_write_1_valid_REG = _RANDOM[3'h1][23];
        entryWriteBuffer_io_write_1_bits_setIdx_r = _RANDOM[3'h1][31:24];
        entryWriteBuffer_io_write_1_bits_entry_r_valid = _RANDOM[3'h2][0];
        entryWriteBuffer_io_write_1_bits_entry_r_tag = _RANDOM[3'h2][16:1];
        entryWriteBuffer_io_write_1_bits_entry_r_attribute_branchType =
          _RANDOM[3'h2][18:17];
        entryWriteBuffer_io_write_1_bits_entry_r_attribute_rasAction =
          _RANDOM[3'h2][20:19];
        entryWriteBuffer_io_write_1_bits_entry_r_position = _RANDOM[3'h2][23:21];
        entryWriteBuffer_io_write_1_bits_entry_r_targetCarry_value = _RANDOM[3'h2][25:24];
        entryWriteBuffer_io_write_1_bits_entry_r_targetLowerBits =
          {_RANDOM[3'h2][31:26], _RANDOM[3'h3][13:0]};
        entryWriteBuffer_io_write_2_valid_REG = _RANDOM[3'h3][14];
        entryWriteBuffer_io_write_2_bits_setIdx_r = _RANDOM[3'h3][22:15];
        entryWriteBuffer_io_write_2_bits_entry_r_valid = _RANDOM[3'h3][23];
        entryWriteBuffer_io_write_2_bits_entry_r_tag =
          {_RANDOM[3'h3][31:24], _RANDOM[3'h4][7:0]};
        entryWriteBuffer_io_write_2_bits_entry_r_attribute_branchType =
          _RANDOM[3'h4][9:8];
        entryWriteBuffer_io_write_2_bits_entry_r_attribute_rasAction =
          _RANDOM[3'h4][11:10];
        entryWriteBuffer_io_write_2_bits_entry_r_position = _RANDOM[3'h4][14:12];
        entryWriteBuffer_io_write_2_bits_entry_r_targetCarry_value = _RANDOM[3'h4][16:15];
        entryWriteBuffer_io_write_2_bits_entry_r_targetLowerBits =
          {_RANDOM[3'h4][31:17], _RANDOM[3'h5][4:0]};
        entryWriteBuffer_io_write_3_valid_REG = _RANDOM[3'h5][5];
        entryWriteBuffer_io_write_3_bits_setIdx_r = _RANDOM[3'h5][13:6];
        entryWriteBuffer_io_write_3_bits_entry_r_valid = _RANDOM[3'h5][14];
        entryWriteBuffer_io_write_3_bits_entry_r_tag = _RANDOM[3'h5][30:15];
        entryWriteBuffer_io_write_3_bits_entry_r_attribute_branchType =
          {_RANDOM[3'h5][31], _RANDOM[3'h6][0]};
        entryWriteBuffer_io_write_3_bits_entry_r_attribute_rasAction = _RANDOM[3'h6][2:1];
        entryWriteBuffer_io_write_3_bits_entry_r_position = _RANDOM[3'h6][5:3];
        entryWriteBuffer_io_write_3_bits_entry_r_targetCarry_value = _RANDOM[3'h6][7:6];
        entryWriteBuffer_io_write_3_bits_entry_r_targetLowerBits = _RANDOM[3'h6][27:8];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        entryWriteBuffer_io_write_0_valid_REG = 1'h0;
        entryWriteBuffer_io_write_1_valid_REG = 1'h0;
  ...
  SRAMTemplate_64 mbtb_sram_entry_align0_bank3_way0 (
    ...
    .io_resetDone
      (_mbtb_sram_entry_align0_bank3_way0_io_resetDone),
  ...
  SRAMTemplate_64 mbtb_sram_entry_align0_bank3_way1 (
    ...
    .io_resetDone
      (_mbtb_sram_entry_align0_bank3_way1_io_resetDone),
  ...
  SRAMTemplate_64 mbtb_sram_entry_align0_bank3_way2 (
    ...
    .io_resetDone
      (_mbtb_sram_entry_align0_bank3_way2_io_resetDone),
  ...
  SRAMTemplate_64 mbtb_sram_entry_align0_bank3_way3 (
    ...
    .io_resetDone
      (_mbtb_sram_entry_align0_bank3_way3_io_resetDone),
  ...
  SRAMTemplate_66 mbtb_sram_counter_align0_bank3 (
    ...
    .io_resetDone                   (_mbtb_sram_counter_align0_bank3_io_resetDone),
  ...
  assign io_sramResetDone =
    ...
    & _mbtb_sram_entry_align0_bank3_way2_io_resetDone
    & _mbtb_sram_entry_align0_bank3_way3_io_resetDone
    & _mbtb_sram_counter_align0_bank3_io_resetDone;
endmodule
