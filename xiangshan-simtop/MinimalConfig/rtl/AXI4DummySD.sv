...
module AXI4DummySD(
  ...
  `ifndef SYNTHESIS
    wire _GEN_0 = _nodeIn_r_bits_user_T & ~reset;
    always @(posedge clock) begin
      ...
      if (_GEN_0 & nodeIn_ar_bits_burst != 2'h1) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: only support busrt ince!\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
  ...
  wire [31:0]     _GEN_1 = {{8{strb[3]}}, {8{strb[2]}}, {8{strb[1]}}, {8{strb[0]}}};
  wire            _GEN_2 = _GEN & waddr == 13'h0;
  wire [31:0]     _regs_0_T_3 = nodeIn_w_bits_data[31:0] & _GEN_1 | regs_0 & ~_GEN_1;
  ...
  wire            _GEN_3 = nodeIn_r_ready & nodeIn_r_valid;
  wire [3:0][1:0] _GEN_4 =
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (_GEN & waddr == 13'h4)
        regs_1 <= nodeIn_w_bits_data[31:0] & _GEN_1 | regs_1 & ~_GEN_1;
      if (~_GEN_2 | _regs_0_T_4) begin
      end
      ...
      if (_GEN & waddr == 13'h20)
        regs_8 <= nodeIn_w_bits_data[31:0] & _GEN_1 | regs_8 & ~_GEN_1;
      if (_GEN & waddr == 13'h38)
        regs_15 <= nodeIn_w_bits_data[31:0] & _GEN_1 | regs_15 & ~_GEN_1;
      if (_GEN & waddr == 13'h50)
        regs_20 <= nodeIn_w_bits_data[31:0] & _GEN_1 | regs_20 & ~_GEN_1;
    end
  ...
  DifftestSDCard DifftestSDCard (
    .clock      (clock),
    .io_setAddr
      (_GEN_2 & ~(_regs_0_T_4 | _regs_0_T_5 | _regs_0_T_6 | _regs_0_T_7)
