...
module SRAMTemplate_52(
  ...
  output [2:0]  io_r_resp_data_0_position,
  ...
  input  [2:0]  io_w_req_bits_data_0_position,
  ...
  wire [45:0] _array_RW0_rdata;
  wire        _rcg_out_clock;
  wire [8:0]  mbistBd_addr_rd = boreChildrenBd_bore_addr_rd;
  wire [45:0] mbistBd_wdata = boreChildrenBd_bore_wdata;
  ...
  reg         respReg;
  reg         rdata_last_REG;
  reg  [45:0] rdata_hold_data_0;
  wire [45:0] _rdata_T_0 = rdata_last_REG ? _array_RW0_rdata : rdata_hold_data_0;
  reg  [45:0] rdataReg;
  wire [45:0] mbistBd_rdata = rdataReg;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        respReg = _RANDOM[3'h2][9];
        rdata_last_REG = _RANDOM[3'h4][10];
        rdata_hold_data_0 = {_RANDOM[3'h4][31:11], _RANDOM[3'h5][24:0]};
        rdataReg = {_RANDOM[3'h5][31:25], _RANDOM[3'h6], _RANDOM[3'h7][6:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        _resetState = 1'h1;
        _resetSet = 8'h0;
  ...
  sram_array_1p256x46m46s1h0l1b_bpu_mbtb_entry array (
  ...
  assign io_r_resp_data_0_valid = _rdata_T_0[45];
  assign io_r_resp_data_0_tag = _rdata_T_0[44:29];
  assign io_r_resp_data_0_attribute_branchType = _rdata_T_0[28:27];
  assign io_r_resp_data_0_attribute_rasAction = _rdata_T_0[26:25];
  assign io_r_resp_data_0_position = _rdata_T_0[24:22];
