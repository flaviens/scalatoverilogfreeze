...
module SRAMTemplate_186(
  input         clock,
  input         reset,
  input         io_r_req_valid,
  input  [6:0]  io_r_req_bits_setIdx,
  output [87:0] io_r_resp_data_0,
  input         io_w_req_valid,
  input  [6:0]  io_w_req_bits_setIdx,
  input  [87:0] io_w_req_bits_data_0,
  input  [87:0] io_w_req_bits_flattened_bitmask,
  ...
  wire        io_r_req_ready;
  wire [87:0] _array_RW0_rdata;
  wire        _rcg_out_clock;
  wire [7:0]  mbistBd_addr_rd = boreChildrenBd_bore_addr_rd;
  wire [87:0] mbistBd_wdata = boreChildrenBd_bore_wdata;
  wire [87:0] mbistBd_wmask = boreChildrenBd_bore_wmask;
  ...
  reg         respReg;
  reg  [87:0] rdataReg;
  wire [87:0] mbistBd_rdata = rdataReg;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        respReg = _RANDOM[4'h3][8];
        rdataReg = {_RANDOM[4'h5][31:9], _RANDOM[4'h6], _RANDOM[4'h7], _RANDOM[4'h8][0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        respReg = 1'h0;
    end // initial
  ...
  sram_array_1p128x88m1s1h0l1b_dcsh_dat array (
    ...
    .RW0_wmask
      (mbistBd_ack
         ? {88{mbistBd_selectedOH}} & mbistBd_wmask
