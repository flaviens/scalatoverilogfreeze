...
module AXI4Error(
  ...
  reg  idle_aw;
  reg  idle_w;
  wire aw_q_io_deq_ready = auto_in_b_ready & b_valid;
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      idle_aw <= aw_q_io_deq_ready | ~_aw_q_io_deq_valid & idle_aw;
      idle_w <= aw_q_io_deq_ready | ~(_w_q_io_deq_valid & _w_q_io_deq_bits_last) & idle_w;
    end
  end // always @(posedge)
  ...
  Queue1_AXI4BundleW_1 w_q (
    ...
    .io_deq_ready     (aw_q_io_deq_ready | ~_w_q_io_deq_bits_last),
