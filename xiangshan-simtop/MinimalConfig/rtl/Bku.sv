...
module Bku(
  ...
  wire        miscModule_io_regEnable = io_in_bits_validPipe_0 & io_in_valid & rdyVec_0;
  reg  [8:0]  funcReg;
  ...
  always @(posedge clock) begin
    ...
    if (rdyVec_0 & io_in_valid)
      funcReg <= io_in_bits_ctrl_fuOpType;
    if (io_in_bits_validPipe_1 & validVecThisFu_1 & rdyVec_1)
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        funcReg = {_RANDOM[6'h35][31:24], _RANDOM[6'h36][0]};
        io_out_bits_res_data_r =
          {_RANDOM[6'h36][31:1], _RANDOM[6'h37], _RANDOM[6'h38][0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validVecThisFu_1 = 1'h0;
        validVecThisFu_2 = 1'h0;
