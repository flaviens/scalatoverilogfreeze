  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_out_blocks_0_bits_r_tracePipe_iretire = _RANDOM[3'h0][17:13];
        s1_out_blocks_0_bits_r_tracePipe_ilastsize = _RANDOM[3'h0][18];
        s1_out_blocks_1_valid_r = _RANDOM[3'h0][19];
        s1_out_blocks_1_bits_r_ftqIdx_value = _RANDOM[3'h0][23:21];
        s1_out_blocks_1_bits_r_ftqOffset = _RANDOM[3'h0][27:24];
        s1_out_blocks_1_bits_r_tracePipe_itype = _RANDOM[3'h0][31:28];
        s1_out_blocks_1_bits_r_tracePipe_iretire = _RANDOM[3'h1][4:0];
        s1_out_blocks_1_bits_r_tracePipe_ilastsize = _RANDOM[3'h1][5];
        s1_out_blocks_2_valid_r = _RANDOM[3'h1][6];
        s1_out_blocks_2_bits_r_ftqIdx_value = _RANDOM[3'h1][10:8];
        s1_out_blocks_2_bits_r_ftqOffset = _RANDOM[3'h1][14:11];
        s1_out_blocks_2_bits_r_tracePipe_itype = _RANDOM[3'h1][18:15];
        s1_out_blocks_2_bits_r_tracePipe_iretire = _RANDOM[3'h1][23:19];
        s1_out_blocks_2_bits_r_tracePipe_ilastsize = _RANDOM[3'h1][24];
        s1_out_blocks_3_valid_r = _RANDOM[3'h1][25];
        s1_out_blocks_3_bits_r_ftqIdx_value = _RANDOM[3'h1][29:27];
        s1_out_blocks_3_bits_r_ftqOffset = {_RANDOM[3'h1][31:30], _RANDOM[3'h2][1:0]};
        s1_out_blocks_3_bits_r_tracePipe_itype = _RANDOM[3'h2][5:2];
        s1_out_blocks_3_bits_r_tracePipe_iretire = _RANDOM[3'h2][10:6];
        s1_out_blocks_3_bits_r_tracePipe_ilastsize = _RANDOM[3'h2][11];
        s1_out_blocks_4_valid_r = _RANDOM[3'h2][12];
        s1_out_blocks_4_bits_r_ftqIdx_value = _RANDOM[3'h2][16:14];
        s1_out_blocks_4_bits_r_ftqOffset = _RANDOM[3'h2][20:17];
        s1_out_blocks_4_bits_r_tracePipe_itype = _RANDOM[3'h2][24:21];
        s1_out_blocks_4_bits_r_tracePipe_iretire = _RANDOM[3'h2][29:25];
        s1_out_blocks_4_bits_r_tracePipe_ilastsize = _RANDOM[3'h2][30];
        s1_out_blocks_5_valid_r = _RANDOM[3'h2][31];
        s1_out_blocks_5_bits_r_ftqIdx_value = _RANDOM[3'h3][3:1];
        s1_out_blocks_5_bits_r_ftqOffset = _RANDOM[3'h3][7:4];
        s1_out_blocks_5_bits_r_tracePipe_itype = _RANDOM[3'h3][11:8];
        s1_out_blocks_5_bits_r_tracePipe_iretire = _RANDOM[3'h3][16:12];
        s1_out_blocks_5_bits_r_tracePipe_ilastsize = _RANDOM[3'h3][17];
        s1_out_blocks_6_valid_r = _RANDOM[3'h3][18];
        s1_out_blocks_6_bits_r_ftqIdx_value = _RANDOM[3'h3][22:20];
        s1_out_blocks_6_bits_r_ftqOffset = _RANDOM[3'h3][26:23];
        s1_out_blocks_6_bits_r_tracePipe_itype = _RANDOM[3'h3][30:27];
        s1_out_blocks_6_bits_r_tracePipe_iretire =
          {_RANDOM[3'h3][31], _RANDOM[3'h4][3:0]};
        s1_out_blocks_6_bits_r_tracePipe_ilastsize = _RANDOM[3'h4][4];
        s1_out_blocks_7_valid_r = _RANDOM[3'h4][5];
        s1_out_blocks_7_bits_r_ftqIdx_value = _RANDOM[3'h4][9:7];
        s1_out_blocks_7_bits_r_ftqOffset = _RANDOM[3'h4][13:10];
        s1_out_blocks_7_bits_r_tracePipe_itype = _RANDOM[3'h4][17:14];
        s1_out_blocks_7_bits_r_tracePipe_iretire = _RANDOM[3'h4][22:18];
        s1_out_blocks_7_bits_r_tracePipe_ilastsize = _RANDOM[3'h4][23];
        s3_out_groups_blocks_0_valid = _RANDOM[3'h4][24];
        s3_out_groups_blocks_0_bits_ftqOffset = {_RANDOM[3'h4][31:29], _RANDOM[3'h5][0]};
        s3_out_groups_blocks_0_bits_tracePipe_itype = _RANDOM[3'h5][4:1];
        s3_out_groups_blocks_0_bits_tracePipe_iretire = _RANDOM[3'h5][12:5];
        s3_out_groups_blocks_0_bits_tracePipe_ilastsize = _RANDOM[3'h5][13];
        s3_out_groups_blocks_1_valid = _RANDOM[3'h5][14];
        s3_out_groups_blocks_1_bits_ftqOffset = _RANDOM[3'h5][22:19];
        s3_out_groups_blocks_1_bits_tracePipe_itype = _RANDOM[3'h5][26:23];
        s3_out_groups_blocks_1_bits_tracePipe_iretire =
          {_RANDOM[3'h5][31:27], _RANDOM[3'h6][2:0]};
        s3_out_groups_blocks_1_bits_tracePipe_ilastsize = _RANDOM[3'h6][3];
        s3_out_groups_blocks_2_valid = _RANDOM[3'h6][4];
        s3_out_groups_blocks_2_bits_ftqOffset = _RANDOM[3'h6][12:9];
        s3_out_groups_blocks_2_bits_tracePipe_itype = _RANDOM[3'h6][16:13];
        s3_out_groups_blocks_2_bits_tracePipe_iretire = _RANDOM[3'h6][24:17];
        s3_out_groups_blocks_2_bits_tracePipe_ilastsize = _RANDOM[3'h6][25];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        s1_out_blocks_0_valid_r = 1'h0;
        s1_out_blocks_0_bits_r_ftqIdx_value = 3'h0;
