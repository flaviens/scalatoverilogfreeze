  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        REG_satp_ppn = {_RANDOM[5'h0][31:20], _RANDOM[5'h1]};
        REG_satp_changed = _RANDOM[5'h2][0];
        REG_vsatp_mode = _RANDOM[5'h2][4:1];
        REG_vsatp_asid = _RANDOM[5'h2][20:5];
        REG_vsatp_ppn = {_RANDOM[5'h2][31:21], _RANDOM[5'h3], _RANDOM[5'h4][0]};
        REG_vsatp_changed = _RANDOM[5'h4][1];
        REG_hgatp_mode = _RANDOM[5'h4][5:2];
        REG_hgatp_vmid = _RANDOM[5'h4][21:6];
        REG_hgatp_ppn = {_RANDOM[5'h4][31:22], _RANDOM[5'h5], _RANDOM[5'h6][1:0]};
        REG_hgatp_changed = _RANDOM[5'h6][2];
        REG_mbmc_BME = _RANDOM[5'h6][4];
        REG_mbmc_CMODE = _RANDOM[5'h6][5];
        REG_priv_mxr = _RANDOM[5'h9][25];
        REG_priv_sum = _RANDOM[5'h9][26];
        REG_priv_vmxr = _RANDOM[5'h9][27];
        REG_priv_vsum = _RANDOM[5'h9][28];
        REG_priv_virt = _RANDOM[5'h9][29];
        REG_priv_virt_changed = _RANDOM[5'h9][30];
        REG_priv_spvp = _RANDOM[5'h9][31];
        REG_priv_imode = _RANDOM[5'hA][1:0];
        REG_priv_dmode = _RANDOM[5'hA][3:2];
        REG_pmm_mseccfg = _RANDOM[5'hA][7:6];
        REG_pmm_menvcfg = _RANDOM[5'hA][9:8];
        REG_pmm_henvcfg = _RANDOM[5'hA][11:10];
        REG_pmm_hstatus = _RANDOM[5'hA][13:12];
        REG_pmm_senvcfg = _RANDOM[5'hA][15:14];
        REG_1_satp_mode = _RANDOM[5'hA][19:16];
        REG_1_satp_asid = {_RANDOM[5'hA][31:20], _RANDOM[5'hB][3:0]};
        REG_1_satp_ppn = {_RANDOM[5'hB][31:4], _RANDOM[5'hC][15:0]};
        REG_1_satp_changed = _RANDOM[5'hC][16];
        REG_1_vsatp_mode = _RANDOM[5'hC][20:17];
        REG_1_vsatp_asid = {_RANDOM[5'hC][31:21], _RANDOM[5'hD][4:0]};
        REG_1_vsatp_ppn = {_RANDOM[5'hD][31:5], _RANDOM[5'hE][16:0]};
        REG_1_vsatp_changed = _RANDOM[5'hE][17];
        REG_1_hgatp_mode = _RANDOM[5'hE][21:18];
        REG_1_hgatp_vmid = {_RANDOM[5'hE][31:22], _RANDOM[5'hF][5:0]};
        REG_1_hgatp_ppn = {_RANDOM[5'hF][31:6], _RANDOM[5'h10][17:0]};
        REG_1_hgatp_changed = _RANDOM[5'h10][18];
        REG_1_mbmc_BME = _RANDOM[5'h10][20];
        REG_1_mbmc_CMODE = _RANDOM[5'h10][21];
        REG_1_priv_mxr = _RANDOM[5'h14][9];
        REG_1_priv_sum = _RANDOM[5'h14][10];
        REG_1_priv_vmxr = _RANDOM[5'h14][11];
        REG_1_priv_vsum = _RANDOM[5'h14][12];
        REG_1_priv_virt = _RANDOM[5'h14][13];
        REG_1_priv_virt_changed = _RANDOM[5'h14][14];
        REG_1_priv_spvp = _RANDOM[5'h14][15];
        REG_1_priv_imode = _RANDOM[5'h14][17:16];
        REG_1_priv_dmode = _RANDOM[5'h14][19:18];
        REG_1_pmm_mseccfg = _RANDOM[5'h14][23:22];
        REG_1_pmm_menvcfg = _RANDOM[5'h14][25:24];
        REG_1_pmm_henvcfg = _RANDOM[5'h14][27:26];
        REG_1_pmm_hstatus = _RANDOM[5'h14][29:28];
        REG_1_pmm_senvcfg = _RANDOM[5'h14][31:30];
      `endif // RANDOMIZE_REG_INIT
    end // initial
