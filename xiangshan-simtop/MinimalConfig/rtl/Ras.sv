  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        redirect_next_bits_r_meta_ras_ssp = _RANDOM[4'hB][27:25];
        redirect_next_bits_r_meta_ras_sctr = _RANDOM[4'hB][30:28];
        redirect_next_bits_r_meta_ras_tosw_flag = _RANDOM[4'hB][31];
        redirect_next_bits_r_meta_ras_tosw_value = _RANDOM[4'hC][3:0];
        redirect_next_bits_r_meta_ras_tosr_flag = _RANDOM[4'hC][4];
        redirect_next_bits_r_meta_ras_tosr_value = _RANDOM[4'hC][8:5];
        redirect_next_bits_r_meta_ras_nos_flag = _RANDOM[4'hC][9];
        redirect_next_bits_r_meta_ras_nos_value = _RANDOM[4'hC][13:10];
        commitValid = _RANDOM[4'hD][31];
        commitInfo_meta_ras_ssp = _RANDOM[4'hE][2:0];
        commitInfo_meta_ras_tosw_flag = _RANDOM[4'hE][3];
        commitInfo_meta_ras_tosw_value = _RANDOM[4'hE][7:4];
        commitInfo_attribute_rasAction = _RANDOM[4'hE][11:10];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        redirect_next_valid_last_REG = 1'h0;
        commitValid = 1'h0;
