  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        bits_1_is0Lat = _RANDOM[7'h5][16];
        bits_1_robIdx_flag = _RANDOM[7'h7][21];
        bits_1_robIdx_value = _RANDOM[7'h7][27:22];
        bits_1_pdest = _RANDOM[7'h8][9:2];
        bits_1_rfWen = _RANDOM[7'h8][15];
        bits_1_vecWen = _RANDOM[7'h8][17];
        bits_1_v0Wen = _RANDOM[7'h8][18];
        bits_1_loadDependency_0 = _RANDOM[7'hB][2:1];
        bits_1_loadDependency_1 = _RANDOM[7'hB][4:3];
        bits_1_loadDependency_2 = _RANDOM[7'hB][6:5];
        bits_2_is0Lat = _RANDOM[7'h24][21];
        bits_2_robIdx_flag = _RANDOM[7'h26][26];
        bits_2_robIdx_value = {_RANDOM[7'h26][31:27], _RANDOM[7'h27][0]};
        bits_2_pdest = _RANDOM[7'h27][14:7];
        bits_2_rfWen = _RANDOM[7'h27][20];
        bits_2_vecWen = _RANDOM[7'h27][22];
        bits_2_v0Wen = _RANDOM[7'h27][23];
        bits_2_loadDependency_0 = _RANDOM[7'h2A][7:6];
        bits_2_loadDependency_1 = _RANDOM[7'h2A][9:8];
        bits_2_loadDependency_2 = _RANDOM[7'h2A][11:10];
        bits_3_is0Lat = _RANDOM[7'h43][26];
        bits_3_robIdx_flag = _RANDOM[7'h45][31];
        bits_3_robIdx_value = _RANDOM[7'h46][5:0];
        bits_3_pdest = _RANDOM[7'h46][19:12];
        bits_3_rfWen = _RANDOM[7'h46][25];
        bits_3_vecWen = _RANDOM[7'h46][27];
        bits_3_v0Wen = _RANDOM[7'h46][28];
        bits_3_loadDependency_0 = _RANDOM[7'h49][12:11];
        bits_3_loadDependency_1 = _RANDOM[7'h49][14:13];
        bits_3_loadDependency_2 = _RANDOM[7'h49][16:15];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_1 = 1'h0;
        valids_2 = 1'h0;
