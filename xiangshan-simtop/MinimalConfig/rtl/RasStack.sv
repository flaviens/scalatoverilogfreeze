...
module RasStack(
  ...
  wire [15:0][3:0]  _GEN_8 =
    {{specNos_15_value},
     ...
     {specNos_1_value},
     {specNos_0_value}};
  wire [3:0]        _GEN_9 = _GEN_8[tosr_value];
  wire              topNos_flag =
    writeBypassValid ? writeBypassNos_flag : _GEN_7[tosr_value];
  wire [3:0]        topNos_value = writeBypassValid ? writeBypassNos_value : _GEN_9;
  ...
  wire              _GEN_20 = io_commit_metaSsp == 3'h0;
  wire              _GEN_21 = io_commit_popValid & (|_GEN_19) & _GEN_20;
  wire              _GEN_22 = io_commit_metaSsp == 3'h1;
  wire              _GEN_23 = io_commit_popValid & (|_GEN_19) & _GEN_22;
  wire              _GEN_24 = io_commit_metaSsp == 3'h2;
  wire              _GEN_25 = io_commit_popValid & (|_GEN_19) & _GEN_24;
  wire              _GEN_26 = io_commit_metaSsp == 3'h3;
  wire              _GEN_27 = io_commit_popValid & (|_GEN_19) & _GEN_26;
  wire              _GEN_28 = io_commit_metaSsp == 3'h4;
  wire              _GEN_29 = io_commit_popValid & (|_GEN_19) & _GEN_28;
  wire              _GEN_30 = io_commit_metaSsp == 3'h5;
  wire              _GEN_31 = io_commit_popValid & (|_GEN_19) & _GEN_30;
  wire              _GEN_32 = io_commit_metaSsp == 3'h6;
  wire              _GEN_33 = io_commit_popValid & (|_GEN_19) & _GEN_32;
  wire              _GEN_34 = io_commit_popValid & (|_GEN_19) & (&io_commit_metaSsp);
  wire              _GEN_35 =
    _GEN_19 != 3'h7 & _GEN_3[nsp] == _GEN_0[io_commit_metaTosw_value];
  wire [2:0]        _nsp_T_2 = 3'(io_commit_metaSsp + 3'h1);
  wire              _GEN_36 = _nsp_T_2 == 3'h0;
  wire              _GEN_37 = _nsp_T_2 == 3'h1;
  wire              _GEN_38 = _nsp_T_2 == 3'h2;
  wire              _GEN_39 = _nsp_T_2 == 3'h3;
  wire              _GEN_40 = _nsp_T_2 == 3'h4;
  wire              _GEN_41 = _nsp_T_2 == 3'h5;
  wire              _GEN_42 = _nsp_T_2 == 3'h6;
  wire [4:0]        _GEN_43 = {1'h0, bos_value};
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (~io_commit_pushValid | _GEN_35 | ~_GEN_36) begin
      end
      else
      ...
      if (io_commit_pushValid) begin
        ...
        nsp <= _GEN_35 ? io_commit_metaSsp : _nsp_T_2;
        ...
        if (io_commit_popValid)
          nsp <= (|_GEN_19) ? io_commit_metaSsp : 3'(io_commit_metaSsp - 3'h1);
        if (io_commit_valid
      ...
      specNearOverflowed <=
        (tosw_flag == bos_flag
           ...
           : 5'(5'({1'h0, tosw_value} - 5'h10) - _GEN_43)) > 5'hE;
      writeBypassValid <=
