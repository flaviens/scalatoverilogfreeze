...
module TLB(
  ...
  wire [7:0]       difftest_l1tlb_index = 8'h0;
  ...
  wire             _GEN_13 = perfEvents_0_2_probe & miss_read_0;
  wire             _GEN_14 = io_ptw_resp_valid & io_ptw_resp_bits_s1_pf;
  ...
  assign difftest_l1tlb_valid =
    ...
    & ~io_requestor_0_resp_bits_excp_0_gpf_instr_0 & privNeedTranslate_0;
  ...
  wire [43:0]      _GEN_16 = {6'h0, io_ptw_resp_bits_s2_entry_tag};
  wire [2:0]       _GEN_17 = _GEN_15[need_gpa_vpn[2:0]];
  ...
  wire [2:0]       _GEN_19 = _GEN_15[io_requestor_0_req_bits_vaddr[14:12]];
  ...
  wire [26:0]      readResult_gvpn =
    readResult_onlyS2
      ...
      : _GEN_20[io_ptw_resp_bits_s1_entry_level][26:0];
    ...
    if (io_ptw_resp_valid) begin
      readResult_p_ppn <=
        readResult_onlyS2 | (&req_in_s2xlate_0)
          ...
          : _GEN_20[io_ptw_resp_bits_s1_entry_level][35:0];
      ...
      readResult_p_gvpn <=
        readResult_onlyS2
          ...
          : ~(_readResult_resp_s1_isLeaf_T | io_ptw_resp_bits_s1_entry_perm_w)
            ...
            & ~io_ptw_resp_bits_s1_af
              ? {io_ptw_resp_bits_s1_entry_ppn, _GEN_19}
              : _GEN_22[io_ptw_resp_bits_s1_entry_level];
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        need_gpa = _RANDOM[6'h7][31];
        need_clear_need_gpa = _RANDOM[6'h8][0];
        need_gpa_vpn = {_RANDOM[6'h8][31:8], _RANDOM[6'h9][13:0]};
        resp_gpa_gvpn = {_RANDOM[6'h9][31:14], _RANDOM[6'hA][25:0]};
        resp_gpa_refill = _RANDOM[6'hA][26];
        resp_s1_level = _RANDOM[6'hA][28:27];
        resp_s1_isLeaf = _RANDOM[6'hA][29];
        resp_s1_isFakePte = _RANDOM[6'hA][30];
        ...
        readResult_p_gvpn = {_RANDOM[6'hE][31:25], _RANDOM[6'hF], _RANDOM[6'h10][4:0]};
        ...
        readResult_p_s2xlate = _RANDOM[6'h10][18:17];
        readResult_p_s1_level = _RANDOM[6'h10][20:19];
        readResult_p_s1_isLeaf = _RANDOM[6'h10][21];
        readResult_p_s1_isFakePte = _RANDOM[6'h10][22];
        ptw_resp_bits_reg_s2xlate = _RANDOM[6'h19][19:18];
        ptw_resp_bits_reg_s1_entry_tag = {_RANDOM[6'h19][31:20], _RANDOM[6'h1A][22:0]};
        ptw_resp_bits_reg_s1_entry_asid = {_RANDOM[6'h1A][31:23], _RANDOM[6'h1B][6:0]};
        ptw_resp_bits_reg_s1_entry_vmid = _RANDOM[6'h1B][20:7];
        ptw_resp_bits_reg_s1_entry_n = _RANDOM[6'h1B][21];
        ptw_resp_bits_reg_s1_entry_perm_g = _RANDOM[6'h1B][26];
        ptw_resp_bits_reg_s1_entry_level = {_RANDOM[6'h1B][31], _RANDOM[6'h1C][0]};
        ptw_resp_bits_reg_s1_addr_low = _RANDOM[6'h1D][14:12];
        ptw_resp_bits_reg_s1_valididx_0 = _RANDOM[6'h1E][7];
        ptw_resp_bits_reg_s1_valididx_1 = _RANDOM[6'h1E][8];
        ptw_resp_bits_reg_s1_valididx_2 = _RANDOM[6'h1E][9];
        ptw_resp_bits_reg_s1_valididx_3 = _RANDOM[6'h1E][10];
        ptw_resp_bits_reg_s1_valididx_4 = _RANDOM[6'h1E][11];
        ptw_resp_bits_reg_s1_valididx_5 = _RANDOM[6'h1E][12];
        ptw_resp_bits_reg_s1_valididx_6 = _RANDOM[6'h1E][13];
        ptw_resp_bits_reg_s1_valididx_7 = _RANDOM[6'h1E][14];
        ptw_resp_bits_reg_s2_entry_tag = {_RANDOM[6'h1E][31:25], _RANDOM[6'h1F][30:0]};
        ptw_resp_bits_reg_s2_entry_vmid = _RANDOM[6'h20][28:15];
        ptw_resp_bits_reg_s2_entry_n = _RANDOM[6'h20][29];
        ptw_resp_bits_reg_s2_entry_level = _RANDOM[6'h22][14:13];
        ptw_already_back_last_REG = _RANDOM[6'h22][27];
        result_ok_last_REG = _RANDOM[6'h22][29];
        io_perf_0_value_REG = _RANDOM[6'h22][30];
        io_perf_0_value_REG_1 = _RANDOM[6'h22][31];
        io_perf_1_value_REG = _RANDOM[6'h23][0];
        io_perf_1_value_REG_1 = _RANDOM[6'h23][1];
        difftest_valid_REG = _RANDOM[6'h23][4];
        difftest_vpn_r = {_RANDOM[6'h23][31:5], _RANDOM[6'h24][10:0]};
        req_s2xlate_REG = _RANDOM[6'h24][11];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        req_out_v_0 = 1'h0;
        need_gpa = 1'h0;
