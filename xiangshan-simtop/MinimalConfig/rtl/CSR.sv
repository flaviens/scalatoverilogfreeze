...
module CSR(
  ...
  output          io_out_bits_res_redirect_bits_canTrain,
  ...
  wire [55:0] _io_out_bits_debug_seqNum_pipMod_io_out_bits_seqNum;
  wire [7:0]  _io_out_bits_debug_seqNum_pipMod_io_out_bits_uopIdx;
  wire        _io_out_bits_perfDebugInfo_pipMod_io_out_bits_eliminatedMove;
  wire [63:0] _io_out_bits_perfDebugInfo_pipMod_io_out_bits_renameTime;
  wire [63:0] _io_out_bits_perfDebugInfo_pipMod_io_out_bits_dispatchTime;
  wire [63:0] _io_out_bits_perfDebugInfo_pipMod_io_out_bits_enqRsTime;
  wire [63:0] _io_out_bits_perfDebugInfo_pipMod_io_out_bits_selectTime;
  wire [63:0] _io_out_bits_perfDebugInfo_pipMod_io_out_bits_issueTime;
  wire [63:0] _io_out_bits_perfDebugInfo_pipMod_io_out_bits_runahead_checkpoint_id;
  wire [63:0] _io_out_bits_perfDebugInfo_pipMod_io_out_bits_tlbFirstReqTime;
  wire [63:0] _io_out_bits_perfDebugInfo_pipMod_io_out_bits_tlbRespTime;
  wire        _io_out_bits_ctrl_rfWen_pipMod_io_out_bits;
  wire        _io_out_bits_ctrl_robIdx_pipMod_io_out_bits_flag;
  wire [5:0]  _io_out_bits_ctrl_robIdx_pipMod_io_out_bits_value;
  ...
  reg         perfDebugInfoReg_eliminatedMove;
  reg  [63:0] perfDebugInfoReg_renameTime;
  reg  [63:0] perfDebugInfoReg_dispatchTime;
  reg  [63:0] perfDebugInfoReg_enqRsTime;
  reg  [63:0] perfDebugInfoReg_selectTime;
  reg  [63:0] perfDebugInfoReg_issueTime;
  reg  [63:0] perfDebugInfoReg_runahead_checkpoint_id;
  reg  [63:0] perfDebugInfoReg_tlbFirstReqTime;
  reg  [63:0] perfDebugInfoReg_tlbRespTime;
  reg  [55:0] debug_seqNumReg_seqNum;
  reg  [7:0]  debug_seqNumReg_uopIdx;
  reg         io_error_0_REG;
  ...
  always @(posedge clock) begin
    if (_io_csrio_isPerfCnt_T_2) begin
      ...
      perfDebugInfoReg_eliminatedMove <= io_in_bits_perfDebugInfo_eliminatedMove;
      perfDebugInfoReg_renameTime <= io_in_bits_perfDebugInfo_renameTime;
      perfDebugInfoReg_dispatchTime <= io_in_bits_perfDebugInfo_dispatchTime;
      perfDebugInfoReg_enqRsTime <= io_in_bits_perfDebugInfo_enqRsTime;
      perfDebugInfoReg_selectTime <= io_in_bits_perfDebugInfo_selectTime;
      perfDebugInfoReg_issueTime <= io_in_bits_perfDebugInfo_issueTime;
      perfDebugInfoReg_runahead_checkpoint_id <=
        io_in_bits_perfDebugInfo_runahead_checkpoint_id;
      perfDebugInfoReg_tlbFirstReqTime <= io_in_bits_perfDebugInfo_tlbFirstReqTime;
      perfDebugInfoReg_tlbRespTime <= io_in_bits_perfDebugInfo_tlbRespTime;
      debug_seqNumReg_seqNum <= io_in_bits_debug_seqNum_seqNum;
      debug_seqNumReg_uopIdx <= io_in_bits_debug_seqNum_uopIdx;
    end
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        tlb_priv_virt_changed_old_data = _RANDOM[5'h6][18];
        isXRetReg = _RANDOM[5'h6][19];
        io_out_bits_res_redirect_bits_ftqIdx_r_flag = _RANDOM[5'h6][20];
        io_out_bits_res_redirect_bits_ftqIdx_r_value = _RANDOM[5'h6][23:21];
        io_out_bits_res_redirect_bits_ftqOffset_r = _RANDOM[5'h6][27:24];
        rfWenReg = _RANDOM[5'h6][28];
        pdestReg = {_RANDOM[5'h6][31:29], _RANDOM[5'h7][4:0]};
        io_out_bits_ctrl_toRobValid_r = _RANDOM[5'h7][5];
        io_out_bits_ctrl_pdest_r = _RANDOM[5'h7][13:6];
        perfDebugInfoReg_eliminatedMove = _RANDOM[5'h7][15];
        perfDebugInfoReg_renameTime =
          {_RANDOM[5'h7][31:16], _RANDOM[5'h8], _RANDOM[5'h9][15:0]};
        perfDebugInfoReg_dispatchTime =
          {_RANDOM[5'h9][31:16], _RANDOM[5'hA], _RANDOM[5'hB][15:0]};
        perfDebugInfoReg_enqRsTime =
          {_RANDOM[5'hB][31:16], _RANDOM[5'hC], _RANDOM[5'hD][15:0]};
        perfDebugInfoReg_selectTime =
          {_RANDOM[5'hD][31:16], _RANDOM[5'hE], _RANDOM[5'hF][15:0]};
        perfDebugInfoReg_issueTime =
          {_RANDOM[5'hF][31:16], _RANDOM[5'h10], _RANDOM[5'h11][15:0]};
        perfDebugInfoReg_runahead_checkpoint_id =
          {_RANDOM[5'h13][31:16], _RANDOM[5'h14], _RANDOM[5'h15][15:0]};
        perfDebugInfoReg_tlbFirstReqTime =
          {_RANDOM[5'h15][31:16], _RANDOM[5'h16], _RANDOM[5'h17][15:0]};
        perfDebugInfoReg_tlbRespTime =
          {_RANDOM[5'h17][31:16], _RANDOM[5'h18], _RANDOM[5'h19][15:0]};
        debug_seqNumReg_seqNum =
          {_RANDOM[5'h19][31:16], _RANDOM[5'h1A], _RANDOM[5'h1B][7:0]};
        debug_seqNumReg_uopIdx = _RANDOM[5'h1B][15:8];
        io_error_0_REG = _RANDOM[5'h1B][16];
        io_error_0_REG_1 = _RANDOM[5'h1B][17];
        io_csrio_isPerfCnt_r = _RANDOM[5'h1B][18];
        io_csrToDecode_REG_illegalInst_sfenceVMA = _RANDOM[5'h1B][19];
        io_csrToDecode_REG_illegalInst_sfencePart = _RANDOM[5'h1B][20];
        io_csrToDecode_REG_illegalInst_hfenceGVMA = _RANDOM[5'h1B][21];
        io_csrToDecode_REG_illegalInst_hfenceVVMA = _RANDOM[5'h1B][22];
        io_csrToDecode_REG_illegalInst_hlsv = _RANDOM[5'h1B][23];
        io_csrToDecode_REG_illegalInst_fsIsOff = _RANDOM[5'h1B][24];
        io_csrToDecode_REG_illegalInst_vsIsOff = _RANDOM[5'h1B][25];
        io_csrToDecode_REG_illegalInst_wfi = _RANDOM[5'h1B][26];
        io_csrToDecode_REG_illegalInst_wrs_nto = _RANDOM[5'h1B][27];
        io_csrToDecode_REG_illegalInst_frm = _RANDOM[5'h1B][28];
        io_csrToDecode_REG_illegalInst_cboZ = _RANDOM[5'h1B][29];
        io_csrToDecode_REG_illegalInst_cboCF = _RANDOM[5'h1B][30];
        io_csrToDecode_REG_illegalInst_cboI = _RANDOM[5'h1B][31];
        io_csrToDecode_REG_virtualInst_sfenceVMA = _RANDOM[5'h1C][0];
        io_csrToDecode_REG_virtualInst_sfencePart = _RANDOM[5'h1C][1];
        io_csrToDecode_REG_virtualInst_hfence = _RANDOM[5'h1C][2];
        io_csrToDecode_REG_virtualInst_hlsv = _RANDOM[5'h1C][3];
        io_csrToDecode_REG_virtualInst_wfi = _RANDOM[5'h1C][4];
        io_csrToDecode_REG_virtualInst_wrs_nto = _RANDOM[5'h1C][5];
        io_csrToDecode_REG_virtualInst_cboZ = _RANDOM[5'h1C][6];
        io_csrToDecode_REG_virtualInst_cboCF = _RANDOM[5'h1C][7];
        io_csrToDecode_REG_virtualInst_cboI = _RANDOM[5'h1C][8];
        io_csrToDecode_REG_special_cboI2F = _RANDOM[5'h1C][9];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        waddrReg = 12'h0;
        wdataReg = 64'h0;
  ...
  DelayNWithValid_13 io_out_bits_perfDebugInfo_pipMod (
    .clock                              (clock),
    .reset                              (reset),
    .io_in_bits_eliminatedMove          (perfDebugInfoReg_eliminatedMove),
    .io_in_bits_renameTime              (perfDebugInfoReg_renameTime),
    .io_in_bits_dispatchTime            (perfDebugInfoReg_dispatchTime),
    .io_in_bits_enqRsTime               (perfDebugInfoReg_enqRsTime),
    .io_in_bits_selectTime              (perfDebugInfoReg_selectTime),
    .io_in_bits_issueTime               (perfDebugInfoReg_issueTime),
    .io_in_bits_runahead_checkpoint_id  (perfDebugInfoReg_runahead_checkpoint_id),
    .io_in_bits_tlbFirstReqTime         (perfDebugInfoReg_tlbFirstReqTime),
    .io_in_bits_tlbRespTime             (perfDebugInfoReg_tlbRespTime),
    .io_in_valid                        (_csrMod_io_out_valid),
    .io_out_bits_eliminatedMove
      (_io_out_bits_perfDebugInfo_pipMod_io_out_bits_eliminatedMove),
    .io_out_bits_renameTime
      (_io_out_bits_perfDebugInfo_pipMod_io_out_bits_renameTime),
    .io_out_bits_dispatchTime
      (_io_out_bits_perfDebugInfo_pipMod_io_out_bits_dispatchTime),
    .io_out_bits_enqRsTime
      (_io_out_bits_perfDebugInfo_pipMod_io_out_bits_enqRsTime),
    .io_out_bits_selectTime
      (_io_out_bits_perfDebugInfo_pipMod_io_out_bits_selectTime),
    .io_out_bits_issueTime
      (_io_out_bits_perfDebugInfo_pipMod_io_out_bits_issueTime),
    .io_out_bits_runahead_checkpoint_id
      (_io_out_bits_perfDebugInfo_pipMod_io_out_bits_runahead_checkpoint_id),
    .io_out_bits_tlbFirstReqTime
      (_io_out_bits_perfDebugInfo_pipMod_io_out_bits_tlbFirstReqTime),
    .io_out_bits_tlbRespTime
      (_io_out_bits_perfDebugInfo_pipMod_io_out_bits_tlbRespTime)
  );
  DelayNWithValid_14 io_out_bits_debug_seqNum_pipMod (
    .clock              (clock),
    .reset              (reset),
    .io_in_bits_seqNum  (debug_seqNumReg_seqNum),
    .io_in_bits_uopIdx  (debug_seqNumReg_uopIdx),
    .io_in_valid        (_csrMod_io_out_valid),
  ...
  assign io_out_bits_res_redirect_bits_canTrain = 1'h0;
  ...
  assign io_out_bits_perfDebugInfo_eliminatedMove =
    isXRetReg
      ? perfDebugInfoReg_eliminatedMove
      : _io_out_bits_perfDebugInfo_pipMod_io_out_bits_eliminatedMove;
  ...
  assign io_out_bits_debug_seqNum_seqNum =
    isXRetReg
      ? debug_seqNumReg_seqNum
      : _io_out_bits_debug_seqNum_pipMod_io_out_bits_seqNum;
  assign io_out_bits_debug_seqNum_uopIdx =
    isXRetReg
      ? debug_seqNumReg_uopIdx
      : _io_out_bits_debug_seqNum_pipMod_io_out_bits_uopIdx;
