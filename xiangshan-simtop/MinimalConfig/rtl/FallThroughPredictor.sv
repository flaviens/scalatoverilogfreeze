...
module FallThroughPredictor(
  ...
  output [3:0]  io_prediction_cfiPosition,
  output [48:0] io_prediction_target_addr
);

  reg  [48:0] s1_startPc_addr;
  wire [49:0] _s1_nextBlockAlignedPc_T_1 = 50'({s1_startPc_addr, 1'h0} + 50'h20);
  wire [48:0] s1_nextBlockAlignedPc_addr = {_s1_nextBlockAlignedPc_T_1[49:4], 3'h0};
  ...
  assign io_prediction_cfiPosition =
    _GEN ? 4'hF : {~(_s1_nextBlockAlignedPc_T_1[4]), 3'h7};
