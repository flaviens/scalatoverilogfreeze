...
module TLXbar_5(
  ...
  wire        requestDOI_0_1 = auto_out_d_bits_source[6:4] == 3'h5;
  wire        requestDOI_0_2 = auto_out_d_bits_source[6:4] == 3'h4;
  reg         beatsLeft;
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin
      if (~reset
          & ~((~winner_0 | ~winner_1) & (~(winner_0 | winner_1) | ~winner_2))) begin
      ...
      if (~reset
          & ~(~(_out_0_a_valid_T | auto_in_2_a_valid) | winner_0 | winner_1
              | winner_2)) begin
        if (`ASSERT_VERBOSE_COND_)
  ...
  wire        out_0_a_valid =
    beatsLeft
      ? state_0 & auto_in_0_a_valid | state_1 & auto_in_1_a_valid | state_2
        & auto_in_2_a_valid
      : _out_0_a_valid_T | auto_in_2_a_valid;
  ...
  assign auto_in_0_b_valid = auto_out_b_valid & ~(auto_out_b_bits_source[6]);
  ...
  assign auto_in_0_b_bits_source = auto_out_b_bits_source[5:0];
  ...
  assign auto_in_0_d_valid = auto_out_d_valid & ~(auto_out_d_bits_source[6]);
  ...
  assign auto_out_a_bits_source =
    (muxState_0 ? {1'h0, auto_in_0_a_bits_source} : 7'h0)
    | (muxState_1 ? {3'h5, auto_in_1_a_bits_source} : 7'h0)
    | (muxState_2 ? {3'h4, auto_in_2_a_bits_source} : 7'h0);
  ...
  assign auto_out_a_bits_user_alias = muxState_0 & auto_in_0_a_bits_user_alias;
  assign auto_out_a_bits_user_vaddr = muxState_0 ? auto_in_0_a_bits_user_vaddr : 44'h0;
  assign auto_out_a_bits_user_needHint = muxState_0 & auto_in_0_a_bits_user_needHint;
  ...
  assign auto_out_b_ready = ~(auto_out_b_bits_source[6]) & auto_in_0_b_ready;
  ...
  assign auto_out_c_bits_user_alias = auto_in_0_c_bits_user_alias;
  ...
  assign auto_out_d_ready =
    ~(auto_out_d_bits_source[6]) & auto_in_0_d_ready | requestDOI_0_1 & auto_in_1_d_ready
