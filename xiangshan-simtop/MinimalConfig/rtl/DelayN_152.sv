...
module DelayN_152(
  ...
  always @(posedge clock) begin
    ...
    REG_bits_instr <= io_in_bits_instr;
    ...
    REG_1_bits_instr <= REG_bits_instr;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        REG_bits_instr = {_RANDOM[4'h1][31:19], _RANDOM[4'h2][18:0]};
        ...
        REG_1_bits_instr = {_RANDOM[4'h7][31:10], _RANDOM[4'h8][9:0]};
  ...
  assign io_out_bits_instr = REG_1_bits_instr;
