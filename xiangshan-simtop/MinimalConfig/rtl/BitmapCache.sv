...
module BitmapCache(
  ...
  wire             _GEN_5 = io_resp_ready & valid_1;
  wire             _GEN_6 = _GEN_5 & ~hit;
  wire [1:0]       hitWay = _hitWay_T ? {1'h0, ~hitVec_0} : {1'h1, ~hitVec_2};
  wire             _GEN_7 = hit & stageResp_valid_1cycle;
  wire [2:0]       _GEN_8 = _GEN_0[data_1_tag[10:6]];
  wire [2:0]       _state_vec_T_8 =
    {~(hitWay[1]),
     hitWay[1] ? ~(hitWay[0]) : _GEN_8[1],
     hitWay[1] ? _GEN_8[0] : ~(hitWay[0])};
