...
module MultiWakeupQueue_7(
  ...
  `ifndef SYNTHESIS
    wire [1:0] _GEN =
      2'({1'h0, allValidVec_0} + 2'({1'h0, allValidVec_1} + {1'h0, allValidVec_2}));
  ...
  always @(posedge clock) begin
    ...
    lastConnect_bits_pdest <=
      (allValidVec_0 ? _pipes_0_io_deq_bits_pdest : 6'h0)
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        lastConnect_bits_pdest = {_RANDOM[4'h9][31], _RANDOM[4'hA][4:0]};
        lastConnect_bits_fpWen = _RANDOM[4'hA][5];
        lastConnect_bits_loadDependency_0 = _RANDOM[4'hB][2:1];
        lastConnect_bits_loadDependency_1 = _RANDOM[4'hB][4:3];
        lastConnect_bits_loadDependency_2 = _RANDOM[4'hB][6:5];
      `endif // RANDOMIZE_REG_INIT
    end // initial
