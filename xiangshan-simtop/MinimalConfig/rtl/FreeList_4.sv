...
module FreeList_4(
  ...
  wire [4:0]       deqPtr_new_value =
    5'({1'h0, headPtr_value} + {3'h0, _numAllocate_T_2});
  ...
  wire             _remFreeSelIndexOHVec_highIndexOH_T =
    freeMask[0] & _remFreeSelMaskVec_T_18[0];
  wire             _remFreeSelIndexOHVec_highIndexOH_T_1 =
    freeMask[4] & _remFreeSelMaskVec_T_18[4];
  wire             _remFreeSelIndexOHVec_highIndexOH_T_2 =
    freeMask[8] & _remFreeSelMaskVec_T_18[8];
  ...
  wire             _remFreeSelIndexOHVec_highIndexOH_T_5 =
    freeMask[1] & _remFreeSelMaskVec_T_18[1];
  wire             _remFreeSelIndexOHVec_highIndexOH_T_6 =
    freeMask[5] & _remFreeSelMaskVec_T_18[5];
  wire             _remFreeSelIndexOHVec_highIndexOH_T_7 =
    freeMask[9] & _remFreeSelMaskVec_T_18[9];
  ...
  wire             _remFreeSelIndexOHVec_highIndexOH_T_10 =
    freeMask[2] & _remFreeSelMaskVec_T_18[2];
  wire             _remFreeSelIndexOHVec_highIndexOH_T_11 =
    freeMask[6] & _remFreeSelMaskVec_T_18[6];
  wire             _remFreeSelIndexOHVec_highIndexOH_T_12 =
    freeMask[10] & _remFreeSelMaskVec_T_18[10];
  ...
  wire             _remFreeSelIndexOHVec_highIndexOH_T_15 =
    freeMask[3] & _remFreeSelMaskVec_T_18[3];
  wire             _remFreeSelIndexOHVec_highIndexOH_T_16 =
    freeMask[7] & _remFreeSelMaskVec_T_18[7];
  wire             _remFreeSelIndexOHVec_highIndexOH_T_17 =
    freeMask[11] & _remFreeSelMaskVec_T_18[11];
  ...
  wire [2:0]       remFreeSelIndexOHVec_highIndexOH =
    _remFreeSelIndexOHVec_highIndexOH_T
      ...
      : _remFreeSelIndexOHVec_highIndexOH_T_1
          ? 3'h2
          : {_remFreeSelIndexOHVec_highIndexOH_T_2, 2'h0};
  ...
  wire [2:0]       remFreeSelIndexOHVec_highIndexOH_1 =
    _remFreeSelIndexOHVec_highIndexOH_T_5
      ...
      : _remFreeSelIndexOHVec_highIndexOH_T_6
          ? 3'h2
          : {_remFreeSelIndexOHVec_highIndexOH_T_7, 2'h0};
  ...
  wire [2:0]       remFreeSelIndexOHVec_highIndexOH_2 =
    _remFreeSelIndexOHVec_highIndexOH_T_10
      ...
      : _remFreeSelIndexOHVec_highIndexOH_T_11
          ? 3'h2
          : {_remFreeSelIndexOHVec_highIndexOH_T_12, 2'h0};
  ...
  wire [2:0]       remFreeSelIndexOHVec_highIndexOH_3 =
    _remFreeSelIndexOHVec_highIndexOH_T_15
      ...
      : _remFreeSelIndexOHVec_highIndexOH_T_16
          ? 3'h2
          : {_remFreeSelIndexOHVec_highIndexOH_T_17, 2'h0};
  ...
  wire [4:0]       tailPtrNext_new_value = 5'(_GEN_0 + {2'h0, 3'(_GEN_4 + _GEN_5)});
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (|_doFree_T)
        tailPtr_value <=
          tailPtrNext_reverse_flag
            ? _tailPtrNext_diff_T_4[3:0]
            : tailPtrNext_new_value[3:0];
      ...
      freeSlotCnt <=
        4'(4'(freeSlotCnt + {1'h0, 3'(_GEN_4 + _GEN_5)}) - {2'h0, _numAllocate_T_2});
    end
  ...
  assign io_validCount = 4'(4'hC - freeSlotCnt);
