...
module AXI4RAM(
  ...
  output [14:0]  auto_in_b_bits_id,
  output [1:0]   auto_in_b_bits_resp,
  output         auto_in_ar_ready,
  input          auto_in_ar_valid,
  input  [14:0]  auto_in_ar_bits_id,
  ...
  output [14:0]  auto_in_r_bits_id,
  output [255:0] auto_in_r_bits_data,
  output [1:0]   auto_in_r_bits_resp,
  output         auto_in_r_bits_last
);

  wire [63:0]     _rdata_mem_read_0_data_0;
  wire [63:0]     _rdata_mem_read_0_data_1;
  wire [63:0]     _rdata_mem_read_0_data_2;
  wire [63:0]     _rdata_mem_read_0_data_3;
  wire            nodeIn_aw_valid = auto_in_aw_valid;
  wire [14:0]     nodeIn_aw_bits_id = auto_in_aw_bits_id;
  ...
  wire [14:0]     nodeIn_ar_bits_id = auto_in_ar_bits_id;
  ...
  reg  [14:0]     nodeIn_b_bits_id_r;
  wire [14:0]     nodeIn_b_bits_id = nodeIn_b_bits_id_r;
  reg  [14:0]     nodeIn_r_bits_id_r;
  wire [14:0]     nodeIn_r_bits_id = nodeIn_r_bits_id_r;
  wire [42:0]     _wIdx_T =
  ...
  wire            rdata_mem_read_0_valid = _rdata_T_106 | _rdata_T_107;
  reg             rdata_REG;
  reg             rdata_REG_1;
  reg  [63:0]     rdata_r_0;
  reg  [63:0]     rdata_r_1;
  ...
  wire [255:0]    nodeIn_r_bits_data =
    {rdata_REG ? _rdata_mem_read_0_data_3 : rdata_r_3,
     ...
     rdata_REG ? _rdata_mem_read_0_data_0 : rdata_r_0};
  wire [3:0][1:0] _GEN_0 =
    {{(&state) & nodeIn_b_ready & nodeIn_b_valid ? 2'h0 : state},
     ...
     {_nodeIn_b_bits_user_T ? 2'h2 : _rdata_T_106 ? 2'h1 : state}};
  always @(posedge clock) begin
    if (reset) begin
      state <= 2'h0;
      readBeatCnt <= 8'h0;
      ...
      if (_wen_T)
        writeBeatCnt <= nodeIn_w_bits_last ? 8'h0 : 8'(writeBeatCnt + 8'h1);
    end
    ...
    rdata_REG <= rdata_mem_read_0_valid;
    rdata_REG_1 <= rdata_mem_read_0_valid;
    if (rdata_REG_1) begin
      rdata_r_0 <= _rdata_mem_read_0_data_0;
      rdata_r_1 <= _rdata_mem_read_0_data_1;
      rdata_r_2 <= _rdata_mem_read_0_data_2;
      rdata_r_3 <= _rdata_mem_read_0_data_3;
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        nodeIn_b_bits_id_r = {_RANDOM[4'h3][31:26], _RANDOM[4'h4][8:0]};
        nodeIn_r_bits_id_r = _RANDOM[4'h4][23:9];
        rdata_REG = _RANDOM[4'h4][24];
        rdata_REG_1 = _RANDOM[4'h4][25];
        rdata_r_0 = {_RANDOM[4'h4][31:26], _RANDOM[4'h5], _RANDOM[4'h6][25:0]};
        rdata_r_1 = {_RANDOM[4'h6][31:26], _RANDOM[4'h7], _RANDOM[4'h8][25:0]};
        rdata_r_2 = {_RANDOM[4'h8][31:26], _RANDOM[4'h9], _RANDOM[4'hA][25:0]};
        rdata_r_3 = {_RANDOM[4'hA][31:26], _RANDOM[4'hB], _RANDOM[4'hC][25:0]};
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  DifftestMem1R1W rdata_mem (
    .clock          (clock),
    .reset          (reset),
    .read_0_valid   (rdata_mem_read_0_valid),
    .read_0_index
    ...
    .write_0_valid  (_wen_T & _wIdx_T_4[37:26] != 12'hFFF),
    .write_0_index  ({26'h0, _wIdx_T_4}),
    .write_0_data_0 (nodeIn_w_bits_data[63:0]),
    .write_0_data_1 (nodeIn_w_bits_data[127:64]),
    .write_0_data_2 (nodeIn_w_bits_data[191:128]),
    .write_0_data_3 (nodeIn_w_bits_data[255:192]),
    .write_0_mask_0
