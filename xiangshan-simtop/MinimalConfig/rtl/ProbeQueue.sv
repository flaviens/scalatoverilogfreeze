...
module ProbeQueue(
  ...
  wire [49:0] entries_7_io_req_bits_vaddr =
    {37'h0, io_mem_probe_bits_data[1], io_mem_probe_bits_address[11:0]};
  ...
  `ifndef SYNTHESIS
    wire _GEN = io_mem_probe_valid & ~reset;
    always @(posedge clock) begin
      if (_GEN
          & (|{_entries_7_io_block_addr_valid
                 & _entries_7_io_block_addr_bits[47:6] == io_mem_probe_bits_address[47:6],
               _entries_6_io_block_addr_valid
                 & _entries_6_io_block_addr_bits[47:6] == io_mem_probe_bits_address[47:6],
               _entries_5_io_block_addr_valid
                 & _entries_5_io_block_addr_bits[47:6] == io_mem_probe_bits_address[47:6],
               _entries_4_io_block_addr_valid
                 & _entries_4_io_block_addr_bits[47:6] == io_mem_probe_bits_address[47:6],
               _entries_3_io_block_addr_valid
                 & _entries_3_io_block_addr_bits[47:6] == io_mem_probe_bits_address[47:6],
               _entries_2_io_block_addr_valid
                 & _entries_2_io_block_addr_bits[47:6] == io_mem_probe_bits_address[47:6],
               _entries_1_io_block_addr_valid
                 & _entries_1_io_block_addr_bits[47:6] == io_mem_probe_bits_address[47:6],
               _entries_0_io_block_addr_valid
                 & _entries_0_io_block_addr_bits[47:6] == io_mem_probe_bits_address[47:6]})) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed at Probe.scala:213\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (_GEN & io_mem_probe_bits_opcode != 3'h6) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed at Probe.scala:215\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
    end // always @(posedge)
  `endif // not def SYNTHESIS
  wire        _GEN_0 = (|_allocate_T) & io_mem_probe_valid;
  ...
  wire [5:0]  _GEN_1 = {2'h0, perfValidCount};
  always @(posedge clock) begin
    ...
    io_perf_3_value_REG <= perfValidCount > 4'h4 & _GEN_1 < 6'h7;
    io_perf_3_value_REG_1 <= io_perf_3_value_REG;
    io_perf_4_value_REG <= _GEN_1 > 6'h6;
