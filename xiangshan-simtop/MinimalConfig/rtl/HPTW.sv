...
module HPTW(
  ...
  input  [7:0]  io_req_bits_bitmapCheck_hitway,
  ...
  always @(posedge clock) begin
    ...
    if (_cache_level_T) begin
      ...
      cache_pte_perm_g <=
        io_req_bits_bitmapCheck_fromSP ? io_req_bits_bitmapCheck_pte[5] : _GEN_18[5];
      cache_pte_perm_u <=
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s_bitmap_check = _RANDOM[3'h5][7];
        w_bitmap_resp = _RANDOM[3'h5][8];
        whether_need_bitmap_check = _RANDOM[3'h5][9];
        bitmap_checkfailed = _RANDOM[3'h5][10];
        accessFault = _RANDOM[3'h5][11];
        id = _RANDOM[3'h5][14:12];
        source = _RANDOM[3'h5][16:15];
        way_info_REG = _RANDOM[3'h5][17];
        way_info_r = _RANDOM[3'h5][25:18];
        cache_hitway = {_RANDOM[3'h5][31:26], _RANDOM[3'h6][1:0]};
        cache_level = _RANDOM[3'h6][3:2];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        level = 2'h3;
        af_level = 2'h3;
