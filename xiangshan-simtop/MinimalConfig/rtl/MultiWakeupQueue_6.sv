  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        lastConnect_bits_pdest = {_RANDOM[4'h9][31], _RANDOM[4'hA][6:0]};
        lastConnect_bits_fpWen = _RANDOM[4'hA][8];
        lastConnect_bits_vecWen = _RANDOM[4'hA][9];
        lastConnect_bits_v0Wen = _RANDOM[4'hA][10];
