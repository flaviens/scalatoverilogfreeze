...
module PipelineConnectPipe(
  ...
  input  [49:0] io_in_bits_debug_pc,
  input  [55:0] io_in_bits_debug_debug_seqNum_seqNum,
  input  [7:0]  io_in_bits_debug_debug_seqNum_uopIdx,
  input         io_out_ready,
  output        io_out_valid,
  ...
  output [49:0] io_out_bits_debug_pc,
  output [55:0] io_out_bits_debug_debug_seqNum_seqNum,
  output [7:0]  io_out_bits_debug_debug_seqNum_uopIdx,
  ...
  reg         data_lastUop;
  reg  [6:0]  data_numWB;
  reg  [49:0] data_debug_pc;
  reg  [55:0] data_debug_debug_seqNum_seqNum;
  reg  [7:0]  data_debug_debug_seqNum_uopIdx;
  ...
  always @(posedge clock) begin
    if (leftFire) begin
      ...
      data_debug_pc <= io_in_bits_debug_pc;
      data_debug_debug_seqNum_seqNum <= io_in_bits_debug_debug_seqNum_seqNum;
      data_debug_debug_seqNum_uopIdx <= io_in_bits_debug_debug_seqNum_uopIdx;
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_exceptionVec_22 = _RANDOM[5'h0][11];
        data_exceptionVec_20 = _RANDOM[5'h0][12];
        data_exceptionVec_19 = _RANDOM[5'h0][13];
        data_exceptionVec_12 = _RANDOM[5'h0][14];
        data_exceptionVec_3 = _RANDOM[5'h0][15];
        data_exceptionVec_2 = _RANDOM[5'h0][16];
        data_exceptionVec_1 = _RANDOM[5'h0][17];
        data_isFetchMalAddr = _RANDOM[5'h0][18];
        data_trigger = _RANDOM[5'h0][22:19];
        data_isRVC = _RANDOM[5'h0][23];
        data_fixedTaken = _RANDOM[5'h0][24];
        data_predTaken = _RANDOM[5'h0][25];
        data_crossPageIPFFix = _RANDOM[5'h0][26];
        data_ftqPtr_flag = _RANDOM[5'h0][27];
        data_ftqPtr_value = _RANDOM[5'h0][30:28];
        data_ftqOffset = {_RANDOM[5'h0][31], _RANDOM[5'h1][2:0]};
        data_isLastInFtqEntry = _RANDOM[5'h1][3];
        data_instr = {_RANDOM[5'h1][31:4], _RANDOM[5'h2][3:0]};
        data_commitType = _RANDOM[5'h2][5:4];
        data_srcType_0 = _RANDOM[5'h2][9:6];
        data_srcType_1 = _RANDOM[5'h2][13:10];
        data_srcType_2 = _RANDOM[5'h2][17:14];
        data_srcType_3 = _RANDOM[5'h2][21:18];
        data_vlRen = _RANDOM[5'h2][22];
        data_lsrc_0 = _RANDOM[5'h2][28:23];
        data_lsrc_1 = {_RANDOM[5'h2][31:29], _RANDOM[5'h3][2:0]};
        data_lsrc_2 = _RANDOM[5'h3][8:3];
        data_ldest = _RANDOM[5'h3][20:15];
        data_fuType = {_RANDOM[5'h3][31:21], _RANDOM[5'h4][24:0]};
        data_fuOpType = {_RANDOM[5'h4][31:25], _RANDOM[5'h5][1:0]};
        data_rfWen = _RANDOM[5'h5][2];
        data_fpWen = _RANDOM[5'h5][3];
        data_vecWen = _RANDOM[5'h5][4];
        data_v0Wen = _RANDOM[5'h5][5];
        data_vlWen = _RANDOM[5'h5][6];
        data_waitForward = _RANDOM[5'h5][7];
        data_blockBackward = _RANDOM[5'h5][8];
        data_flushPipe = _RANDOM[5'h5][9];
        data_canRobCompress = _RANDOM[5'h5][10];
        data_selImm = _RANDOM[5'h5][14:11];
        data_imm = {_RANDOM[5'h5][31:15], _RANDOM[5'h6][14:0]};
        data_fpu_wflags = _RANDOM[5'h6][15];
        data_fpu_fmt = _RANDOM[5'h6][17:16];
        data_fpu_rm = _RANDOM[5'h6][20:18];
        data_vpu_vill = _RANDOM[5'h6][21];
        data_vpu_vma = _RANDOM[5'h6][22];
        data_vpu_vta = _RANDOM[5'h6][23];
        data_vpu_vsew = _RANDOM[5'h6][25:24];
        data_vpu_vlmul = _RANDOM[5'h6][28:26];
        data_vpu_specVill = _RANDOM[5'h6][29];
        data_vpu_specVma = _RANDOM[5'h6][30];
        data_vpu_specVta = _RANDOM[5'h6][31];
        data_vpu_specVsew = _RANDOM[5'h7][1:0];
        data_vpu_specVlmul = _RANDOM[5'h7][4:2];
        data_vpu_vm = _RANDOM[5'h7][5];
        data_vpu_vstart = _RANDOM[5'h7][13:6];
        data_vpu_fpu_isFoldTo1_2 = _RANDOM[5'h7][21];
        data_vpu_fpu_isFoldTo1_4 = _RANDOM[5'h7][22];
        data_vpu_fpu_isFoldTo1_8 = _RANDOM[5'h7][23];
        data_vpu_nf = _RANDOM[5'hC][12:10];
        data_vpu_veew = _RANDOM[5'hC][14:13];
        data_vpu_isReverse = _RANDOM[5'hC][15];
        data_vpu_isExt = _RANDOM[5'hC][16];
        data_vpu_isNarrow = _RANDOM[5'hC][17];
        data_vpu_isDstMask = _RANDOM[5'hC][18];
        data_vpu_isOpMask = _RANDOM[5'hC][19];
        data_vpu_isDependOldVd = _RANDOM[5'hC][21];
        data_vpu_isWritePartVd = _RANDOM[5'hC][22];
        data_vpu_isVleff = _RANDOM[5'hC][23];
        data_vlsInstr = _RANDOM[5'hD][12];
        data_wfflags = _RANDOM[5'hD][13];
        data_isMove = _RANDOM[5'hD][14];
        data_uopIdx = _RANDOM[5'hD][21:15];
        data_uopSplitType = _RANDOM[5'hD][27:22];
        data_isVset = _RANDOM[5'hD][28];
        data_firstUop = _RANDOM[5'hD][29];
        data_lastUop = _RANDOM[5'hD][30];
        data_numWB = {_RANDOM[5'hD][31], _RANDOM[5'hE][5:0]};
        data_debug_pc = {_RANDOM[5'hE][31:8], _RANDOM[5'hF][25:0]};
        data_debug_debug_seqNum_seqNum =
          {_RANDOM[5'hF][31:26], _RANDOM[5'h10], _RANDOM[5'h11][17:0]};
        data_debug_debug_seqNum_uopIdx = _RANDOM[5'h11][25:18];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
  ...
  assign io_out_bits_debug_pc = data_debug_pc;
  assign io_out_bits_debug_debug_seqNum_seqNum = data_debug_debug_seqNum_seqNum;
  assign io_out_bits_debug_debug_seqNum_uopIdx = data_debug_debug_seqNum_uopIdx;
endmodule
