...
module PTW(
  ...
  wire             perfEvents_0_2_probe = idle & io_req_valid;
  ...
  reg  [1:0]       source;
  wire             perfEvents_1_2_probe = ~idle;
  reg              accessFault;
  ...
  wire             _GEN_3 = perfEvents_0_2_probe & jmp_bitmap_check_w;
  wire             _GEN_4 =
    perfEvents_0_2_probe & io_req_bits_stage1Hit & ~jmp_bitmap_check_w;
  wire             _GEN_5 = _GEN_4 | _GEN_3;
  wire             _GEN_6 = io_resp_ready & io_resp_valid_0;
  wire             _GEN_7 =
    perfEvents_0_2_probe & ~io_req_bits_stage1Hit & ~jmp_bitmap_check_w;
  wire             _GEN_8 =
    ((|io_req_bits_req_info_s2xlate) ? io_csr_vsatp_mode : io_csr_satp_mode) == 4'h9;
  wire             _GEN_9 = _GEN_8 & io_req_bits_l3Hit;
  wire             _GEN_10 = _GEN_9 | io_req_bits_l2Hit;
  wire             _GEN_11 = _GEN_7 | _GEN_3;
  wire             _GEN_12 = _GEN_7 | _GEN_5;
  wire             _check_gpa_high_fail_T = io_req_bits_req_info_s2xlate == 2'h2;
  wire             _GEN_13 = io_hptw_resp_valid & ~w_hptw_resp;
  ...
  wire             _GEN_14 = io_hptw_resp_valid & ~w_last_hptw_resp;
  wire             _GEN_15 = _GEN_14 & stage1Hit;
  wire             _GEN_16 = _GEN_14 & ~stage1Hit;
  wire             _GEN_17 = _GEN_16 | _GEN_15;
  wire             perfEvents_4_2_probe = io_mem_req_ready & io_mem_req_valid_0;
  wire             _GEN_18 =
    level[1] & req_s2xlate != 2'h2 & ~(guestFault | find_pte | accessFault);
  wire             _GEN_19 = mem_addr_update & _GEN_18;
  wire             vs_finish = _GEN_19 & s2xlate;
  wire             _GEN_20 = s2xlate & need_last_s2xlate;
  wire             finish =
    mem_addr_update & ~_GEN_18 & (io_llptw_valid_0 | ~_GEN_20 & io_resp_valid_0);
  wire             _GEN_21 = perfEvents_0_2_probe & io_req_bits_req_info_source == 2'h0;
  wire             _GEN_22 = perfEvents_0_2_probe & io_req_bits_req_info_source == 2'h1;
  wire             _GEN_23 = io_resp_valid_0 & ~io_resp_ready;
  wire             _GEN_24 = _GEN_6 & ppn_af;
  reg              r;
  wire             r_probe = r;
  wire             _GEN_25 = io_mem_req_valid_0 & ~io_mem_req_ready;
  reg              perfEvents_5_2;
  ...
  always @(posedge clock) begin
    ...
    if (_GEN_7) begin
      ppn <= _GEN_10 ? io_req_bits_ppn : current_satp_ppn;
      l3Hit <= _GEN_9;
      l2Hit <= io_req_bits_l2Hit;
    end
    if (_GEN_11)
      vpn <= io_req_bits_req_info_vpn;
    if (perfEvents_0_2_probe) begin
    ...
    hptw_resp_stage2 <= _GEN_15 | ~_GEN_4 & hptw_resp_stage2;
    if (_GEN_16 | _GEN_15 | _GEN_13) begin
        ...
        _GEN_27[full_gvpn_reg_idx] == 2'h0
          ...
          : {_GEN_27[full_gvpn_reg_idx] == 2'h1
               ...
               : _GEN_27[full_gvpn_reg_idx] == 2'h2
                   ...
                   : {_GEN_28[full_gvpn_reg_idx][40:24],
                      _GEN_26[full_gvpn_reg_idx][23:0]},
             |full_gvpn_reg_idx_hi,
             |(_full_gvpn_reg_idx_T_2[2:1]),
             _full_gvpn_reg_idx_T_4};
    ...
    io_perf_4_value_REG <= perfEvents_4_2_probe;
  ...
  wire             _GEN_32 = ~_GEN_5 & need_last_s2xlate;
  wire [1:0]       _GEN_33 =
    io_req_bits_l2Hit ? 2'h1 : _GEN_8 ? {1'h1, ~io_req_bits_l3Hit} : 2'h2;
  wire [14:0]      gvpn_wire = _GEN_10 ? io_req_bits_ppn[43:29] : current_satp_ppn[43:29];
  wire             _GEN_34 = ~_GEN_7 & (_GEN_6 & stage1Hit | ~_GEN_5 & idle);
  ...
  wire             _GEN_35 = (&io_req_bits_req_info_s2xlate) & check_gpa_high_fail_1;
  wire             _GEN_36 = io_hptw_req_ready & io_hptw_req_valid_0;
  wire             _GEN_37 = _GEN_36 & ~s_hptw_req;
  wire             _GEN_38 = _hptw_resp_gpf_T | io_hptw_resp_bits_h_resp_gaf;
  wire             _GEN_39 =
    (~_GEN_13 | ~_GEN_38)
    & (_GEN_7
         ? ~_check_gpa_high_fail_T & (&io_req_bits_req_info_s2xlate)
           & (~check_gpa_high_fail_1 | _GEN_32)
         : _GEN_32);
  wire             _GEN_40 = _GEN_36 & ~s_last_hptw_req;
  wire             _GEN_41 = sent_to_pmp & ~mem_addr_update;
  wire             _GEN_42 = accessFault & ~idle;
  wire             _GEN_43 = guestFault & ~idle;
  wire             _GEN_44 = _GEN_43 | _GEN_42;
  wire             _GEN_45 = io_mem_resp_valid & ~w_mem_resp;
  wire             _GEN_46 =
    bitmap_enable & (~(|req_s2xlate) | onlyS1xlate) & (_find_pte_T | pte_perm_w)
    & pte_perm_v & ~pageFault;
  wire             _GEN_47 =
    (~whether_need_bitmap_check | _GEN_46) & (~_GEN_45 | bitmap_enable)
    & (_GEN_44 | s_llptw_req);
  wire             _GEN_48 = io_bitmap_req_ready & ~s_bitmap_check;
  wire             _GEN_49 = ~w_bitmap_resp & io_bitmap_resp_valid;
  wire             _GEN_50 =
    _GEN_49 | whether_need_bitmap_check & ~_GEN_46 | _GEN_45 & ~bitmap_enable | _GEN_43
    | _GEN_42 | _GEN_16 | _GEN_13 & _GEN_38
    | (_GEN_7
         ? (_check_gpa_high_fail_T
              ? check_gpa_high_fail | mem_addr_update
              : _GEN_35 | mem_addr_update)
         : mem_addr_update);
  wire             _GEN_51 = io_llptw_ready & io_llptw_valid_0;
  wire             _GEN_52 = ~mem_addr_update | _GEN_18;
  wire             _GEN_53 = guestFault | accessFault | pageFault | ppn_af;
  wire             _GEN_54 = ~_GEN_20 & _GEN_6;
  wire             _GEN_55 = _GEN_18 | io_llptw_valid_0 | _GEN_20;
  wire             _GEN_56 = ~mem_addr_update | _GEN_55 | ~_GEN_6;
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      s_pmp_check <=
        ...
        & (~_GEN_7 | _check_gpa_high_fail_T | (&io_req_bits_req_info_s2xlate))
        & s_pmp_check;
      s_mem_req <=
        flush | (~_GEN_19 | s2xlate)
        & (perfEvents_4_2_probe | _GEN_44 | ~_GEN_41 & s_mem_req);
      s_llptw_req <=
        flush
        | (mem_addr_update
             ? _GEN_18 | (io_llptw_valid_0 ? _GEN_51 | _GEN_47 : _GEN_54 | _GEN_47)
             : _GEN_47);
      w_mem_resp <= flush | _GEN_45 | ~perfEvents_4_2_probe & (_GEN_44 | w_mem_resp);
      s_hptw_req <=
        flush | ~(mem_addr_update & _GEN_18 & s2xlate)
        & (_GEN_43 | _GEN_42 | _GEN_37
           | (~_GEN_7 | _check_gpa_high_fail_T | ~(&io_req_bits_req_info_s2xlate)
              | check_gpa_high_fail_1) & s_hptw_req);
      w_hptw_resp <= flush | _GEN_43 | _GEN_42 | _GEN_13 | ~_GEN_37 & w_hptw_resp;
      s_last_hptw_req <=
        flush | (~mem_addr_update | _GEN_18 | io_llptw_valid_0 | ~(_GEN_20 & ~_GEN_53))
        & (_GEN_43 | _GEN_42 | _GEN_40
           | (~(_GEN_7 & _check_gpa_high_fail_T) | check_gpa_high_fail) & ~_GEN_4
           & s_last_hptw_req);
      w_last_hptw_resp <=
        flush | _GEN_43 | _GEN_42 | _GEN_17 | ~_GEN_40 & w_last_hptw_resp;
      mem_addr_update <=
        ~flush
        & (mem_addr_update
             ? ~_GEN_18
               & (io_llptw_valid_0
                    ? ~_GEN_51 & _GEN_50
                    : _GEN_20 ? _GEN_53 & _GEN_50 : ~_GEN_6 & _GEN_50)
             : _GEN_50);
      s_bitmap_check <=
        flush | _GEN_48 | ~(whether_need_bitmap_check & _GEN_46)
        & (_GEN_44 | ~_GEN_3 & s_bitmap_check);
      w_bitmap_resp <= flush | _GEN_49 | ~_GEN_48 & (_GEN_44 | w_bitmap_resp);
      whether_need_bitmap_check <=
        ~(flush | whether_need_bitmap_check)
        & (_GEN_45 ? bitmap_enable : ~_GEN_44 & whether_need_bitmap_check);
      bitmap_checkfailed <=
        ~flush & _GEN_56
        & (_GEN_49 ? io_bitmap_resp_bits_cf : ~_GEN_44 & bitmap_checkfailed);
      idle <=
        flush
        | (_GEN_52 ? _GEN_34 : io_llptw_valid_0 ? _GEN_51 | _GEN_34 : _GEN_54 | _GEN_34);
      hptw_pageFault <=
        _GEN_16
          ? io_hptw_resp_bits_h_resp_gpf
          : _GEN_13 ? _hptw_resp_gpf_T : ~_GEN_12 & hptw_pageFault;
      hptw_accessFault <=
        _GEN_16 | _GEN_13 ? io_hptw_resp_bits_h_resp_gaf : ~_GEN_12 & hptw_accessFault;
      need_last_s2xlate <=
        _GEN_52
          ? ~_GEN_44 & _GEN_39
          : io_llptw_valid_0
              ? ~(_GEN_51 | _GEN_44) & _GEN_39
              : ~(_GEN_20 | _GEN_44) & _GEN_39;
      first_gvpn_check_fail <=
        ~flush & _GEN_56
        & (_GEN_7
             ? (_check_gpa_high_fail_T
                  ? check_gpa_high_fail | first_gvpn_check_fail
                  : _GEN_35 | first_gvpn_check_fail)
             : first_gvpn_check_fail);
      pte_valid <= _GEN_45 | ~_GEN_7 & (_GEN_3 | pte_valid);
      accessFault <=
        ~flush
        & (~mem_addr_update | _GEN_55 | ~io_resp_valid_0
             ? ~_GEN_11 & _GEN_31
             : ~(_GEN_6 | _GEN_11) & _GEN_31);
      update_full_gvpn_mem_resp <=
        ~update_full_gvpn_mem_resp & (_GEN_45 | update_full_gvpn_mem_resp);
      r <= perfEvents_4_2_probe | ~io_mem_resp_valid & r;
      perfEvents_5_2 <= perfEvents_4_2_probe | ~io_mem_resp_valid & perfEvents_5_2;
    end
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s_bitmap_check = _RANDOM[6'h5][8];
        w_bitmap_resp = _RANDOM[6'h5][9];
        whether_need_bitmap_check = _RANDOM[6'h5][10];
        bitmap_checkfailed = _RANDOM[6'h5][11];
        idle = _RANDOM[6'h5][12];
        hptw_pageFault = _RANDOM[6'h5][13];
        hptw_accessFault = _RANDOM[6'h5][14];
        need_last_s2xlate = _RANDOM[6'h5][15];
        stage1Hit = _RANDOM[6'h5][16];
        stage1_entry_0_tag = {_RANDOM[6'h5][31:17], _RANDOM[6'h6][19:0]};
        stage1_entry_0_asid = {_RANDOM[6'h6][31:20], _RANDOM[6'h7][3:0]};
        stage1_entry_0_vmid = _RANDOM[6'h7][17:4];
        stage1_entry_0_n = _RANDOM[6'h7][18];
        stage1_entry_0_pbmt = _RANDOM[6'h7][20:19];
        stage1_entry_0_perm_d = _RANDOM[6'h7][21];
        stage1_entry_0_perm_a = _RANDOM[6'h7][22];
        stage1_entry_0_perm_g = _RANDOM[6'h7][23];
        stage1_entry_0_perm_u = _RANDOM[6'h7][24];
        stage1_entry_0_perm_x = _RANDOM[6'h7][25];
        stage1_entry_0_perm_w = _RANDOM[6'h7][26];
        stage1_entry_0_perm_r = _RANDOM[6'h7][27];
        stage1_entry_0_level = _RANDOM[6'h7][29:28];
        stage1_entry_0_v = _RANDOM[6'h7][31];
        stage1_entry_0_ppn = {_RANDOM[6'h8], _RANDOM[6'h9][8:0]};
        stage1_entry_0_ppn_low = _RANDOM[6'h9][11:9];
        stage1_entry_0_pf = _RANDOM[6'h9][13];
        stage1_entry_0_cf = _RANDOM[6'h9][14];
        stage1_entry_1_tag = {_RANDOM[6'h9][31:15], _RANDOM[6'hA][17:0]};
        stage1_entry_1_asid = {_RANDOM[6'hA][31:18], _RANDOM[6'hB][1:0]};
        stage1_entry_1_vmid = _RANDOM[6'hB][15:2];
        stage1_entry_1_n = _RANDOM[6'hB][16];
        stage1_entry_1_pbmt = _RANDOM[6'hB][18:17];
        stage1_entry_1_perm_d = _RANDOM[6'hB][19];
        stage1_entry_1_perm_a = _RANDOM[6'hB][20];
        stage1_entry_1_perm_g = _RANDOM[6'hB][21];
        stage1_entry_1_perm_u = _RANDOM[6'hB][22];
        stage1_entry_1_perm_x = _RANDOM[6'hB][23];
        stage1_entry_1_perm_w = _RANDOM[6'hB][24];
        stage1_entry_1_perm_r = _RANDOM[6'hB][25];
        stage1_entry_1_level = _RANDOM[6'hB][27:26];
        stage1_entry_1_v = _RANDOM[6'hB][29];
        stage1_entry_1_ppn = {_RANDOM[6'hB][31:30], _RANDOM[6'hC], _RANDOM[6'hD][6:0]};
        stage1_entry_1_ppn_low = _RANDOM[6'hD][9:7];
        stage1_entry_1_pf = _RANDOM[6'hD][11];
        stage1_entry_1_cf = _RANDOM[6'hD][12];
        stage1_entry_2_tag = {_RANDOM[6'hD][31:13], _RANDOM[6'hE][15:0]};
        stage1_entry_2_asid = _RANDOM[6'hE][31:16];
        stage1_entry_2_vmid = _RANDOM[6'hF][13:0];
        stage1_entry_2_n = _RANDOM[6'hF][14];
        stage1_entry_2_pbmt = _RANDOM[6'hF][16:15];
        stage1_entry_2_perm_d = _RANDOM[6'hF][17];
        stage1_entry_2_perm_a = _RANDOM[6'hF][18];
        stage1_entry_2_perm_g = _RANDOM[6'hF][19];
        stage1_entry_2_perm_u = _RANDOM[6'hF][20];
        stage1_entry_2_perm_x = _RANDOM[6'hF][21];
        stage1_entry_2_perm_w = _RANDOM[6'hF][22];
        stage1_entry_2_perm_r = _RANDOM[6'hF][23];
        stage1_entry_2_level = _RANDOM[6'hF][25:24];
        stage1_entry_2_v = _RANDOM[6'hF][27];
        stage1_entry_2_ppn = {_RANDOM[6'hF][31:28], _RANDOM[6'h10], _RANDOM[6'h11][4:0]};
        stage1_entry_2_ppn_low = _RANDOM[6'h11][7:5];
        stage1_entry_2_pf = _RANDOM[6'h11][9];
        stage1_entry_2_cf = _RANDOM[6'h11][10];
        stage1_entry_3_tag = {_RANDOM[6'h11][31:11], _RANDOM[6'h12][13:0]};
        stage1_entry_3_asid = _RANDOM[6'h12][29:14];
        stage1_entry_3_vmid = {_RANDOM[6'h12][31:30], _RANDOM[6'h13][11:0]};
        stage1_entry_3_n = _RANDOM[6'h13][12];
        stage1_entry_3_pbmt = _RANDOM[6'h13][14:13];
        stage1_entry_3_perm_d = _RANDOM[6'h13][15];
        stage1_entry_3_perm_a = _RANDOM[6'h13][16];
        stage1_entry_3_perm_g = _RANDOM[6'h13][17];
        stage1_entry_3_perm_u = _RANDOM[6'h13][18];
        stage1_entry_3_perm_x = _RANDOM[6'h13][19];
        stage1_entry_3_perm_w = _RANDOM[6'h13][20];
        stage1_entry_3_perm_r = _RANDOM[6'h13][21];
        stage1_entry_3_level = _RANDOM[6'h13][23:22];
        stage1_entry_3_v = _RANDOM[6'h13][25];
        stage1_entry_3_ppn = {_RANDOM[6'h13][31:26], _RANDOM[6'h14], _RANDOM[6'h15][2:0]};
        stage1_entry_3_ppn_low = _RANDOM[6'h15][5:3];
        stage1_entry_3_pf = _RANDOM[6'h15][7];
        stage1_entry_3_cf = _RANDOM[6'h15][8];
        stage1_entry_4_tag = {_RANDOM[6'h15][31:9], _RANDOM[6'h16][11:0]};
        stage1_entry_4_asid = _RANDOM[6'h16][27:12];
        stage1_entry_4_vmid = {_RANDOM[6'h16][31:28], _RANDOM[6'h17][9:0]};
        stage1_entry_4_n = _RANDOM[6'h17][10];
        stage1_entry_4_pbmt = _RANDOM[6'h17][12:11];
        stage1_entry_4_perm_d = _RANDOM[6'h17][13];
        stage1_entry_4_perm_a = _RANDOM[6'h17][14];
        stage1_entry_4_perm_g = _RANDOM[6'h17][15];
        stage1_entry_4_perm_u = _RANDOM[6'h17][16];
        stage1_entry_4_perm_x = _RANDOM[6'h17][17];
        stage1_entry_4_perm_w = _RANDOM[6'h17][18];
        stage1_entry_4_perm_r = _RANDOM[6'h17][19];
        stage1_entry_4_level = _RANDOM[6'h17][21:20];
        stage1_entry_4_v = _RANDOM[6'h17][23];
        stage1_entry_4_ppn = {_RANDOM[6'h17][31:24], _RANDOM[6'h18], _RANDOM[6'h19][0]};
        stage1_entry_4_ppn_low = _RANDOM[6'h19][3:1];
        stage1_entry_4_pf = _RANDOM[6'h19][5];
        stage1_entry_4_cf = _RANDOM[6'h19][6];
        stage1_entry_5_tag = {_RANDOM[6'h19][31:7], _RANDOM[6'h1A][9:0]};
        stage1_entry_5_asid = _RANDOM[6'h1A][25:10];
        stage1_entry_5_vmid = {_RANDOM[6'h1A][31:26], _RANDOM[6'h1B][7:0]};
        stage1_entry_5_n = _RANDOM[6'h1B][8];
        stage1_entry_5_pbmt = _RANDOM[6'h1B][10:9];
        stage1_entry_5_perm_d = _RANDOM[6'h1B][11];
        stage1_entry_5_perm_a = _RANDOM[6'h1B][12];
        stage1_entry_5_perm_g = _RANDOM[6'h1B][13];
        stage1_entry_5_perm_u = _RANDOM[6'h1B][14];
        stage1_entry_5_perm_x = _RANDOM[6'h1B][15];
        stage1_entry_5_perm_w = _RANDOM[6'h1B][16];
        stage1_entry_5_perm_r = _RANDOM[6'h1B][17];
        stage1_entry_5_level = _RANDOM[6'h1B][19:18];
        stage1_entry_5_v = _RANDOM[6'h1B][21];
        stage1_entry_5_ppn = {_RANDOM[6'h1B][31:22], _RANDOM[6'h1C][30:0]};
        stage1_entry_5_ppn_low = {_RANDOM[6'h1C][31], _RANDOM[6'h1D][1:0]};
        stage1_entry_5_pf = _RANDOM[6'h1D][3];
        stage1_entry_5_cf = _RANDOM[6'h1D][4];
        stage1_entry_6_tag = {_RANDOM[6'h1D][31:5], _RANDOM[6'h1E][7:0]};
        stage1_entry_6_asid = _RANDOM[6'h1E][23:8];
        stage1_entry_6_vmid = {_RANDOM[6'h1E][31:24], _RANDOM[6'h1F][5:0]};
        stage1_entry_6_n = _RANDOM[6'h1F][6];
        stage1_entry_6_pbmt = _RANDOM[6'h1F][8:7];
        stage1_entry_6_perm_d = _RANDOM[6'h1F][9];
        stage1_entry_6_perm_a = _RANDOM[6'h1F][10];
        stage1_entry_6_perm_g = _RANDOM[6'h1F][11];
        stage1_entry_6_perm_u = _RANDOM[6'h1F][12];
        stage1_entry_6_perm_x = _RANDOM[6'h1F][13];
        stage1_entry_6_perm_w = _RANDOM[6'h1F][14];
        stage1_entry_6_perm_r = _RANDOM[6'h1F][15];
        stage1_entry_6_level = _RANDOM[6'h1F][17:16];
        stage1_entry_6_v = _RANDOM[6'h1F][19];
        stage1_entry_6_ppn = {_RANDOM[6'h1F][31:20], _RANDOM[6'h20][28:0]};
        stage1_entry_6_ppn_low = _RANDOM[6'h20][31:29];
        stage1_entry_6_pf = _RANDOM[6'h21][1];
        stage1_entry_6_cf = _RANDOM[6'h21][2];
        stage1_entry_7_tag = {_RANDOM[6'h21][31:3], _RANDOM[6'h22][5:0]};
        stage1_entry_7_asid = _RANDOM[6'h22][21:6];
        stage1_entry_7_vmid = {_RANDOM[6'h22][31:22], _RANDOM[6'h23][3:0]};
        stage1_entry_7_n = _RANDOM[6'h23][4];
        stage1_entry_7_pbmt = _RANDOM[6'h23][6:5];
        stage1_entry_7_perm_d = _RANDOM[6'h23][7];
        stage1_entry_7_perm_a = _RANDOM[6'h23][8];
        stage1_entry_7_perm_g = _RANDOM[6'h23][9];
        stage1_entry_7_perm_u = _RANDOM[6'h23][10];
        stage1_entry_7_perm_x = _RANDOM[6'h23][11];
        stage1_entry_7_perm_w = _RANDOM[6'h23][12];
        stage1_entry_7_perm_r = _RANDOM[6'h23][13];
        stage1_entry_7_level = _RANDOM[6'h23][15:14];
        stage1_entry_7_v = _RANDOM[6'h23][17];
        stage1_entry_7_ppn = {_RANDOM[6'h23][31:18], _RANDOM[6'h24][26:0]};
        stage1_entry_7_ppn_low = _RANDOM[6'h24][29:27];
        stage1_entry_7_pf = _RANDOM[6'h24][31];
        stage1_entry_7_cf = _RANDOM[6'h25][0];
        stage1_pteidx_0 = _RANDOM[6'h25][1];
        stage1_pteidx_1 = _RANDOM[6'h25][2];
        stage1_pteidx_2 = _RANDOM[6'h25][3];
        stage1_pteidx_3 = _RANDOM[6'h25][4];
        stage1_pteidx_4 = _RANDOM[6'h25][5];
        stage1_pteidx_5 = _RANDOM[6'h25][6];
        stage1_pteidx_6 = _RANDOM[6'h25][7];
        stage1_pteidx_7 = _RANDOM[6'h25][8];
        stage1_not_super = _RANDOM[6'h25][9];
        hptw_resp_stage2 = _RANDOM[6'h25][11];
        first_gvpn_check_fail = _RANDOM[6'h25][12];
        pte_valid = _RANDOM[6'h25][13];
        source = _RANDOM[6'h25][15:14];
        accessFault = _RANDOM[6'h25][16];
        hptw_resp_entry_tag = {_RANDOM[6'h25][31:17], _RANDOM[6'h26][22:0]};
        hptw_resp_entry_vmid = _RANDOM[6'h27][20:7];
        hptw_resp_entry_n = _RANDOM[6'h27][21];
        hptw_resp_entry_pbmt = _RANDOM[6'h27][23:22];
        hptw_resp_entry_ppn = {_RANDOM[6'h27][31:24], _RANDOM[6'h28][29:0]};
        hptw_resp_entry_perm_d = _RANDOM[6'h28][30];
        hptw_resp_entry_perm_a = _RANDOM[6'h28][31];
        hptw_resp_entry_perm_g = _RANDOM[6'h29][0];
        hptw_resp_entry_perm_u = _RANDOM[6'h29][1];
        hptw_resp_entry_perm_x = _RANDOM[6'h29][2];
        hptw_resp_entry_perm_w = _RANDOM[6'h29][3];
        hptw_resp_entry_perm_r = _RANDOM[6'h29][4];
        hptw_resp_entry_level = _RANDOM[6'h29][6:5];
        hptw_resp_gpf = _RANDOM[6'h29][9];
        hptw_resp_gaf = _RANDOM[6'h29][10];
        update_full_gvpn_mem_resp = _RANDOM[6'h29][11];
        full_gvpn_reg = {_RANDOM[6'h29][31:12], _RANDOM[6'h2A][23:0]};
        cache_level = _RANDOM[6'h2A][25:24];
        r = _RANDOM[6'h2A][26];
        perfEvents_5_2 = _RANDOM[6'h2A][27];
        io_perf_0_value_REG = _RANDOM[6'h2A][28];
        io_perf_0_value_REG_1 = _RANDOM[6'h2A][29];
        io_perf_1_value_REG = _RANDOM[6'h2A][30];
        io_perf_1_value_REG_1 = _RANDOM[6'h2A][31];
        io_perf_2_value_REG = _RANDOM[6'h2B][0];
        io_perf_2_value_REG_1 = _RANDOM[6'h2B][1];
        io_perf_3_value_REG = _RANDOM[6'h2B][2];
        io_perf_3_value_REG_1 = _RANDOM[6'h2B][3];
        io_perf_4_value_REG = _RANDOM[6'h2B][4];
        io_perf_4_value_REG_1 = _RANDOM[6'h2B][5];
        io_perf_5_value_REG = _RANDOM[6'h2B][6];
        io_perf_5_value_REG_1 = _RANDOM[6'h2B][7];
        io_perf_6_value_REG = _RANDOM[6'h2B][8];
        io_perf_6_value_REG_1 = _RANDOM[6'h2B][9];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        level = 2'h3;
        af_level = 2'h3;
