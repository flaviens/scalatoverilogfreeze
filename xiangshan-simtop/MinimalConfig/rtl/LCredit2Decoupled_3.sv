...
module LCredit2Decoupled_3(
  ...
  wire [4:0] lcreditInflight_probe = lcreditInflight;
  reg  [4:0] lcreditPool;
  wire       accept_probe = (|lcreditInflight) & io_in_flitv;
  reg        io_in_lcrdv_REG;
  `ifndef SYNTHESIS
    always @(posedge clock) begin
      if (~reset & 5'(lcreditInflight + lcreditPool) != 5'hF) begin
  ...
  wire       _GEN_0 = &_queue_io_count;
  wire       exHalf_probe = _queue_io_count[3];
  wire       empty_probe = _queue_io_count == 4'h0;
