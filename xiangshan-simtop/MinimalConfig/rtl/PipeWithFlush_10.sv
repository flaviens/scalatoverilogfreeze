  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        bits_1_robIdx_flag = _RANDOM[7'h9][20];
        bits_1_robIdx_value = _RANDOM[7'h9][26:21];
        bits_1_pdest = _RANDOM[7'hA][8:1];
        bits_1_fpWen = _RANDOM[7'hA][10];
        bits_1_vecWen = _RANDOM[7'hA][11];
        bits_1_v0Wen = _RANDOM[7'hA][12];
        bits_1_loadDependency_0 = _RANDOM[7'hB][9:8];
        bits_1_loadDependency_1 = _RANDOM[7'hB][11:10];
        bits_1_loadDependency_2 = _RANDOM[7'hB][13:12];
        bits_2_robIdx_flag = _RANDOM[7'h29][0];
        bits_2_robIdx_value = _RANDOM[7'h29][6:1];
        bits_2_pdest = _RANDOM[7'h29][20:13];
        bits_2_fpWen = _RANDOM[7'h29][22];
        bits_2_vecWen = _RANDOM[7'h29][23];
        bits_2_v0Wen = _RANDOM[7'h29][24];
        bits_2_loadDependency_0 = _RANDOM[7'h2A][21:20];
        bits_2_loadDependency_1 = _RANDOM[7'h2A][23:22];
        bits_2_loadDependency_2 = _RANDOM[7'h2A][25:24];
        bits_3_robIdx_flag = _RANDOM[7'h48][12];
        bits_3_robIdx_value = _RANDOM[7'h48][18:13];
        bits_3_pdest = {_RANDOM[7'h48][31:25], _RANDOM[7'h49][0]};
        bits_3_fpWen = _RANDOM[7'h49][2];
        bits_3_vecWen = _RANDOM[7'h49][3];
        bits_3_v0Wen = _RANDOM[7'h49][4];
        bits_3_loadDependency_0 = _RANDOM[7'h4A][1:0];
        bits_3_loadDependency_1 = _RANDOM[7'h4A][3:2];
        bits_3_loadDependency_2 = _RANDOM[7'h4A][5:4];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_1 = 1'h0;
        valids_2 = 1'h0;
