  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        full = _RANDOM[3'h0][0];
        saved_opcode = _RANDOM[3'h0][4:1];
        saved_size = _RANDOM[3'h0][9:8];
        saved_source = _RANDOM[3'h0][24:10];
        saved_address = {_RANDOM[3'h0][31:25], _RANDOM[3'h1][23:0]};
        saved_user_amba_prot_bufferable = _RANDOM[3'h1][24];
        saved_user_amba_prot_modifiable = _RANDOM[3'h1][25];
        saved_user_amba_prot_readalloc = _RANDOM[3'h1][26];
        saved_user_amba_prot_writealloc = _RANDOM[3'h1][27];
        saved_user_amba_prot_privileged = _RANDOM[3'h1][28];
        saved_user_amba_prot_secure = _RANDOM[3'h1][29];
        saved_user_amba_prot_fetch = _RANDOM[3'h1][30];
        saved_mask = {_RANDOM[3'h1][31], _RANDOM[3'h2][6:0]};
        saved_data = {_RANDOM[3'h2][31:7], _RANDOM[3'h3], _RANDOM[3'h4][6:0]};
      `endif // RANDOMIZE_REG_INIT
    end // initial
