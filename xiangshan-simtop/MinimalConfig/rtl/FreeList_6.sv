...
module FreeList_6(
  ...
  wire            _remFreeSelIndexOHVec_highIndexOH_T =
    freeMask[0] & _remFreeSelMaskVec_T_15[0];
  wire            _remFreeSelIndexOHVec_highIndexOH_T_1 =
    freeMask[4] & _remFreeSelMaskVec_T_15[4];
  wire [1:0]      remFreeSelMaskVec_0 =
    {_remFreeSelIndexOHVec_highIndexOH_T_1, _remFreeSelIndexOHVec_highIndexOH_T};
  wire            _remFreeSelIndexOHVec_highIndexOH_T_3 =
    freeMask[1] & _remFreeSelMaskVec_T_15[1];
  wire            _remFreeSelIndexOHVec_highIndexOH_T_4 =
    freeMask[5] & _remFreeSelMaskVec_T_15[5];
  wire [1:0]      remFreeSelMaskVec_1 =
    {_remFreeSelIndexOHVec_highIndexOH_T_4, _remFreeSelIndexOHVec_highIndexOH_T_3};
  wire            _remFreeSelIndexOHVec_highIndexOH_T_6 =
    freeMask[2] & _remFreeSelMaskVec_T_15[2];
  wire            _remFreeSelIndexOHVec_highIndexOH_T_7 =
    freeMask[6] & _remFreeSelMaskVec_T_15[6];
  wire [1:0]      remFreeSelMaskVec_2 =
    {_remFreeSelIndexOHVec_highIndexOH_T_7, _remFreeSelIndexOHVec_highIndexOH_T_6};
  wire            _remFreeSelIndexOHVec_highIndexOH_T_9 =
    freeMask[3] & _remFreeSelMaskVec_T_15[3];
  wire            _remFreeSelIndexOHVec_highIndexOH_T_10 =
    freeMask[7] & _remFreeSelMaskVec_T_15[7];
  wire [1:0]      remFreeSelMaskVec_3 =
    {_remFreeSelIndexOHVec_highIndexOH_T_10, _remFreeSelIndexOHVec_highIndexOH_T_9};
  wire [1:0]      remFreeSelIndexOHVec_highIndexOH =
    _remFreeSelIndexOHVec_highIndexOH_T
      ? 2'h1
      : {_remFreeSelIndexOHVec_highIndexOH_T_1, 1'h0};
  ...
  wire [1:0]      remFreeSelIndexOHVec_highIndexOH_1 =
    _remFreeSelIndexOHVec_highIndexOH_T_3
      ? 2'h1
      : {_remFreeSelIndexOHVec_highIndexOH_T_4, 1'h0};
  ...
  wire [1:0]      remFreeSelIndexOHVec_highIndexOH_2 =
    _remFreeSelIndexOHVec_highIndexOH_T_6
      ? 2'h1
      : {_remFreeSelIndexOHVec_highIndexOH_T_7, 1'h0};
  ...
  wire [1:0]      remFreeSelIndexOHVec_highIndexOH_3 =
    _remFreeSelIndexOHVec_highIndexOH_T_9
      ? 2'h1
      : {_remFreeSelIndexOHVec_highIndexOH_T_10, 1'h0};
  ...
  wire [2:0]      _enqPtr_new_ptr_T_13 = 3'(tailPtr_value + _GEN_3);
  ...
  wire [2:0]      _GEN_5 = {1'h0, 2'(_GEN_4 + {1'h0, freeReq_next_nextVec_3_r})};
  wire [3:0]      _tailPtrNext_new_ptr_T_1 =
    4'({tailPtr_flag, tailPtr_value} + {1'h0, 3'(_GEN_3 + _GEN_5)});
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (freeReq_next_nextVec_3_r & _enqPtr_new_ptr_T_19 == 3'h0)
        freeList_0 <= _freeList_T_27;
      else if (freeReq_next_nextVec_2_r & _enqPtr_new_ptr_T_13 == 3'h0)
        freeList_0 <= _freeList_T_20;
      else if (freeReq_next_nextVec_1_r & _enqPtr_new_ptr_T_7 == 3'h0)
      ...
      else if (freeReq_next_nextVec_2_r & _enqPtr_new_ptr_T_13 == 3'h1)
      ...
      if (freeReq_next_nextVec_3_r & _enqPtr_new_ptr_T_19 == 3'h2)
        freeList_2 <= _freeList_T_27;
      else if (freeReq_next_nextVec_2_r & _enqPtr_new_ptr_T_13 == 3'h2)
        freeList_2 <= _freeList_T_20;
      else if (freeReq_next_nextVec_1_r & _enqPtr_new_ptr_T_7 == 3'h2)
        freeList_2 <= _freeList_T_13;
      else if (freeReq_next_nextVec_0_r & tailPtr_value == 3'h2)
        freeList_2 <= _freeList_T_6;
      if (freeReq_next_nextVec_3_r & _enqPtr_new_ptr_T_19 == 3'h3)
        freeList_3 <= _freeList_T_27;
      else if (freeReq_next_nextVec_2_r & _enqPtr_new_ptr_T_13 == 3'h3)
        freeList_3 <= _freeList_T_20;
      else if (freeReq_next_nextVec_1_r & _enqPtr_new_ptr_T_7 == 3'h3)
        freeList_3 <= _freeList_T_13;
      else if (freeReq_next_nextVec_0_r & tailPtr_value == 3'h3)
        freeList_3 <= _freeList_T_6;
      if (freeReq_next_nextVec_3_r & _enqPtr_new_ptr_T_19 == 3'h4)
        freeList_4 <= _freeList_T_27;
      else if (freeReq_next_nextVec_2_r & _enqPtr_new_ptr_T_13 == 3'h4)
        freeList_4 <= _freeList_T_20;
      else if (freeReq_next_nextVec_1_r & _enqPtr_new_ptr_T_7 == 3'h4)
        freeList_4 <= _freeList_T_13;
      else if (freeReq_next_nextVec_0_r & tailPtr_value == 3'h4)
        freeList_4 <= _freeList_T_6;
      if (freeReq_next_nextVec_3_r & _enqPtr_new_ptr_T_19 == 3'h5)
        freeList_5 <= _freeList_T_27;
      else if (freeReq_next_nextVec_2_r & _enqPtr_new_ptr_T_13 == 3'h5)
        freeList_5 <= _freeList_T_20;
      else if (freeReq_next_nextVec_1_r & _enqPtr_new_ptr_T_7 == 3'h5)
        freeList_5 <= _freeList_T_13;
      else if (freeReq_next_nextVec_0_r & tailPtr_value == 3'h5)
        freeList_5 <= _freeList_T_6;
      if (freeReq_next_nextVec_3_r & _enqPtr_new_ptr_T_19 == 3'h6)
        freeList_6 <= _freeList_T_27;
      else if (freeReq_next_nextVec_2_r & _enqPtr_new_ptr_T_13 == 3'h6)
        freeList_6 <= _freeList_T_20;
      else if (freeReq_next_nextVec_1_r & _enqPtr_new_ptr_T_7 == 3'h6)
      ...
      freeSlotCnt <= 4'(4'(freeSlotCnt + {1'h0, 3'(_GEN_3 + _GEN_5)}) - _GEN_0);
    end
  ...
  wire [7:0][2:0] _GEN_6 =
    {{freeList_7},
     ...
     {freeList_1},
     {freeList_0}};
  wire [3:0]      _deqPtr_new_ptr_T_19 = 4'(_GEN + 4'(_GEN_0 + 4'h1));
  wire [3:0]      _deqPtr_new_ptr_T_31 = 4'(_GEN + 4'(_GEN_0 + 4'h2));
  always @(posedge clock) begin
    io_canAllocate_0_r <=
      _deqPtr_new_ptr_T_1[3] ^ tailPtr_flag ^ _deqPtr_new_ptr_T_1[2:0] < tailPtr_value;
    io_allocateSlot_0_r <= _GEN_6[_deqPtr_new_ptr_T_1[2:0]];
    io_canAllocate_1_r <=
      _deqPtr_new_ptr_T_19[3] ^ tailPtr_flag ^ _deqPtr_new_ptr_T_19[2:0] < tailPtr_value;
    io_allocateSlot_1_r <= _GEN_6[_deqPtr_new_ptr_T_19[2:0]];
    io_canAllocate_2_r <=
      _deqPtr_new_ptr_T_31[3] ^ tailPtr_flag ^ _deqPtr_new_ptr_T_31[2:0] < tailPtr_value;
    io_allocateSlot_2_r <= _GEN_6[_deqPtr_new_ptr_T_31[2:0]];
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        freeSlotCnt = _RANDOM[2'h2][15:12];
