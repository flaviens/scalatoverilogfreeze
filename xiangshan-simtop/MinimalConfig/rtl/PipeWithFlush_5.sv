  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        bits_1_is0Lat = _RANDOM[6'h5][15];
        bits_1_robIdx_flag = _RANDOM[6'h7][20];
        bits_1_robIdx_value = _RANDOM[6'h7][26:21];
        bits_1_pdest = _RANDOM[6'h8][5:0];
        bits_1_rfWen = _RANDOM[6'h8][6];
        bits_1_loadDependency_0 = _RANDOM[6'h8][24:23];
        bits_1_loadDependency_1 = _RANDOM[6'h8][26:25];
        bits_1_loadDependency_2 = _RANDOM[6'h8][28:27];
        bits_2_is0Lat = _RANDOM[6'h22][11];
        bits_2_robIdx_flag = _RANDOM[6'h24][16];
        bits_2_robIdx_value = _RANDOM[6'h24][22:17];
        bits_2_pdest = {_RANDOM[6'h24][31:28], _RANDOM[6'h25][1:0]};
        bits_2_rfWen = _RANDOM[6'h25][2];
        bits_2_loadDependency_0 = _RANDOM[6'h25][20:19];
        bits_2_loadDependency_1 = _RANDOM[6'h25][22:21];
        bits_2_loadDependency_2 = _RANDOM[6'h25][24:23];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_1 = 1'h0;
        valids_2 = 1'h0;
