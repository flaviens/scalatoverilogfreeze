...
module FastArbiter(
  ...
  assign io_out_bits_robIdx_value =
    (chosenOH[0] ? io_in_0_bits_robIdx_value : 6'h0)
    | (chosenOH[1] ? io_in_1_bits_robIdx_value : 6'h0)
    | (chosenOH[2] ? io_in_2_bits_robIdx_value : 6'h0)
    | (chosenOH[3] ? io_in_3_bits_robIdx_value : 6'h0);
  ...
  assign io_out_bits_id =
    (chosenOH[0] ? io_in_0_bits_id : 5'h0) | (chosenOH[1] ? io_in_1_bits_id : 5'h0)
    | (chosenOH[2] ? io_in_2_bits_id : 5'h0) | (chosenOH[3] ? io_in_3_bits_id : 5'h0);
  assign io_out_bits_nc =
    chosenOH[0] & io_in_0_bits_nc | chosenOH[1] & io_in_1_bits_nc | chosenOH[2]
    & io_in_2_bits_nc | chosenOH[3] & io_in_3_bits_nc;
