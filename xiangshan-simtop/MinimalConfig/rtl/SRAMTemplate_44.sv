...
module SRAMTemplate_44(
  ...
  output [3:0]  io_r_resp_data_0_cfiPosition,
  ...
  input  [3:0]  io_w_req_bits_data_0_cfiPosition,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        respReg = _RANDOM[2'h1][9];
        rdataReg = _RANDOM[2'h3][26:10];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        _resetState = 1'h1;
        _resetSet = 7'h0;
  ...
  sram_array_1p128x17m17s1h0l1b_bpu_utage array (
  ...
  assign io_r_resp_data_0_tag = _array_RW0_rdata[15:8];
  assign io_r_resp_data_0_cfiPosition = _array_RW0_rdata[7:4];
