...
module RegCacheDataModule_1(
  ...
  `ifndef SYNTHESIS
    ...
    always @(posedge clock) begin
      if (io_readPorts_0_ren & ~reset & ~_GEN_0[io_readPorts_0_addr[3:0]]) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: MemRegCache readPorts 0 read a invalid entry\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (io_readPorts_1_ren & ~reset & ~_GEN_0[io_readPorts_1_addr[3:0]]) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: MemRegCache readPorts 1 read a invalid entry\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (io_readPorts_2_ren & ~reset & ~_GEN_0[io_readPorts_2_addr[3:0]]) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: MemRegCache readPorts 2 read a invalid entry\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (io_readPorts_3_ren & ~reset & ~_GEN_0[io_readPorts_3_addr[3:0]]) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: MemRegCache readPorts 3 read a invalid entry\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (io_readPorts_4_ren & ~reset & ~_GEN_0[io_readPorts_4_addr[3:0]]) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: MemRegCache readPorts 4 read a invalid entry\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (io_readPorts_5_ren & ~reset & ~_GEN_0[io_readPorts_5_addr[3:0]]) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: MemRegCache readPorts 5 read a invalid entry\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (io_readPorts_6_ren & ~reset & ~_GEN_0[io_readPorts_6_addr[3:0]]) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: MemRegCache readPorts 6 read a invalid entry\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (io_readPorts_7_ren & ~reset & ~_GEN_0[io_readPorts_7_addr[3:0]]) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: MemRegCache readPorts 7 read a invalid entry\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (io_readPorts_8_ren & ~reset & ~_GEN_0[io_readPorts_8_addr[3:0]]) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: MemRegCache readPorts 8 read a invalid entry\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (io_readPorts_9_ren & ~reset & ~_GEN_0[io_readPorts_9_addr[3:0]]) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: MemRegCache readPorts 9 read a invalid entry\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (io_readPorts_10_ren & ~reset & ~_GEN_0[io_readPorts_10_addr[3:0]]) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: MemRegCache readPorts 10 read a invalid entry\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (io_readPorts_11_ren & ~reset & ~_GEN_0[io_readPorts_11_addr[3:0]]) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: MemRegCache readPorts 11 read a invalid entry\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (io_readPorts_12_ren & ~reset & ~_GEN_0[io_readPorts_12_addr[3:0]]) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: MemRegCache readPorts 12 read a invalid entry\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (io_readPorts_13_ren & ~reset & ~_GEN_0[io_readPorts_13_addr[3:0]]) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: MemRegCache readPorts 13 read a invalid entry\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (io_readPorts_14_ren & ~reset & ~_GEN_0[io_readPorts_14_addr[3:0]]) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: MemRegCache readPorts 14 read a invalid entry\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (io_readPorts_15_ren & ~reset & ~_GEN_0[io_readPorts_15_addr[3:0]]) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: MemRegCache readPorts 15 read a invalid entry\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (io_readPorts_16_ren & ~reset & ~_GEN_0[io_readPorts_16_addr[3:0]]) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: MemRegCache readPorts 16 read a invalid entry\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (io_readPorts_17_ren & ~reset & ~_GEN_0[io_readPorts_17_addr[3:0]]) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: MemRegCache readPorts 17 read a invalid entry\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (io_readPorts_18_ren & ~reset & ~_GEN_0[io_readPorts_18_addr[3:0]]) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: MemRegCache readPorts 18 read a invalid entry\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (io_readPorts_19_ren & ~reset & ~_GEN_0[io_readPorts_19_addr[3:0]]) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: MemRegCache readPorts 19 read a invalid entry\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (io_readPorts_20_ren & ~reset & ~_GEN_0[io_readPorts_20_addr[3:0]]) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: MemRegCache readPorts 20 read a invalid entry\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (io_readPorts_21_ren & ~reset & ~_GEN_0[io_readPorts_21_addr[3:0]]) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: MemRegCache readPorts 21 read a invalid entry\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (io_readPorts_22_ren & ~reset & ~_GEN_0[io_readPorts_22_addr[3:0]]) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: MemRegCache readPorts 22 read a invalid entry\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (io_readPorts_23_ren & ~reset & ~_GEN_0[io_readPorts_23_addr[3:0]]) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: MemRegCache readPorts 23 read a invalid entry\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (io_readPorts_24_ren & ~reset & ~_GEN_0[io_readPorts_24_addr[3:0]]) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: MemRegCache readPorts 24 read a invalid entry\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (~reset
        ...
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: MemRegCache has two or more writePorts writing the same entry\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
  ...
  wire [2:0]        _GEN_1 = {wenOH_2, wenOH_1, wenOH_0};
  ...
  wire [2:0]        _GEN_2 = {wenOH_1_2, wenOH_1_1, wenOH_1_0};
  ...
  wire [2:0]        _GEN_3 = {wenOH_2_2, wenOH_2_1, wenOH_2_0};
  ...
  wire [2:0]        _GEN_4 = {wenOH_3_2, wenOH_3_1, wenOH_3_0};
  ...
  wire [2:0]        _GEN_5 = {wenOH_4_2, wenOH_4_1, wenOH_4_0};
  ...
  wire [2:0]        _GEN_6 = {wenOH_5_2, wenOH_5_1, wenOH_5_0};
  ...
  wire [2:0]        _GEN_7 = {wenOH_6_2, wenOH_6_1, wenOH_6_0};
  ...
  wire [2:0]        _GEN_8 = {wenOH_7_2, wenOH_7_1, wenOH_7_0};
  ...
  wire [2:0]        _GEN_9 = {wenOH_8_2, wenOH_8_1, wenOH_8_0};
  ...
  wire [2:0]        _GEN_10 = {wenOH_9_2, wenOH_9_1, wenOH_9_0};
  ...
  wire [2:0]        _GEN_11 = {wenOH_10_2, wenOH_10_1, wenOH_10_0};
  ...
  wire [2:0]        _GEN_12 = {wenOH_11_2, wenOH_11_1, wenOH_11_0};
