...
module BoomIOMSHR(	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7]
  ...
  input  [15:0]  io_req_bits_uop_br_mask,	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:405:14]
  input  [3:0]   io_req_bits_uop_br_tag,	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:405:14]
  input  [4:0]   io_req_bits_uop_ftq_idx,	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:405:14]
  ...
  input  [4:0]   io_req_bits_uop_ppred,	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:405:14]
  ...
  output [15:0]  io_resp_bits_uop_br_mask,	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:405:14]
  output [3:0]   io_resp_bits_uop_br_tag,	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:405:14]
  output [4:0]   io_resp_bits_uop_ftq_idx,	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:405:14]
  ...
  output [4:0]   io_resp_bits_uop_ppred,	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:405:14]
  ...
  output [2:0]   io_mem_access_bits_source,	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:405:14]
  ...
  reg  [15:0]  req_uop_br_mask;	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:421:16]
  reg  [3:0]   req_uop_br_tag;	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:421:16]
  reg  [4:0]   req_uop_ftq_idx;	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:421:16]
  ...
  reg  [4:0]   req_uop_ppred;	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:421:16]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7]
    ...
    initial begin	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7]
        ...
        req_uop_br_mask = {_RANDOM[5'h4][31:29], _RANDOM[5'h5][12:0]};	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_br_tag = _RANDOM[5'h5][16:13];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_ftq_idx = _RANDOM[5'h5][21:17];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_edge_inst = _RANDOM[5'h5][22];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_pc_lob = _RANDOM[5'h5][28:23];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_taken = _RANDOM[5'h5][29];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_imm_packed = {_RANDOM[5'h5][31:30], _RANDOM[5'h6][17:0]};	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_csr_addr = _RANDOM[5'h6][29:18];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_rob_idx = {_RANDOM[5'h6][31:30], _RANDOM[5'h7][4:0]};	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_ldq_idx = _RANDOM[5'h7][9:5];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_stq_idx = _RANDOM[5'h7][14:10];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_rxq_idx = _RANDOM[5'h7][16:15];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_pdst = _RANDOM[5'h7][23:17];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_prs1 = _RANDOM[5'h7][30:24];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_prs2 = {_RANDOM[5'h7][31], _RANDOM[5'h8][5:0]};	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_prs3 = _RANDOM[5'h8][12:6];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_ppred = _RANDOM[5'h8][17:13];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_prs1_busy = _RANDOM[5'h8][18];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_prs2_busy = _RANDOM[5'h8][19];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_prs3_busy = _RANDOM[5'h8][20];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_ppred_busy = _RANDOM[5'h8][21];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_stale_pdst = _RANDOM[5'h8][28:22];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_exception = _RANDOM[5'h8][29];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_exc_cause = {_RANDOM[5'h8][31:30], _RANDOM[5'h9], _RANDOM[5'hA][29:0]};	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_bypassable = _RANDOM[5'hA][30];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_mem_cmd = {_RANDOM[5'hA][31], _RANDOM[5'hB][3:0]};	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_mem_size = _RANDOM[5'hB][5:4];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_mem_signed = _RANDOM[5'hB][6];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_is_fence = _RANDOM[5'hB][7];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_is_fencei = _RANDOM[5'hB][8];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_is_amo = _RANDOM[5'hB][9];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_uses_ldq = _RANDOM[5'hB][10];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_uses_stq = _RANDOM[5'hB][11];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_is_sys_pc2epc = _RANDOM[5'hB][12];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_is_unique = _RANDOM[5'hB][13];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_flush_on_commit = _RANDOM[5'hB][14];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_ldst_is_rs1 = _RANDOM[5'hB][15];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_ldst = _RANDOM[5'hB][21:16];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_lrs1 = _RANDOM[5'hB][27:22];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_lrs2 = {_RANDOM[5'hB][31:28], _RANDOM[5'hC][1:0]};	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_lrs3 = _RANDOM[5'hC][7:2];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_ldst_val = _RANDOM[5'hC][8];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_dst_rtype = _RANDOM[5'hC][10:9];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_lrs1_rtype = _RANDOM[5'hC][12:11];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_lrs2_rtype = _RANDOM[5'hC][14:13];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_frs3_en = _RANDOM[5'hC][15];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_fp_val = _RANDOM[5'hC][16];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_fp_single = _RANDOM[5'hC][17];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_xcpt_pf_if = _RANDOM[5'hC][18];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_xcpt_ae_if = _RANDOM[5'hC][19];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_xcpt_ma_if = _RANDOM[5'hC][20];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_bp_debug_if = _RANDOM[5'hC][21];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_bp_xcpt_if = _RANDOM[5'hC][22];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_debug_fsrc = _RANDOM[5'hC][24:23];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_uop_debug_tsrc = _RANDOM[5'hC][26:25];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_addr = {_RANDOM[5'hC][31:27], _RANDOM[5'hD], _RANDOM[5'hE][2:0]};	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_data = {_RANDOM[5'hE][31:3], _RANDOM[5'hF], _RANDOM[5'h10][2:0]};	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        req_is_hella = _RANDOM[5'h10][3];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16]
        grant_word = {_RANDOM[5'h10][31:4], _RANDOM[5'h11], _RANDOM[5'h12][3:0]};	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :421:16, :422:23]
        state = _RANDOM[5'h12][5:4];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :422:23, :426:22]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_mem_access_bits_source = ~_io_mem_access_bits_T_16 | _send_resp_T_18 | _send_resp_T_17 | _send_resp_T_16 | _send_resp_T_15 | _send_resp_T_14 | _GEN ? 3'h5 : 3'h0;	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :439:75, :457:29, generators/rocket-chip/src/main/scala/rocket/Consts.scala:87:44, generators/rocket-chip/src/main/scala/util/package.scala:82:59]
  ...
  assign io_mem_access_bits_data = _io_mem_access_bits_T_16 ? (_send_resp_T_18 | _send_resp_T_17 | _send_resp_T_16 | _send_resp_T_15 | _send_resp_T_14 | _send_resp_T_10 | _send_resp_T_9 | _send_resp_T_8 | _send_resp_T_7 ? a_data : 128'h0) : _io_mem_access_bits_T_41 ? 128'h0 : a_data;	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:402:7, :434:23, :439:75, :457:{29,66}, generators/rocket-chip/src/main/scala/rocket/Consts.scala:87:44, :89:68, generators/rocket-chip/src/main/scala/util/package.scala:82:59]
endmodule
