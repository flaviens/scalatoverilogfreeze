...
module BranchKillableQueue_7(	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7]
  ...
  wire [3:0][15:0] _GEN_2 = {{uops_0_br_mask}, {uops_2_br_mask}, {uops_1_br_mask}, {uops_0_br_mask}};	// @[generators/boom/src/main/scala/v3/util/util.scala:466:20, :508:19]
  ...
  always @(posedge clock) begin	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7]
    if (reset) begin	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7]
      ...
      valids_0 <= ~(do_deq & deq_ptr_value == 2'h0) & (_GEN_11 | valids_0 & (io_brupdate_b1_mispredict_mask & uops_0_br_mask) == 16'h0 & ~io_flush);	// @[generators/boom/src/main/scala/v3/util/util.scala:118:{51,59}, :465:24, :466:20, :476:{24,66}, :481:{16,29,69,72}, :487:17, :489:33, :495:17, :496:27, :515:21, :520:14, src/main/scala/chisel3/util/Counter.scala:61:40]
      valids_1 <= ~(do_deq & deq_ptr_value == 2'h1) & (_GEN_13 | valids_1 & (io_brupdate_b1_mispredict_mask & uops_1_br_mask) == 16'h0 & ~io_flush);	// @[generators/boom/src/main/scala/v3/util/util.scala:118:{51,59}, :465:24, :466:20, :476:{24,66}, :481:{16,29,69,72}, :487:17, :489:33, :495:17, :496:27, :515:21, :520:14, src/main/scala/chisel3/util/Counter.scala:61:40]
      valids_2 <= ~(do_deq & deq_ptr_value == 2'h2) & (_GEN_15 | valids_2 & (io_brupdate_b1_mispredict_mask & uops_2_br_mask) == 16'h0 & ~io_flush);	// @[generators/boom/src/main/scala/v3/util/util.scala:118:{51,59}, :465:24, :466:20, :476:{24,66}, :481:{16,29,69,72}, :487:17, :489:33, :495:17, :496:27, :515:21, :520:14, src/main/scala/chisel3/util/Counter.scala:61:40]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7]
    ...
    initial begin	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7]
        ...
        uops_0_br_mask = _RANDOM[6'h5][15:0];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_0_rob_idx = _RANDOM[6'h7][7:1];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_0_stq_idx = _RANDOM[6'h7][17:13];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_0_pdst = _RANDOM[6'h7][26:20];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_0_is_amo = _RANDOM[6'hB][12];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_0_uses_stq = _RANDOM[6'hB][14];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_0_dst_rtype = _RANDOM[6'hC][13:12];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_0_fp_val = _RANDOM[6'hC][19];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_uopc = {_RANDOM[6'hC][31:30], _RANDOM[6'hD][4:0]};	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_br_mask = {_RANDOM[6'h11][31:27], _RANDOM[6'h12][10:0]};	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_rob_idx = {_RANDOM[6'h13][31:28], _RANDOM[6'h14][2:0]};	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_stq_idx = _RANDOM[6'h14][12:8];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_pdst = _RANDOM[6'h14][21:15];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_is_amo = _RANDOM[6'h18][7];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_uses_stq = _RANDOM[6'h18][9];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_dst_rtype = _RANDOM[6'h19][8:7];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_fp_val = _RANDOM[6'h19][14];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_uopc = _RANDOM[6'h19][31:25];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_br_mask = {_RANDOM[6'h1E][31:22], _RANDOM[6'h1F][5:0]};	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_rob_idx = _RANDOM[6'h20][29:23];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_stq_idx = _RANDOM[6'h21][7:3];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_pdst = _RANDOM[6'h21][16:10];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_is_amo = _RANDOM[6'h25][2];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_uses_stq = _RANDOM[6'h25][4];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_dst_rtype = _RANDOM[6'h26][3:2];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_fp_val = _RANDOM[6'h26][9];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        enq_ptr_value = _RANDOM[6'h26][21:20];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20, src/main/scala/chisel3/util/Counter.scala:61:40]
        deq_ptr_value = _RANDOM[6'h26][23:22];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20, src/main/scala/chisel3/util/Counter.scala:61:40]
        maybe_full = _RANDOM[6'h26][24];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20, :470:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
