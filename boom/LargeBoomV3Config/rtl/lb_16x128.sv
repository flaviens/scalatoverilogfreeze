...
module lb_16x128(	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:580:15]
  input  [3:0]   R0_addr,
  input          R0_en,
  input          R0_clk,
  ...
  reg [127:0] Memory[0:15];	// @[generators/boom/src/main/scala/v3/lsu/mshrs.scala:580:15]
