...
module regfile_96x65(	// @[generators/boom/src/main/scala/v3/exu/register-read/regfile.scala:117:20]
  input  [6:0]  R0_addr,
  input         R0_en,
  input         R0_clk,
  output [64:0] R0_data,
  ...
  reg [64:0] Memory[0:95];	// @[generators/boom/src/main/scala/v3/exu/register-read/regfile.scala:117:20]
