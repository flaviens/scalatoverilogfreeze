...
module regfile_100x64(	// @[generators/boom/src/main/scala/v3/exu/register-read/regfile.scala:117:20]
  input  [6:0]  R0_addr,
  input         R0_en,
  input         R0_clk,
  output [63:0] R0_data,
  ...
  reg [63:0] Memory[0:99];	// @[generators/boom/src/main/scala/v3/exu/register-read/regfile.scala:117:20]
