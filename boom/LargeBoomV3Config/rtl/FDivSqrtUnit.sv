...
module FDivSqrtUnit(	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7]
  ...
  reg  [15:0] r_buffer_req_uop_br_mask;	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:98:25]
  ...
  reg  [15:0] r_divsqrt_uop_br_mask;	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:148:26]
  ...
  reg  [15:0] r_out_uop_br_mask;	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:185:22]
  ...
  wire [15:0] _io_resp_valid_T = io_brupdate_b1_mispredict_mask & r_out_uop_br_mask;	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:185:22, generators/boom/src/main/scala/v3/util/util.scala:118:51]
  ...
  wire        io_resp_valid_0 = r_out_val & _io_resp_valid_T == 16'h0;	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:184:26, :218:30, generators/boom/src/main/scala/v3/util/util.scala:118:{51,59}]
  ...
  wire [15:0] _r_divsqrt_killed_T_4 = io_brupdate_b1_mispredict_mask & r_buffer_req_uop_br_mask;	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:98:25, generators/boom/src/main/scala/v3/util/util.scala:118:51]
  wire        _GEN_1 = io_req_valid & (io_brupdate_b1_mispredict_mask & io_req_bits_uop_br_mask) == 16'h0 & ~io_req_bits_kill;	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:105:71, :121:{22,73}, generators/boom/src/main/scala/v3/util/util.scala:118:{51,59}]
  wire [15:0] _r_out_val_T_1 = io_brupdate_b1_mispredict_mask & r_divsqrt_uop_br_mask;	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:148:26, generators/boom/src/main/scala/v3/util/util.scala:118:51]
  ...
  always @(posedge clock) begin	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7]
    if (reset) begin	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7]
      ...
      r_buffer_val <= ~_GEN_2 & (_GEN_1 | _r_divsqrt_killed_T_4 == 16'h0 & ~io_req_bits_kill & r_buffer_val);	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:97:29, :105:{16,68,71,89}, :121:{22,73,95}, :122:18, :170:{24,42}, :173:18, generators/boom/src/main/scala/v3/util/util.scala:118:{51,59}]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7]
    ...
    initial begin	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7]
        ...
        r_buffer_req_uop_br_mask = {_RANDOM[6'h4][31:30], _RANDOM[6'h5][13:0]};	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :98:25]
        r_buffer_req_uop_rob_idx = {_RANDOM[6'h6][31], _RANDOM[6'h7][5:0]};	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :98:25]
        r_buffer_req_uop_pdst = _RANDOM[6'h7][24:18];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :98:25]
        r_buffer_req_uop_is_amo = _RANDOM[6'hB][10];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :98:25]
        r_buffer_req_uop_uses_ldq = _RANDOM[6'hB][11];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :98:25]
        r_buffer_req_uop_uses_stq = _RANDOM[6'hB][12];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :98:25]
        r_buffer_req_uop_dst_rtype = _RANDOM[6'hC][11:10];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :98:25]
        r_buffer_req_uop_fp_val = _RANDOM[6'hC][17];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :98:25]
        r_buffer_fin_typeTagIn = _RANDOM[6'h13][9:8];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :99:25]
        r_buffer_fin_div = _RANDOM[6'h13][16];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :99:25]
        r_buffer_fin_sqrt = _RANDOM[6'h13][17];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :99:25]
        r_buffer_fin_rm = _RANDOM[6'h13][22:20];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :99:25]
        r_buffer_fin_in1 = {_RANDOM[6'h13][31:29], _RANDOM[6'h14], _RANDOM[6'h15][29:0]};	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :99:25]
        r_buffer_fin_in2 = {_RANDOM[6'h15][31:30], _RANDOM[6'h16], _RANDOM[6'h17][30:0]};	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :99:25]
        r_divsqrt_val = _RANDOM[6'h1A][0];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :145:30]
        r_divsqrt_killed = _RANDOM[6'h1A][1];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :145:30, :146:29]
        r_divsqrt_fin_typeTagIn = _RANDOM[6'h1A][10:9];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :145:30, :147:26]
        r_divsqrt_fin_rm = _RANDOM[6'h1A][23:21];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :145:30, :147:26]
        r_divsqrt_uop_br_mask = {_RANDOM[6'h25][31:30], _RANDOM[6'h26][13:0]};	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_divsqrt_uop_rob_idx = {_RANDOM[6'h27][31], _RANDOM[6'h28][5:0]};	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_divsqrt_uop_pdst = _RANDOM[6'h28][24:18];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_divsqrt_uop_is_amo = _RANDOM[6'h2C][10];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_divsqrt_uop_uses_ldq = _RANDOM[6'h2C][11];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_divsqrt_uop_uses_stq = _RANDOM[6'h2C][12];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_divsqrt_uop_dst_rtype = _RANDOM[6'h2D][11:10];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_divsqrt_uop_fp_val = _RANDOM[6'h2D][17];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_out_val = _RANDOM[6'h2D][28];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26, :184:26]
        r_out_uop_br_mask = {_RANDOM[6'h32][31:26], _RANDOM[6'h33][9:0]};	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_uop_rob_idx = {_RANDOM[6'h34][31:27], _RANDOM[6'h35][1:0]};	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_uop_pdst = _RANDOM[6'h35][20:14];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_uop_is_amo = _RANDOM[6'h39][6];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_uop_uses_ldq = _RANDOM[6'h39][7];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_uop_uses_stq = _RANDOM[6'h39][8];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_uop_dst_rtype = _RANDOM[6'h3A][7:6];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_uop_fp_val = _RANDOM[6'h3A][13];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_flags_double = _RANDOM[6'h3A][28:24];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22, :186:31]
        r_out_wdata_double = {_RANDOM[6'h3A][31:29], _RANDOM[6'h3B], _RANDOM[6'h3C][29:0]};	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22, :187:31]
      `endif // RANDOMIZE_REG_INIT
    end // initial
