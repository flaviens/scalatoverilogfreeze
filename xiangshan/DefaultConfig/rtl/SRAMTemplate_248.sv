...
module SRAMTemplate_248(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        respReg = _RANDOM[4'h3][10];
        rdataReg =
          {_RANDOM[4'h5][31:11], _RANDOM[4'h6], _RANDOM[4'h7], _RANDOM[4'h8][2:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        respReg = 1'h0;
    end // initial
  ...
  sram_array_1p256x88m1s1h0l1b_dcsh_dat array (
