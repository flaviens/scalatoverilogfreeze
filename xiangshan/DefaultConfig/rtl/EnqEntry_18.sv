  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_commonOut_entry_bits_payload_og1Payload_REG_ssid = _RANDOM[3'h7][15:10];
        io_commonOut_entry_bits_payload_og1Payload_REG_sqIdx_first_flag =
          _RANDOM[3'h7][16];
        io_commonOut_entry_bits_payload_og1Payload_REG_sqIdx_second_flag =
          _RANDOM[3'h7][17];
        io_commonOut_entry_bits_payload_og1Payload_REG_sqIdx_value = _RANDOM[3'h7][23:18];
        io_commonOut_entry_bits_status_srcStatus_0_psrc_REG = _RANDOM[3'h7][31:24];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validReg_last_REG = 1'h0;
        enqDelayValidReg_last_REG = 1'h0;
