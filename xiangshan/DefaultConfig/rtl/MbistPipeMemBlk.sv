...
module MbistPipeMemBlk(
  ...
  always @(posedge clock) begin
    if (activated)
      pipelineDataOutReg <=
        {60'h0, selected ? toNextPipeline_0_outdata : 88'h0}
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        beReg = {_RANDOM[4'h0][31:10], _RANDOM[4'h1], _RANDOM[4'h2], _RANDOM[4'h3][1:0]};
        addrReg = _RANDOM[4'h3][10:2];
        dataInReg =
          {_RANDOM[4'h3][31:11],
           _RANDOM[4'h4],
           _RANDOM[4'h5],
           _RANDOM[4'h6],
           _RANDOM[4'h7][30:0]};
        renReg = _RANDOM[4'h7][31];
        addrRdReg = _RANDOM[4'h8][8:0];
        pipelineDataOutReg =
          {_RANDOM[4'h8][31:9],
           _RANDOM[4'h9],
           _RANDOM[4'hA],
  ...
  assign toNextPipeline_4_be = beReg[1:0];
  ...
  assign toNextPipeline_5_be = beReg[1:0];
