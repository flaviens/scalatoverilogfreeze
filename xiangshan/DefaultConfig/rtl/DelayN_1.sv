  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        REG_priv_mxr = _RANDOM[4'h9][25];
        REG_priv_sum = _RANDOM[4'h9][26];
        REG_priv_vmxr = _RANDOM[4'h9][27];
        REG_priv_vsum = _RANDOM[4'h9][28];
        REG_priv_virt = _RANDOM[4'h9][29];
        REG_priv_virt_changed = _RANDOM[4'h9][30];
        REG_priv_spvp = _RANDOM[4'h9][31];
        REG_priv_imode = _RANDOM[4'hA][1:0];
        REG_priv_dmode = _RANDOM[4'hA][3:2];
        REG_mPBMTE = _RANDOM[4'hA][4];
        REG_hPBMTE = _RANDOM[4'hA][5];
        REG_pmm_mseccfg = _RANDOM[4'hA][7:6];
        REG_pmm_menvcfg = _RANDOM[4'hA][9:8];
        REG_pmm_henvcfg = _RANDOM[4'hA][11:10];
        REG_pmm_hstatus = _RANDOM[4'hA][13:12];
        REG_pmm_senvcfg = _RANDOM[4'hA][15:14];
      `endif // RANDOMIZE_REG_INIT
    end // initial
