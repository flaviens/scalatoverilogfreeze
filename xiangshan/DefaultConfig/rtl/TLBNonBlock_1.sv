  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        readResult_lastCycleRedirect_REG_bits_level = _RANDOM[7'h1F][10];
        readResult_lastCycleRedirect_REG_bits_robIdx_flag = _RANDOM[7'h1F][14];
        readResult_lastCycleRedirect_REG_bits_robIdx_value = _RANDOM[7'h1F][23:15];
        ...
        readResult_p_perm_1_d = _RANDOM[7'h25][28];
        ...
        readResult_p_gvpn_1 = {_RANDOM[7'h26][31:3], _RANDOM[7'h27][14:0]};
        ...
        readResult_p_g_perm_1_d = _RANDOM[7'h27][20];
        readResult_p_g_perm_1_a = _RANDOM[7'h27][21];
        readResult_p_g_perm_1_x = _RANDOM[7'h27][24];
        readResult_p_g_perm_1_w = _RANDOM[7'h27][25];
        readResult_p_g_perm_1_r = _RANDOM[7'h27][26];
        readResult_p_s2xlate_1 = _RANDOM[7'h27][28:27];
        readResult_p_s1_level_1 = _RANDOM[7'h27][30:29];
        readResult_p_s1_isLeaf_1 = _RANDOM[7'h27][31];
        readResult_p_s1_isFakePte_1 = _RANDOM[7'h28][0];
        ...
        REG = _RANDOM[7'h31][2];
        io_requestor_0_resp_bits_excp_0_pf_ld_REG = _RANDOM[7'h31][3];
        io_requestor_0_resp_bits_excp_0_pf_st_REG = _RANDOM[7'h31][4];
        io_requestor_0_resp_bits_excp_0_gpf_ld_REG = _RANDOM[7'h31][5];
        io_requestor_0_resp_bits_excp_0_gpf_st_REG = _RANDOM[7'h31][6];
        io_requestor_0_resp_bits_excp_0_af_ld_REG = _RANDOM[7'h31][7];
        io_requestor_0_resp_bits_excp_0_af_st_REG = _RANDOM[7'h31][8];
        REG_1 = _RANDOM[7'h31][10];
        io_requestor_1_resp_bits_excp_0_pf_ld_REG = _RANDOM[7'h31][11];
        io_requestor_1_resp_bits_excp_0_pf_st_REG = _RANDOM[7'h31][12];
        io_requestor_1_resp_bits_excp_0_gpf_ld_REG = _RANDOM[7'h31][13];
        io_requestor_1_resp_bits_excp_0_gpf_st_REG = _RANDOM[7'h31][14];
        io_requestor_1_resp_bits_excp_0_af_ld_REG = _RANDOM[7'h31][15];
        io_requestor_1_resp_bits_excp_0_af_st_REG = _RANDOM[7'h31][16];
        ptw_resp_bits_reg_s2xlate = _RANDOM[7'h31][18:17];
        ptw_resp_bits_reg_s1_entry_tag = {_RANDOM[7'h31][31:19], _RANDOM[7'h32][21:0]};
        ptw_resp_bits_reg_s1_entry_asid = {_RANDOM[7'h32][31:22], _RANDOM[7'h33][5:0]};
        ptw_resp_bits_reg_s1_entry_vmid = _RANDOM[7'h33][19:6];
        ptw_resp_bits_reg_s1_entry_n = _RANDOM[7'h33][20];
        ptw_resp_bits_reg_s1_entry_perm_g = _RANDOM[7'h33][25];
        ptw_resp_bits_reg_s1_entry_level = _RANDOM[7'h33][31:30];
        ptw_resp_bits_reg_s1_addr_low = _RANDOM[7'h35][13:11];
        ptw_resp_bits_reg_s1_valididx_0 = _RANDOM[7'h36][6];
        ptw_resp_bits_reg_s1_valididx_1 = _RANDOM[7'h36][7];
        ptw_resp_bits_reg_s1_valididx_2 = _RANDOM[7'h36][8];
        ptw_resp_bits_reg_s1_valididx_3 = _RANDOM[7'h36][9];
        ptw_resp_bits_reg_s1_valididx_4 = _RANDOM[7'h36][10];
        ptw_resp_bits_reg_s1_valididx_5 = _RANDOM[7'h36][11];
        ptw_resp_bits_reg_s1_valididx_6 = _RANDOM[7'h36][12];
        ptw_resp_bits_reg_s1_valididx_7 = _RANDOM[7'h36][13];
        ptw_resp_bits_reg_s2_entry_tag = {_RANDOM[7'h36][31:24], _RANDOM[7'h37][29:0]};
        ptw_resp_bits_reg_s2_entry_vmid = _RANDOM[7'h38][27:14];
        ptw_resp_bits_reg_s2_entry_n = _RANDOM[7'h38][28];
        ptw_resp_bits_reg_s2_entry_level = _RANDOM[7'h3A][13:12];
        ptw_already_back_last_REG = _RANDOM[7'h3A][28];
        ptw_resp_bits_reg_1_s2xlate = _RANDOM[7'h3A][31:30];
        ptw_resp_bits_reg_1_s1_entry_tag = {_RANDOM[7'h3B], _RANDOM[7'h3C][2:0]};
        ptw_resp_bits_reg_1_s1_entry_asid = _RANDOM[7'h3C][18:3];
        ptw_resp_bits_reg_1_s1_entry_vmid = {_RANDOM[7'h3C][31:19], _RANDOM[7'h3D][0]};
        ptw_resp_bits_reg_1_s1_entry_n = _RANDOM[7'h3D][1];
        ptw_resp_bits_reg_1_s1_entry_perm_g = _RANDOM[7'h3D][6];
        ptw_resp_bits_reg_1_s1_entry_level = _RANDOM[7'h3D][12:11];
        ptw_resp_bits_reg_1_s1_addr_low = _RANDOM[7'h3E][26:24];
        ptw_resp_bits_reg_1_s1_valididx_0 = _RANDOM[7'h3F][19];
        ptw_resp_bits_reg_1_s1_valididx_1 = _RANDOM[7'h3F][20];
        ptw_resp_bits_reg_1_s1_valididx_2 = _RANDOM[7'h3F][21];
        ptw_resp_bits_reg_1_s1_valididx_3 = _RANDOM[7'h3F][22];
        ptw_resp_bits_reg_1_s1_valididx_4 = _RANDOM[7'h3F][23];
        ptw_resp_bits_reg_1_s1_valididx_5 = _RANDOM[7'h3F][24];
        ptw_resp_bits_reg_1_s1_valididx_6 = _RANDOM[7'h3F][25];
        ptw_resp_bits_reg_1_s1_valididx_7 = _RANDOM[7'h3F][26];
        ptw_resp_bits_reg_1_s2_entry_tag = {_RANDOM[7'h40][31:5], _RANDOM[7'h41][10:0]};
        ptw_resp_bits_reg_1_s2_entry_vmid = {_RANDOM[7'h41][31:27], _RANDOM[7'h42][8:0]};
        ptw_resp_bits_reg_1_s2_entry_n = _RANDOM[7'h42][9];
        ptw_resp_bits_reg_1_s2_entry_level = _RANDOM[7'h43][26:25];
        ptw_already_back_last_REG_1 = _RANDOM[7'h44][9];
        result_ok_last_REG = _RANDOM[7'h44][11];
        result_ok_last_REG_1 = _RANDOM[7'h44][12];
        io_perf_0_value_REG = _RANDOM[7'h44][14:13];
        io_perf_0_value_REG_1 = _RANDOM[7'h44][16:15];
        io_perf_1_value_REG = _RANDOM[7'h44][18:17];
        io_perf_1_value_REG_1 = _RANDOM[7'h44][20:19];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        req_out_v_0 = 1'h0;
        req_out_v_1 = 1'h0;
