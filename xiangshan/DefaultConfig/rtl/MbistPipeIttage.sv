...
module MbistPipeIttage(
  ...
  output [17:0]  toSRAM_11_wdata,
  output         toSRAM_11_wmask,
  output         toSRAM_11_re,
  output         toSRAM_11_we,
  input  [17:0]  toSRAM_11_rdata,
  ...
  output [17:0]  toSRAM_12_wdata,
  output         toSRAM_12_wmask,
  output         toSRAM_12_re,
  output         toSRAM_12_we,
  input  [17:0]  toSRAM_12_rdata,
  ...
  output [17:0]  toSRAM_13_wdata,
  output         toSRAM_13_wmask,
  output         toSRAM_13_re,
  output         toSRAM_13_we,
  input  [17:0]  toSRAM_13_rdata,
  ...
  output [17:0]  toSRAM_14_wdata,
  output         toSRAM_14_wmask,
  output         toSRAM_14_re,
  output         toSRAM_14_we,
  input  [17:0]  toSRAM_14_rdata,
  ...
  output [17:0]  toSRAM_15_wdata,
  output         toSRAM_15_wmask,
  output         toSRAM_15_re,
  output         toSRAM_15_we,
  input  [17:0]  toSRAM_15_rdata,
  ...
  output [6:0]   toSRAM_64_addr,
  output [6:0]   toSRAM_64_addr_rd,
  ...
  output [6:0]   toSRAM_65_addr,
  output [6:0]   toSRAM_65_addr_rd,
  ...
  output [6:0]   toSRAM_66_addr,
  output [6:0]   toSRAM_66_addr_rd,
  ...
  output [6:0]   toSRAM_67_addr,
  output [6:0]   toSRAM_67_addr_rd,
  ...
  output [6:0]   toSRAM_68_addr,
  output [6:0]   toSRAM_68_addr_rd,
  ...
  output [6:0]   toSRAM_69_addr,
  output [6:0]   toSRAM_69_addr_rd,
  ...
  output [6:0]   toSRAM_70_addr,
  output [6:0]   toSRAM_70_addr_rd,
  ...
  output [6:0]   toSRAM_71_addr,
  output [6:0]   toSRAM_71_addr_rd,
  ...
  output [7:0]   toSRAM_184_addr,
  output [7:0]   toSRAM_184_addr_rd,
  output [37:0]  toSRAM_184_wdata,
  output [37:0]  toSRAM_184_wmask,
  output         toSRAM_184_re,
  output         toSRAM_184_we,
  input  [37:0]  toSRAM_184_rdata,
  output         toSRAM_184_ack,
  output         toSRAM_184_selectedOH,
  output [7:0]   toSRAM_184_array,
  output [7:0]   toSRAM_185_addr,
  output [7:0]   toSRAM_185_addr_rd,
  output [37:0]  toSRAM_185_wdata,
  output [37:0]  toSRAM_185_wmask,
  output         toSRAM_185_re,
  output         toSRAM_185_we,
  input  [37:0]  toSRAM_185_rdata,
  ...
  assign sramDataOut_184 = {74'h0, selectedVec_0_184 ? toSRAM_184_rdata : 38'h0};
  wire         selectedVec_0_185 = arrayReg == 8'hDD;
  wire         doSpread_185 = selectedVec_0_185 | allReg;
  assign sramDataOut_185 = {74'h0, selectedVec_0_185 ? toSRAM_185_rdata : 38'h0};
  wire         arrayHit =
  ...
  assign mbist_outdata =
    ...
    | sramDataOut_184 | sramDataOut_185;
  ...
  assign toSRAM_8_wdata = dataInReg[17:0];
  ...
  assign toSRAM_9_wdata = dataInReg[17:0];
  ...
  assign toSRAM_10_wdata = dataInReg[17:0];
  ...
  assign toSRAM_11_wdata = dataInReg[17:0];
  ...
  assign toSRAM_12_wdata = dataInReg[17:0];
  ...
  assign toSRAM_13_wdata = dataInReg[17:0];
  ...
  assign toSRAM_14_wdata = dataInReg[17:0];
  ...
  assign toSRAM_15_wdata = dataInReg[17:0];
  ...
  assign toSRAM_64_addr = doSpread_64 ? addrReg[6:0] : 7'h0;
  assign toSRAM_64_addr_rd = doSpread_64 ? addrRdReg[6:0] : 7'h0;
  ...
  assign toSRAM_65_addr = doSpread_65 ? addrReg[6:0] : 7'h0;
  assign toSRAM_65_addr_rd = doSpread_65 ? addrRdReg[6:0] : 7'h0;
  ...
  assign toSRAM_66_addr = doSpread_66 ? addrReg[6:0] : 7'h0;
  assign toSRAM_66_addr_rd = doSpread_66 ? addrRdReg[6:0] : 7'h0;
  ...
  assign toSRAM_67_addr = doSpread_67 ? addrReg[6:0] : 7'h0;
  assign toSRAM_67_addr_rd = doSpread_67 ? addrRdReg[6:0] : 7'h0;
  ...
  assign toSRAM_68_addr = doSpread_68 ? addrReg[6:0] : 7'h0;
  assign toSRAM_68_addr_rd = doSpread_68 ? addrRdReg[6:0] : 7'h0;
  ...
  assign toSRAM_69_addr = doSpread_69 ? addrReg[6:0] : 7'h0;
  assign toSRAM_69_addr_rd = doSpread_69 ? addrRdReg[6:0] : 7'h0;
  ...
  assign toSRAM_70_addr = doSpread_70 ? addrReg[6:0] : 7'h0;
  assign toSRAM_70_addr_rd = doSpread_70 ? addrRdReg[6:0] : 7'h0;
  ...
  assign toSRAM_71_addr = doSpread_71 ? addrReg[6:0] : 7'h0;
  assign toSRAM_71_addr_rd = doSpread_71 ? addrRdReg[6:0] : 7'h0;
  ...
  assign toSRAM_184_addr = doSpread_184 ? addrReg[7:0] : 8'h0;
  assign toSRAM_184_addr_rd = doSpread_184 ? addrRdReg[7:0] : 8'h0;
  assign toSRAM_184_wdata = dataInReg[37:0];
  assign toSRAM_184_wmask = beReg;
  ...
  assign toSRAM_185_addr = doSpread_185 ? addrReg[7:0] : 8'h0;
  assign toSRAM_185_addr_rd = doSpread_185 ? addrRdReg[7:0] : 8'h0;
  assign toSRAM_185_wdata = dataInReg[37:0];
  assign toSRAM_185_wmask = beReg;
