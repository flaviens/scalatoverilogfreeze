...
module FreeList_1(
  ...
  wire [4:0]       _GEN_0 = {4'h0, freeReq_next_nextVec_0_r};
  wire [4:0]       _GEN_1 = {4'h0, io_doAllocate_0};
  wire [4:0]       _headPtrNext_new_ptr_T_1 = 5'(_GEN_1 + {headPtr_flag, headPtr_value});
  wire [4:0]       _tailPtrNext_new_ptr_T_1 = 5'({tailPtr_flag, tailPtr_value} + _GEN_0);
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      freeSlotCnt <= 5'(5'(freeSlotCnt + _GEN_0) - _GEN_1);
    end
