...
module VSSplitPipelineImp(
  ...
  wire          s1_ready;
  wire          _s0_valid_T;
  wire [7:0]    _illegalIssue_new_ptr_T_2 =
    8'({io_in_bits_sqIdx_first_flag, io_in_bits_sqIdx_second_flag, io_in_bits_sqIdx_value}
       + {3'h0, io_in_bits_numLsElem});
  wire [7:0]    _illegalIssue_endPtr_new_ptr_T_2 =
    8'({io_sqDeqPtr_first_flag, io_sqDeqPtr_second_flag, io_sqDeqPtr_value} + 8'h40);
  wire          _io_in_ready_T =
    (_illegalIssue_new_ptr_T_2[7] ^ io_sqDeqPtr_first_flag
     ^ _illegalIssue_new_ptr_T_2[6:0] >= {io_sqDeqPtr_second_flag, io_sqDeqPtr_value})
    & (_illegalIssue_new_ptr_T_2[7] ^ _illegalIssue_endPtr_new_ptr_T_2[7]
       ^ _illegalIssue_new_ptr_T_2[6:0] < _illegalIssue_endPtr_new_ptr_T_2[6:0]);
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_in_r_uop_sqIdx_first_flag = _RANDOM[6'h37][19];
        s1_in_r_uop_sqIdx_second_flag = _RANDOM[6'h37][20];
