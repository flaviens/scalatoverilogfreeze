...
module VSSplitBufferImp(
  ...
  wire [7:0]   _sqIdx_new_ptr_T_2 =
    8'({uopq_uop_sqIdx_first_flag, uopq_uop_sqIdx_second_flag, uopq_uop_sqIdx_value}
       + {3'h0, splitIdx});
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uopq_uop_sqIdx_first_flag = _RANDOM[7'h37][15];
        uopq_uop_sqIdx_second_flag = _RANDOM[7'h37][16];
  ...
  assign io_out_bits_uop_sqIdx_first_flag = _sqIdx_new_ptr_T_2[7];
  assign io_out_bits_uop_sqIdx_second_flag = _sqIdx_new_ptr_T_2[6];
  assign io_out_bits_uop_sqIdx_value = _sqIdx_new_ptr_T_2[5:0];
  ...
  assign io_vstd_bits_sqIdx_value = _sqIdx_new_ptr_T_2[5:0];
endmodule
