...
module Debug(
  ...
  input  [1:0]  io_in_tdata3Vec_0_SSELECT,
  input  [31:0] io_in_tdata3Vec_0_SVALUE,
  input  [3:0]  io_in_tdata3Vec_0_SBYTEMASK,
  input  [2:0]  io_in_tdata3Vec_0_MHSELECT,
  input  [12:0] io_in_tdata3Vec_0_MHVALUE,
  input  [1:0]  io_in_tdata3Vec_1_SSELECT,
  input  [31:0] io_in_tdata3Vec_1_SVALUE,
  input  [3:0]  io_in_tdata3Vec_1_SBYTEMASK,
  input  [2:0]  io_in_tdata3Vec_1_MHSELECT,
  input  [12:0] io_in_tdata3Vec_1_MHVALUE,
  input  [1:0]  io_in_tdata3Vec_2_SSELECT,
  input  [31:0] io_in_tdata3Vec_2_SVALUE,
  input  [3:0]  io_in_tdata3Vec_2_SBYTEMASK,
  input  [2:0]  io_in_tdata3Vec_2_MHSELECT,
  input  [12:0] io_in_tdata3Vec_2_MHVALUE,
  input  [1:0]  io_in_tdata3Vec_3_SSELECT,
  input  [31:0] io_in_tdata3Vec_3_SVALUE,
  input  [3:0]  io_in_tdata3Vec_3_SBYTEMASK,
  input  [2:0]  io_in_tdata3Vec_3_MHSELECT,
  input  [12:0] io_in_tdata3Vec_3_MHVALUE,
  input         io_in_triggerCanRaiseBpExp,
  input  [31:0] io_in_scontext_ALL,
  input  [13:0] io_in_mhcontext_HCONTEXT,
  input  [15:0] io_in_satpAsid,
  input  [15:0] io_in_vsatpAsid,
  input  [13:0] io_in_hgatpVmid,
  input         io_in_tdata1Update,
  input         io_in_tdata2Update,
  input         io_in_tdata3Update,
  ...
  wire [15:0] currentAsid = io_in_privState_V ? io_in_vsatpAsid : io_in_satpAsid;
  wire [13:0] tdata3MatchVec_highSelValue =
    {io_in_tdata3Vec_0_MHVALUE, io_in_tdata3Vec_0_MHSELECT[2]};
  wire [13:0] tdata3MatchVec_highSelValue_1 =
    {io_in_tdata3Vec_1_MHVALUE, io_in_tdata3Vec_1_MHSELECT[2]};
  wire [13:0] tdata3MatchVec_highSelValue_2 =
    {io_in_tdata3Vec_2_MHVALUE, io_in_tdata3Vec_2_MHSELECT[2]};
  wire [13:0] tdata3MatchVec_highSelValue_3 =
    {io_in_tdata3Vec_3_MHVALUE, io_in_tdata3Vec_3_MHSELECT[2]};
  ...
  wire        frontendTriggerUpdate =
    ...
    | io_in_tdata1Selected_DATA[2] & (triggerUpdate | io_in_tdata3Update);
  wire        triggerEnableVec_0 =
    io_in_tdata1Vec_0_TYPE == 4'h6
    & (io_in_tdata3Vec_0_SSELECT == 2'h2
         ? currentAsid == io_in_tdata3Vec_0_SVALUE[15:0]
         : io_in_tdata3Vec_0_SSELECT == 2'h1
             ? (io_in_scontext_ALL[7:0] == io_in_tdata3Vec_0_SVALUE[7:0]
                | io_in_tdata3Vec_0_SBYTEMASK[0])
               & (io_in_scontext_ALL[15:8] == io_in_tdata3Vec_0_SVALUE[15:8]
                  | io_in_tdata3Vec_0_SBYTEMASK[1])
               & (io_in_scontext_ALL[23:16] == io_in_tdata3Vec_0_SVALUE[23:16]
                  | io_in_tdata3Vec_0_SBYTEMASK[2])
               & (io_in_scontext_ALL[31:24] == io_in_tdata3Vec_0_SVALUE[31:24]
                  | io_in_tdata3Vec_0_SBYTEMASK[3])
             : io_in_tdata3Vec_0_SSELECT == 2'h0)
    & (io_in_tdata3Vec_0_MHSELECT == 3'h6 | io_in_tdata3Vec_0_MHSELECT == 3'h2
         ? io_in_hgatpVmid == tdata3MatchVec_highSelValue
         : io_in_tdata3Vec_0_MHSELECT == 3'h5 | io_in_tdata3Vec_0_MHSELECT == 3'h1
             ? io_in_mhcontext_HCONTEXT == tdata3MatchVec_highSelValue
             : io_in_tdata3Vec_0_MHSELECT == 3'h4
                 ? io_in_mhcontext_HCONTEXT[12:0] == io_in_tdata3Vec_0_MHVALUE
                 : io_in_tdata3Vec_0_MHSELECT == 3'h0)
  ...
  wire        triggerEnableVec_1 =
    ...
    & (io_in_tdata3Vec_1_SSELECT == 2'h2
         ? currentAsid == io_in_tdata3Vec_1_SVALUE[15:0]
         : io_in_tdata3Vec_1_SSELECT == 2'h1
             ? (io_in_scontext_ALL[7:0] == io_in_tdata3Vec_1_SVALUE[7:0]
                | io_in_tdata3Vec_1_SBYTEMASK[0])
               & (io_in_scontext_ALL[15:8] == io_in_tdata3Vec_1_SVALUE[15:8]
                  | io_in_tdata3Vec_1_SBYTEMASK[1])
               & (io_in_scontext_ALL[23:16] == io_in_tdata3Vec_1_SVALUE[23:16]
                  | io_in_tdata3Vec_1_SBYTEMASK[2])
               & (io_in_scontext_ALL[31:24] == io_in_tdata3Vec_1_SVALUE[31:24]
                  | io_in_tdata3Vec_1_SBYTEMASK[3])
             : io_in_tdata3Vec_1_SSELECT == 2'h0)
    & (io_in_tdata3Vec_1_MHSELECT == 3'h6 | io_in_tdata3Vec_1_MHSELECT == 3'h2
         ? io_in_hgatpVmid == tdata3MatchVec_highSelValue_1
         : io_in_tdata3Vec_1_MHSELECT == 3'h5 | io_in_tdata3Vec_1_MHSELECT == 3'h1
             ? io_in_mhcontext_HCONTEXT == tdata3MatchVec_highSelValue_1
             : io_in_tdata3Vec_1_MHSELECT == 3'h4
                 ? io_in_mhcontext_HCONTEXT[12:0] == io_in_tdata3Vec_1_MHVALUE
                 : io_in_tdata3Vec_1_MHSELECT == 3'h0)
  ...
  wire        triggerEnableVec_2 =
    ...
    & (io_in_tdata3Vec_2_SSELECT == 2'h2
         ? currentAsid == io_in_tdata3Vec_2_SVALUE[15:0]
         : io_in_tdata3Vec_2_SSELECT == 2'h1
             ? (io_in_scontext_ALL[7:0] == io_in_tdata3Vec_2_SVALUE[7:0]
                | io_in_tdata3Vec_2_SBYTEMASK[0])
               & (io_in_scontext_ALL[15:8] == io_in_tdata3Vec_2_SVALUE[15:8]
                  | io_in_tdata3Vec_2_SBYTEMASK[1])
               & (io_in_scontext_ALL[23:16] == io_in_tdata3Vec_2_SVALUE[23:16]
                  | io_in_tdata3Vec_2_SBYTEMASK[2])
               & (io_in_scontext_ALL[31:24] == io_in_tdata3Vec_2_SVALUE[31:24]
                  | io_in_tdata3Vec_2_SBYTEMASK[3])
             : io_in_tdata3Vec_2_SSELECT == 2'h0)
    & (io_in_tdata3Vec_2_MHSELECT == 3'h6 | io_in_tdata3Vec_2_MHSELECT == 3'h2
         ? io_in_hgatpVmid == tdata3MatchVec_highSelValue_2
         : io_in_tdata3Vec_2_MHSELECT == 3'h5 | io_in_tdata3Vec_2_MHSELECT == 3'h1
             ? io_in_mhcontext_HCONTEXT == tdata3MatchVec_highSelValue_2
             : io_in_tdata3Vec_2_MHSELECT == 3'h4
                 ? io_in_mhcontext_HCONTEXT[12:0] == io_in_tdata3Vec_2_MHVALUE
                 : io_in_tdata3Vec_2_MHSELECT == 3'h0)
  ...
  wire        triggerEnableVec_3 =
    ...
    & (io_in_tdata3Vec_3_SSELECT == 2'h2
         ? currentAsid == io_in_tdata3Vec_3_SVALUE[15:0]
         : io_in_tdata3Vec_3_SSELECT == 2'h1
             ? (io_in_scontext_ALL[7:0] == io_in_tdata3Vec_3_SVALUE[7:0]
                | io_in_tdata3Vec_3_SBYTEMASK[0])
               & (io_in_scontext_ALL[15:8] == io_in_tdata3Vec_3_SVALUE[15:8]
                  | io_in_tdata3Vec_3_SBYTEMASK[1])
               & (io_in_scontext_ALL[23:16] == io_in_tdata3Vec_3_SVALUE[23:16]
                  | io_in_tdata3Vec_3_SBYTEMASK[2])
               & (io_in_scontext_ALL[31:24] == io_in_tdata3Vec_3_SVALUE[31:24]
                  | io_in_tdata3Vec_3_SBYTEMASK[3])
             : io_in_tdata3Vec_3_SSELECT == 2'h0)
    & (io_in_tdata3Vec_3_MHSELECT == 3'h6 | io_in_tdata3Vec_3_MHSELECT == 3'h2
         ? io_in_hgatpVmid == tdata3MatchVec_highSelValue_3
         : io_in_tdata3Vec_3_MHSELECT == 3'h5 | io_in_tdata3Vec_3_MHSELECT == 3'h1
             ? io_in_mhcontext_HCONTEXT == tdata3MatchVec_highSelValue_3
             : io_in_tdata3Vec_3_MHSELECT == 3'h4
                 ? io_in_mhcontext_HCONTEXT[12:0] == io_in_tdata3Vec_3_MHVALUE
                 : io_in_tdata3Vec_3_MHSELECT == 3'h0)
