...
module FastArbiter_4(
  ...
  assign io_out_bits =
    (chosenOH[0] ? io_in_0_bits : 48'h0) | (chosenOH[1] ? io_in_1_bits : 48'h0)
    | (chosenOH[2] ? io_in_2_bits : 48'h0) | (chosenOH[3] ? io_in_3_bits : 48'h0)
    | (chosenOH[4] ? io_in_4_bits : 48'h0) | (chosenOH[5] ? io_in_5_bits : 48'h0)
    | (chosenOH[6] ? io_in_6_bits : 48'h0) | (chosenOH[7] ? io_in_7_bits : 48'h0);
endmodule
