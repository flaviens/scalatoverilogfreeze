...
module PrefetchFilter(
  ...
  wire        _tlb_req_arb_io_out_bits_isPrefetch;
  ...
  always @(posedge clock) begin
    ...
    if (_tlb_req_arb_io_out_valid) begin
      ...
      s1_tlb_req_bits_isPrefetch <= _tlb_req_arb_io_out_bits_isPrefetch;
    end
  ...
  TwoLevelRRArbiter_1 tlb_req_arb (
    ...
    .io_out_bits_isPrefetch (_tlb_req_arb_io_out_bits_isPrefetch)
  );
