...
module Arbiter5_MainPipeReq(
  ...
  wire _GEN = io_in_2_valid | io_in_3_valid;
  wire _GEN_0 = io_in_0_valid | ~io_in_1_valid;
  wire _GEN_1 = io_in_0_valid | io_in_1_valid | io_in_2_valid | ~io_in_3_valid;
  wire _io_out_valid_T = io_in_0_valid | io_in_1_valid | io_in_2_valid | io_in_3_valid;
  ...
  assign io_out_bits_miss_id = _GEN_0 ? 4'h0 : io_in_1_bits_miss_id;
  assign io_out_bits_occupy_way = _GEN_0 ? 4'h0 : io_in_1_bits_occupy_way;
  ...
  assign io_out_bits_source =
    io_in_0_valid
      ...
      : io_in_1_valid
          ? io_in_1_bits_source
          : io_in_2_valid ? 4'h3 : io_in_3_valid ? 4'h1 : 4'h2;
  assign io_out_bits_cmd =
    io_in_0_valid
      ? 5'h0
      : io_in_1_valid
          ? io_in_1_bits_cmd
          : io_in_2_valid ? 5'h2 : io_in_3_valid ? 5'h1 : io_in_4_bits_cmd;
  assign io_out_bits_vaddr =
    io_in_0_valid
      ...
      : io_in_1_valid
          ...
          : io_in_2_valid
              ? io_in_2_bits_vaddr
              : io_in_3_valid ? io_in_3_bits_vaddr : io_in_4_bits_vaddr;
  ...
  assign io_out_bits_store_data = _GEN_1 ? 512'h0 : io_in_3_bits_store_data;
  assign io_out_bits_store_mask = _GEN_1 ? 64'h0 : io_in_3_bits_store_mask;
  assign io_out_bits_word_idx =
    io_in_0_valid
      ? 3'h0
      : io_in_1_valid ? io_in_1_bits_word_idx : _GEN ? 3'h0 : io_in_4_bits_word_idx;
  assign io_out_bits_amo_data =
    io_in_0_valid
      ? 128'h0
      : io_in_1_valid ? io_in_1_bits_amo_data : _GEN ? 128'h0 : io_in_4_bits_amo_data;
  assign io_out_bits_amo_mask =
    io_in_0_valid
      ? 16'h0
      : io_in_1_valid ? io_in_1_bits_amo_mask : _GEN ? 16'h0 : io_in_4_bits_amo_mask;
  assign io_out_bits_amo_cmp =
    io_in_0_valid
      ? 128'h0
      : io_in_1_valid ? io_in_1_bits_amo_cmp : _GEN ? 128'h0 : io_in_4_bits_amo_cmp;
  assign io_out_bits_pf_source =
    io_in_0_valid
      ? 3'h0
      : io_in_1_valid
          ? io_in_1_bits_pf_source
          : io_in_2_valid ? io_in_2_bits_pf_source : 3'h0;
  ...
  assign io_out_bits_id =
    io_in_0_valid
      ...
      : io_in_1_valid
          ? io_in_1_bits_id
          : io_in_2_valid | ~io_in_3_valid ? 6'h0 : io_in_3_bits_id;
endmodule
