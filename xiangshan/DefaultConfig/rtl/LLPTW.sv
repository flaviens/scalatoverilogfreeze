  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        mem_refill_id = _RANDOM[8'h90][2:0];
        io_perf_0_value_REG = _RANDOM[8'h90][3];
        io_perf_0_value_REG_1 = _RANDOM[8'h90][4];
        io_perf_1_value_REG = _RANDOM[8'h90][5];
        io_perf_1_value_REG_1 = _RANDOM[8'h90][6];
        io_perf_2_value_REG = _RANDOM[8'h90][7];
        io_perf_2_value_REG_1 = _RANDOM[8'h90][8];
        io_perf_3_value_REG = _RANDOM[8'h90][11:9];
        io_perf_3_value_REG_1 = _RANDOM[8'h90][14:12];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        entries_0_req_info_vpn = 38'h0;
        entries_0_req_info_s2xlate = 2'h0;
