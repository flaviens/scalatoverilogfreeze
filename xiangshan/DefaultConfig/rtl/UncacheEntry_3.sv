  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_nc = _RANDOM[7'h30][13];
        req_mmio = _RANDOM[7'h30][14];
        req_memBackTypeMM = _RANDOM[7'h30][15];
        req_isHyper = _RANDOM[7'h30][16];
        req_isForVSnonLeafPTE = _RANDOM[7'h30][17];
        slaveAccept = _RANDOM[7'h45][15];
        slaveId = _RANDOM[7'h45][19:16];
        uncacheState = _RANDOM[7'h45][22:20];
        uncacheData = {_RANDOM[7'h45][31:23], _RANDOM[7'h46], _RANDOM[7'h47][22:0]};
        nderr = _RANDOM[7'h47][23];
        derr = _RANDOM[7'h47][24];
        needFlushReg = _RANDOM[7'h47][25];
        pendingPtr_next_r_flag = _RANDOM[7'h47][26];
        pendingPtr_next_r_value = {_RANDOM[7'h47][31:27], _RANDOM[7'h48][3:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        req_valid = 1'h0;
        slaveAccept = 1'h0;
