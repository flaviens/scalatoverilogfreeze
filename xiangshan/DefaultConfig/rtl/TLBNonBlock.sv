  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        readResult_lastCycleRedirect_REG_bits_level = _RANDOM[8'h34][10];
        readResult_lastCycleRedirect_REG_bits_robIdx_flag = _RANDOM[8'h34][14];
        readResult_lastCycleRedirect_REG_bits_robIdx_value = _RANDOM[8'h34][23:15];
        readResult_p_hit_last_REG_1 = _RANDOM[8'h39][18];
        readResult_p_ppn_1 = {_RANDOM[8'h39][31:19], _RANDOM[8'h3A][22:0]};
        readResult_p_pbmt_1 = _RANDOM[8'h3A][24:23];
        readResult_p_perm_1_pf = _RANDOM[8'h3A][25];
        readResult_p_perm_1_af = _RANDOM[8'h3A][26];
        readResult_p_perm_1_v = _RANDOM[8'h3A][27];
        readResult_p_perm_1_a = _RANDOM[8'h3A][29];
        readResult_p_perm_1_u = _RANDOM[8'h3A][31];
        readResult_p_perm_1_x = _RANDOM[8'h3B][0];
        readResult_p_perm_1_w = _RANDOM[8'h3B][1];
        readResult_p_perm_1_r = _RANDOM[8'h3B][2];
        readResult_p_gvpn_1 = {_RANDOM[8'h3B][31:3], _RANDOM[8'h3C][14:0]};
        readResult_p_g_pbmt_1 = _RANDOM[8'h3C][16:15];
        readResult_p_g_perm_1_pf = _RANDOM[8'h3C][17];
        readResult_p_g_perm_1_af = _RANDOM[8'h3C][18];
        readResult_p_g_perm_1_a = _RANDOM[8'h3C][21];
        readResult_p_g_perm_1_x = _RANDOM[8'h3C][24];
        readResult_p_g_perm_1_r = _RANDOM[8'h3C][26];
        readResult_p_s2xlate_1 = _RANDOM[8'h3C][28:27];
        readResult_p_s1_level_1 = _RANDOM[8'h3C][30:29];
        readResult_p_s1_isLeaf_1 = _RANDOM[8'h3C][31];
        readResult_p_s1_isFakePte_1 = _RANDOM[8'h3D][0];
        readResult_lastCycleRedirect_REG_1_valid = _RANDOM[8'h3D][1];
        readResult_lastCycleRedirect_REG_1_bits_level = _RANDOM[8'h40][25];
        readResult_lastCycleRedirect_REG_1_bits_robIdx_flag = _RANDOM[8'h40][29];
        readResult_lastCycleRedirect_REG_1_bits_robIdx_value =
          {_RANDOM[8'h40][31:30], _RANDOM[8'h41][6:0]};
        readResult_p_hit_last_REG_2 = _RANDOM[8'h46][1];
        readResult_p_ppn_2 = {_RANDOM[8'h46][31:2], _RANDOM[8'h47][5:0]};
        readResult_p_pbmt_2 = _RANDOM[8'h47][7:6];
        readResult_p_perm_2_pf = _RANDOM[8'h47][8];
        readResult_p_perm_2_af = _RANDOM[8'h47][9];
        readResult_p_perm_2_v = _RANDOM[8'h47][10];
        readResult_p_perm_2_a = _RANDOM[8'h47][12];
        readResult_p_perm_2_u = _RANDOM[8'h47][14];
        readResult_p_perm_2_x = _RANDOM[8'h47][15];
        readResult_p_perm_2_w = _RANDOM[8'h47][16];
        readResult_p_perm_2_r = _RANDOM[8'h47][17];
        readResult_p_gvpn_2 = {_RANDOM[8'h47][31:18], _RANDOM[8'h48][29:0]};
        readResult_p_g_pbmt_2 = _RANDOM[8'h48][31:30];
        readResult_p_g_perm_2_pf = _RANDOM[8'h49][0];
        readResult_p_g_perm_2_af = _RANDOM[8'h49][1];
        readResult_p_g_perm_2_a = _RANDOM[8'h49][4];
        readResult_p_g_perm_2_x = _RANDOM[8'h49][7];
        readResult_p_g_perm_2_r = _RANDOM[8'h49][9];
        readResult_p_s2xlate_2 = _RANDOM[8'h49][11:10];
        readResult_p_s1_level_2 = _RANDOM[8'h49][13:12];
        readResult_p_s1_isLeaf_2 = _RANDOM[8'h49][14];
        readResult_p_s1_isFakePte_2 = _RANDOM[8'h49][15];
        readResult_lastCycleRedirect_REG_2_valid = _RANDOM[8'h49][16];
        readResult_lastCycleRedirect_REG_2_bits_level = _RANDOM[8'h4D][8];
        readResult_lastCycleRedirect_REG_2_bits_robIdx_flag = _RANDOM[8'h4D][12];
        readResult_lastCycleRedirect_REG_2_bits_robIdx_value = _RANDOM[8'h4D][21:13];
        readResult_p_hit_last_REG_3 = _RANDOM[8'h52][16];
        readResult_p_ppn_3 = {_RANDOM[8'h52][31:17], _RANDOM[8'h53][20:0]};
        readResult_p_pbmt_3 = _RANDOM[8'h53][22:21];
        readResult_p_perm_3_pf = _RANDOM[8'h53][23];
        readResult_p_perm_3_af = _RANDOM[8'h53][24];
        readResult_p_perm_3_v = _RANDOM[8'h53][25];
        readResult_p_perm_3_d = _RANDOM[8'h53][26];
        readResult_p_perm_3_a = _RANDOM[8'h53][27];
        readResult_p_perm_3_u = _RANDOM[8'h53][29];
        readResult_p_perm_3_x = _RANDOM[8'h53][30];
        readResult_p_perm_3_w = _RANDOM[8'h53][31];
        readResult_p_perm_3_r = _RANDOM[8'h54][0];
        readResult_p_g_pbmt_3 = _RANDOM[8'h55][14:13];
        readResult_p_g_perm_3_pf = _RANDOM[8'h55][15];
        readResult_p_g_perm_3_af = _RANDOM[8'h55][16];
        readResult_p_g_perm_3_d = _RANDOM[8'h55][18];
        readResult_p_g_perm_3_a = _RANDOM[8'h55][19];
        readResult_p_g_perm_3_x = _RANDOM[8'h55][22];
        readResult_p_g_perm_3_w = _RANDOM[8'h55][23];
        readResult_p_g_perm_3_r = _RANDOM[8'h55][24];
        readResult_lastCycleRedirect_REG_3_valid = _RANDOM[8'h55][31];
        readResult_lastCycleRedirect_REG_3_bits_level = _RANDOM[8'h59][23];
        readResult_lastCycleRedirect_REG_3_bits_robIdx_flag = _RANDOM[8'h59][27];
        readResult_lastCycleRedirect_REG_3_bits_robIdx_value =
          {_RANDOM[8'h59][31:28], _RANDOM[8'h5A][4:0]};
        noTranslateReg = _RANDOM[8'h5E][31];
        REG = _RANDOM[8'h5F][0];
        io_requestor_0_resp_bits_excp_0_pf_ld_REG = _RANDOM[8'h5F][1];
        io_requestor_0_resp_bits_excp_0_pf_st_REG = _RANDOM[8'h5F][2];
        io_requestor_0_resp_bits_excp_0_gpf_ld_REG = _RANDOM[8'h5F][3];
        io_requestor_0_resp_bits_excp_0_gpf_st_REG = _RANDOM[8'h5F][4];
        io_requestor_0_resp_bits_excp_0_af_ld_REG = _RANDOM[8'h5F][5];
        io_requestor_0_resp_bits_excp_0_af_st_REG = _RANDOM[8'h5F][6];
        REG_1 = _RANDOM[8'h5F][7];
        noTranslateReg_1 = _RANDOM[8'h5F][14];
        REG_2 = _RANDOM[8'h5F][15];
        io_requestor_1_resp_bits_excp_0_pf_ld_REG = _RANDOM[8'h5F][16];
        io_requestor_1_resp_bits_excp_0_gpf_ld_REG = _RANDOM[8'h5F][18];
        io_requestor_1_resp_bits_excp_0_af_ld_REG = _RANDOM[8'h5F][20];
        REG_3 = _RANDOM[8'h5F][22];
        noTranslateReg_2 = _RANDOM[8'h5F][29];
        REG_4 = _RANDOM[8'h5F][30];
        io_requestor_2_resp_bits_excp_0_pf_ld_REG = _RANDOM[8'h5F][31];
        io_requestor_2_resp_bits_excp_0_gpf_ld_REG = _RANDOM[8'h60][1];
        io_requestor_2_resp_bits_excp_0_af_ld_REG = _RANDOM[8'h60][3];
        REG_5 = _RANDOM[8'h60][5];
        noTranslateReg_3 = _RANDOM[8'h60][12];
        REG_6 = _RANDOM[8'h60][13];
        io_requestor_3_resp_bits_excp_0_pf_ld_REG = _RANDOM[8'h60][14];
        io_requestor_3_resp_bits_excp_0_gpf_ld_REG = _RANDOM[8'h60][16];
        io_requestor_3_resp_bits_excp_0_gpf_st_REG = _RANDOM[8'h60][17];
        io_requestor_3_resp_bits_excp_0_af_ld_REG = _RANDOM[8'h60][18];
        REG_7 = _RANDOM[8'h60][20];
        ptw_resp_bits_reg_s2xlate = _RANDOM[8'h60][28:27];
        ptw_resp_bits_reg_s1_entry_tag = {_RANDOM[8'h60][31:29], _RANDOM[8'h61]};
        ptw_resp_bits_reg_s1_entry_asid = _RANDOM[8'h62][15:0];
        ptw_resp_bits_reg_s1_entry_vmid = _RANDOM[8'h62][29:16];
        ptw_resp_bits_reg_s1_entry_n = _RANDOM[8'h62][30];
        ptw_resp_bits_reg_s1_entry_perm_g = _RANDOM[8'h63][3];
        ptw_resp_bits_reg_s1_entry_level = _RANDOM[8'h63][9:8];
        ptw_resp_bits_reg_s1_addr_low = _RANDOM[8'h64][23:21];
        ptw_resp_bits_reg_s1_valididx_0 = _RANDOM[8'h65][16];
        ptw_resp_bits_reg_s1_valididx_1 = _RANDOM[8'h65][17];
        ptw_resp_bits_reg_s1_valididx_2 = _RANDOM[8'h65][18];
        ptw_resp_bits_reg_s1_valididx_3 = _RANDOM[8'h65][19];
        ptw_resp_bits_reg_s1_valididx_4 = _RANDOM[8'h65][20];
        ptw_resp_bits_reg_s1_valididx_5 = _RANDOM[8'h65][21];
        ptw_resp_bits_reg_s1_valididx_6 = _RANDOM[8'h65][22];
        ptw_resp_bits_reg_s1_valididx_7 = _RANDOM[8'h65][23];
        ptw_resp_bits_reg_s2_entry_tag = {_RANDOM[8'h66][31:2], _RANDOM[8'h67][7:0]};
        ptw_resp_bits_reg_s2_entry_vmid = {_RANDOM[8'h67][31:24], _RANDOM[8'h68][5:0]};
        ptw_resp_bits_reg_s2_entry_n = _RANDOM[8'h68][6];
        ptw_resp_bits_reg_s2_entry_level = _RANDOM[8'h69][23:22];
        ptw_already_back_last_REG = _RANDOM[8'h6A][6];
        last_REG = _RANDOM[8'h6A][7];
        ptw_resp_bits_reg_1_s2xlate = _RANDOM[8'h6A][9:8];
        ptw_resp_bits_reg_1_s1_entry_tag = {_RANDOM[8'h6A][31:10], _RANDOM[8'h6B][12:0]};
        ptw_resp_bits_reg_1_s1_entry_asid = _RANDOM[8'h6B][28:13];
        ptw_resp_bits_reg_1_s1_entry_vmid = {_RANDOM[8'h6B][31:29], _RANDOM[8'h6C][10:0]};
        ptw_resp_bits_reg_1_s1_entry_n = _RANDOM[8'h6C][11];
        ptw_resp_bits_reg_1_s1_entry_perm_g = _RANDOM[8'h6C][16];
        ptw_resp_bits_reg_1_s1_entry_level = _RANDOM[8'h6C][22:21];
        ptw_resp_bits_reg_1_s1_addr_low = _RANDOM[8'h6E][4:2];
        ptw_resp_bits_reg_1_s1_valididx_0 = _RANDOM[8'h6E][29];
        ptw_resp_bits_reg_1_s1_valididx_1 = _RANDOM[8'h6E][30];
        ptw_resp_bits_reg_1_s1_valididx_2 = _RANDOM[8'h6E][31];
        ptw_resp_bits_reg_1_s1_valididx_3 = _RANDOM[8'h6F][0];
        ptw_resp_bits_reg_1_s1_valididx_4 = _RANDOM[8'h6F][1];
        ptw_resp_bits_reg_1_s1_valididx_5 = _RANDOM[8'h6F][2];
        ptw_resp_bits_reg_1_s1_valididx_6 = _RANDOM[8'h6F][3];
        ptw_resp_bits_reg_1_s1_valididx_7 = _RANDOM[8'h6F][4];
        ptw_resp_bits_reg_1_s2_entry_tag = {_RANDOM[8'h6F][31:15], _RANDOM[8'h70][20:0]};
        ptw_resp_bits_reg_1_s2_entry_vmid = _RANDOM[8'h71][18:5];
        ptw_resp_bits_reg_1_s2_entry_n = _RANDOM[8'h71][19];
        ptw_resp_bits_reg_1_s2_entry_level = _RANDOM[8'h73][4:3];
        ptw_already_back_last_REG_1 = _RANDOM[8'h73][19];
        last_REG_1 = _RANDOM[8'h73][20];
        ptw_resp_bits_reg_2_s2xlate = _RANDOM[8'h73][22:21];
        ptw_resp_bits_reg_2_s1_entry_tag = {_RANDOM[8'h73][31:23], _RANDOM[8'h74][25:0]};
        ptw_resp_bits_reg_2_s1_entry_asid = {_RANDOM[8'h74][31:26], _RANDOM[8'h75][9:0]};
        ptw_resp_bits_reg_2_s1_entry_vmid = _RANDOM[8'h75][23:10];
        ptw_resp_bits_reg_2_s1_entry_n = _RANDOM[8'h75][24];
        ptw_resp_bits_reg_2_s1_entry_perm_g = _RANDOM[8'h75][29];
        ptw_resp_bits_reg_2_s1_entry_level = _RANDOM[8'h76][3:2];
        ptw_resp_bits_reg_2_s1_addr_low = _RANDOM[8'h77][17:15];
        ptw_resp_bits_reg_2_s1_valididx_0 = _RANDOM[8'h78][10];
        ptw_resp_bits_reg_2_s1_valididx_1 = _RANDOM[8'h78][11];
        ptw_resp_bits_reg_2_s1_valididx_2 = _RANDOM[8'h78][12];
        ptw_resp_bits_reg_2_s1_valididx_3 = _RANDOM[8'h78][13];
        ptw_resp_bits_reg_2_s1_valididx_4 = _RANDOM[8'h78][14];
        ptw_resp_bits_reg_2_s1_valididx_5 = _RANDOM[8'h78][15];
        ptw_resp_bits_reg_2_s1_valididx_6 = _RANDOM[8'h78][16];
        ptw_resp_bits_reg_2_s1_valididx_7 = _RANDOM[8'h78][17];
        ptw_resp_bits_reg_2_s2_entry_tag =
          {_RANDOM[8'h78][31:28], _RANDOM[8'h79], _RANDOM[8'h7A][1:0]};
        ptw_resp_bits_reg_2_s2_entry_vmid = _RANDOM[8'h7A][31:18];
        ptw_resp_bits_reg_2_s2_entry_n = _RANDOM[8'h7B][0];
        ptw_resp_bits_reg_2_s2_entry_level = _RANDOM[8'h7C][17:16];
        ptw_already_back_last_REG_2 = _RANDOM[8'h7D][0];
        last_REG_2 = _RANDOM[8'h7D][1];
        ptw_resp_bits_reg_3_s2xlate = _RANDOM[8'h7D][3:2];
        ptw_resp_bits_reg_3_s1_entry_tag = {_RANDOM[8'h7D][31:4], _RANDOM[8'h7E][6:0]};
        ptw_resp_bits_reg_3_s1_entry_asid = _RANDOM[8'h7E][22:7];
        ptw_resp_bits_reg_3_s1_entry_vmid = {_RANDOM[8'h7E][31:23], _RANDOM[8'h7F][4:0]};
        ptw_resp_bits_reg_3_s1_entry_n = _RANDOM[8'h7F][5];
        ptw_resp_bits_reg_3_s1_entry_perm_g = _RANDOM[8'h7F][10];
        ptw_resp_bits_reg_3_s1_entry_level = _RANDOM[8'h7F][16:15];
        ptw_resp_bits_reg_3_s1_addr_low = _RANDOM[8'h80][30:28];
        ptw_resp_bits_reg_3_s1_valididx_0 = _RANDOM[8'h81][23];
        ptw_resp_bits_reg_3_s1_valididx_1 = _RANDOM[8'h81][24];
        ptw_resp_bits_reg_3_s1_valididx_2 = _RANDOM[8'h81][25];
        ptw_resp_bits_reg_3_s1_valididx_3 = _RANDOM[8'h81][26];
        ptw_resp_bits_reg_3_s1_valididx_4 = _RANDOM[8'h81][27];
        ptw_resp_bits_reg_3_s1_valididx_5 = _RANDOM[8'h81][28];
        ptw_resp_bits_reg_3_s1_valididx_6 = _RANDOM[8'h81][29];
        ptw_resp_bits_reg_3_s1_valididx_7 = _RANDOM[8'h81][30];
        ptw_resp_bits_reg_3_s2_entry_tag = {_RANDOM[8'h82][31:9], _RANDOM[8'h83][14:0]};
        ptw_resp_bits_reg_3_s2_entry_vmid = {_RANDOM[8'h83][31], _RANDOM[8'h84][12:0]};
        ptw_resp_bits_reg_3_s2_entry_n = _RANDOM[8'h84][13];
        ptw_resp_bits_reg_3_s2_entry_level = _RANDOM[8'h85][30:29];
        ptw_already_back_last_REG_3 = _RANDOM[8'h86][13];
        result_ok_last_REG = _RANDOM[8'h86][15];
        result_ok_last_REG_1 = _RANDOM[8'h86][16];
        result_ok_last_REG_2 = _RANDOM[8'h86][17];
        result_ok_last_REG_3 = _RANDOM[8'h86][18];
        io_perf_0_value_REG = _RANDOM[8'h86][21:19];
        io_perf_0_value_REG_1 = _RANDOM[8'h86][24:22];
        io_perf_1_value_REG = _RANDOM[8'h86][27:25];
        io_perf_1_value_REG_1 = _RANDOM[8'h86][30:28];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        req_out_v_0 = 1'h0;
        req_out_v_1 = 1'h0;
