...
module SRAMTemplate_36(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        respReg = _RANDOM[4'h4][6];
        rdata_last_REG = _RANDOM[4'h8][7];
        rdata_hold_data_0 = {_RANDOM[4'h8][31:8], _RANDOM[4'h9]};
        rdata_hold_data_1 = {_RANDOM[4'hA], _RANDOM[4'hB][23:0]};
        rdataReg =
          {_RANDOM[4'hB][31:24],
           _RANDOM[4'hC],
           _RANDOM[4'hD],
  ...
  sram_array_1p64x112m56s1h0l1b_bpu_abtb array (
