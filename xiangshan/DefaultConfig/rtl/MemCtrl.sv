  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        lfst_io_redirect_REG_bits_level = _RANDOM[5'hF][7];
        lfst_io_redirect_REG_bits_robIdx_flag = _RANDOM[5'hF][11];
        lfst_io_redirect_REG_bits_robIdx_value = _RANDOM[5'hF][20:12];
        REG_0_valid = _RANDOM[5'h14][6];
        REG_0_bits_robIdx_value = _RANDOM[5'h14][16:8];
        REG_0_bits_ssid = _RANDOM[5'h14][22:17];
        REG_0_bits_storeSetHit = _RANDOM[5'h14][23];
        REG_1_valid = _RANDOM[5'h14][24];
        REG_1_bits_robIdx_value = {_RANDOM[5'h14][31:26], _RANDOM[5'h15][2:0]};
        REG_1_bits_ssid = _RANDOM[5'h15][8:3];
        REG_1_bits_storeSetHit = _RANDOM[5'h15][9];
        lfst_io_csrCtrl_REG_lvpred_disable = _RANDOM[5'h16][11];
        lfst_io_csrCtrl_REG_no_spec_load = _RANDOM[5'h16][12];
        lfst_io_csrCtrl_REG_storeset_wait_store = _RANDOM[5'h16][13];
      `endif // RANDOMIZE_REG_INIT
    end // initial
