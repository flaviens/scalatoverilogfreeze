  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uopq_mBIndex = _RANDOM[7'h3B][23:20];
        uopq_alignedType = _RANDOM[7'h3B][26:24];
        uopq_indexVlMaxInVd = {_RANDOM[7'h3B][31:27], _RANDOM[7'h3C][2:0]};
        uopq_usLowBitsAddr = _RANDOM[7'h3C][6:3];
        uopq_usAligned128 = _RANDOM[7'h3C][7];
        uopq_usMask = {_RANDOM[7'h3C][31:8], _RANDOM[7'h3D][7:0]};
        allocated = _RANDOM[7'h3D][8];
        splitIdx = _RANDOM[7'h3D][13:9];
        strideOffsetReg =
          {_RANDOM[7'h3D][31:14],
           _RANDOM[7'h3E],
           _RANDOM[7'h3F],
