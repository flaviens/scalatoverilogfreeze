  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        bits_1_robIdx_value = _RANDOM[6'h7][27:22];
        bits_1_pdest = _RANDOM[6'h8][9:2];
        bits_1_rfWen = _RANDOM[6'h8][15];
        bits_1_vecWen = _RANDOM[6'h8][17];
        bits_1_v0Wen = _RANDOM[6'h8][18];
        bits_1_loadDependency_0 = _RANDOM[6'hB][2:1];
        bits_1_loadDependency_1 = _RANDOM[6'hB][4:3];
        bits_1_loadDependency_2 = _RANDOM[6'hB][6:5];
        bits_2_is0Lat = _RANDOM[6'h10][20];
        bits_2_robIdx_flag = _RANDOM[6'h12][25];
        bits_2_robIdx_value = _RANDOM[6'h12][31:26];
        bits_2_pdest = _RANDOM[6'h13][13:6];
        bits_2_rfWen = _RANDOM[6'h13][19];
        bits_2_vecWen = _RANDOM[6'h13][21];
        bits_2_v0Wen = _RANDOM[6'h13][22];
        bits_2_loadDependency_0 = _RANDOM[6'h16][6:5];
        bits_2_loadDependency_1 = _RANDOM[6'h16][8:7];
        bits_2_loadDependency_2 = _RANDOM[6'h16][10:9];
        bits_3_is0Lat = _RANDOM[6'h1B][24];
        bits_3_robIdx_flag = _RANDOM[6'h1D][29];
        bits_3_robIdx_value = {_RANDOM[6'h1D][31:30], _RANDOM[6'h1E][3:0]};
        bits_3_pdest = _RANDOM[6'h1E][17:10];
        bits_3_rfWen = _RANDOM[6'h1E][23];
        bits_3_vecWen = _RANDOM[6'h1E][25];
        bits_3_v0Wen = _RANDOM[6'h1E][26];
        bits_3_loadDependency_0 = _RANDOM[6'h21][10:9];
        bits_3_loadDependency_1 = _RANDOM[6'h21][12:11];
        bits_3_loadDependency_2 = _RANDOM[6'h21][14:13];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_1 = 1'h0;
        valids_2 = 1'h0;
