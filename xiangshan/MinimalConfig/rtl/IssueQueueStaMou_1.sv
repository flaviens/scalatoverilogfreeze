...
module IssueQueueStaMou_1(
  ...
  always @(posedge clock) begin
    ...
    io_wakeupToLRQ_0_valid_REG <= io_deqDelay_0_ready & deqDelay_0_valid;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        deqDelay_0_bits_rfWen = _RANDOM[2'h2][14];
        deqDelay_0_bits_pdest = _RANDOM[2'h2][20:15];
        deqDelay_0_bits_ftqIdx_value = _RANDOM[2'h2][24:22];
        deqDelay_0_bits_ftqOffset = _RANDOM[2'h2][28:25];
        deqDelay_0_bits_dataSources_0_value = {_RANDOM[2'h2][31:29], _RANDOM[2'h3][0]};
        deqDelay_0_bits_exuSources_0_value = _RANDOM[2'h3][4:1];
        deqDelay_0_bits_loadDependency_0 = _RANDOM[2'h3][6:5];
        deqDelay_0_bits_loadDependency_1 = _RANDOM[2'h3][8:7];
        deqDelay_0_bits_loadDependency_2 = _RANDOM[2'h3][10:9];
        io_wakeupToLRQ_0_valid_REG = _RANDOM[2'h3][11];
        io_wakeupToLRQ_0_bits_sqIdx_REG_first_flag = _RANDOM[2'h3][12];
        io_wakeupToLRQ_0_bits_sqIdx_REG_second_flag = _RANDOM[2'h3][13];
        io_wakeupToLRQ_0_bits_sqIdx_REG_value = _RANDOM[2'h3][17:14];
