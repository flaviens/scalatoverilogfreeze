  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_robIdx_flag = _RANDOM[/*Zero width*/ 1'b0][1];
        data_robIdx_value = _RANDOM[/*Zero width*/ 1'b0][7:2];
        data_exceptionVec_19 = _RANDOM[/*Zero width*/ 1'b0][10];
        data_exceptionVec_7 = _RANDOM[/*Zero width*/ 1'b0][13];
        data_debugInfo_isMMIO = _RANDOM[/*Zero width*/ 1'b0][29];
        data_debugInfo_isNCIO = _RANDOM[/*Zero width*/ 1'b0][30];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
