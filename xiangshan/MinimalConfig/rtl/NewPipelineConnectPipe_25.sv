  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_vaddr = {_RANDOM[6'h28][31:26], _RANDOM[6'h29], _RANDOM[6'h2A][11:0]};
        data_fullva = {_RANDOM[6'h2A][31:12], _RANDOM[6'h2B], _RANDOM[6'h2C][11:0]};
        data_size = _RANDOM[6'h2C][14:12];
        data_mask = _RANDOM[6'h2C][30:15];
        data_elemIdx = {_RANDOM[6'h2C][31], _RANDOM[6'h2D][6:0]};
        data_mbIndex = _RANDOM[6'h2D][10:7];
        data_regOffset = _RANDOM[6'h2D][14:11];
        data_elemIdxInsideVd = _RANDOM[6'h2D][22:15];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
