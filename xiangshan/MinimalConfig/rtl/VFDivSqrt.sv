  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        outCtrl_r_vpu_vma = _RANDOM[5'h1][2];
        outCtrl_r_vpu_vta = _RANDOM[5'h1][3];
        outCtrl_r_vpu_vsew = _RANDOM[5'h1][5:4];
        outCtrl_r_vpu_vlmul = _RANDOM[5'h1][8:6];
        outCtrl_r_vpu_vm = _RANDOM[5'h1][17];
        outCtrl_r_vpu_vstart = _RANDOM[5'h1][25:18];
        outCtrl_r_vpu_vuopIdx = _RANDOM[5'h2][12:6];
        outCtrl_r_vpu_isNarrow = _RANDOM[5'h6][29];
        outCtrl_r_vpu_isDstMask = _RANDOM[5'h6][30];
        outData_r_src_3 =
          {_RANDOM[5'h7][31:24],
           _RANDOM[5'h8],
           _RANDOM[5'h9],
        ...
        outData_r_src_2 =
          {_RANDOM[5'hB][31:24],
           ...
           _RANDOM[5'hE],
           _RANDOM[5'hF][23:0]};
        outData_r_vl = _RANDOM[5'h17][31:24];
        io_out_bits_ctrl_toRobValid_r = _RANDOM[5'h1C][0];
        io_out_bits_ctrl_robIdx_r_flag = _RANDOM[5'h1C][1];
        io_out_bits_ctrl_robIdx_r_value = _RANDOM[5'h1C][7:2];
        ...
        io_out_bits_ctrl_fpu_r_wflags = _RANDOM[5'h1C][18];
      `endif // RANDOMIZE_REG_INIT
    end // initial
