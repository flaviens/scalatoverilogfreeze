  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        enqDelayValidReg_last_REG = _RANDOM[4'h6][31];
        io_commonOut_entry_bits_payload_og1Payload_REG_fuOpType = _RANDOM[4'h7][8:0];
        io_commonOut_entry_bits_payload_og1Payload_REG_selImm = _RANDOM[4'h7][12:9];
        io_commonOut_entry_bits_payload_og1Payload_REG_imm =
          {_RANDOM[4'h7][31:13], _RANDOM[4'h8][12:0]};
        io_commonOut_entry_bits_status_srcStatus_0_psrc_REG = _RANDOM[4'h8][18:13];
        io_commonOut_entry_bits_status_srcStatus_1_psrc_REG = _RANDOM[4'h8][24:19];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validReg_last_REG = 1'h0;
        enqDelayValidReg_last_REG = 1'h0;
