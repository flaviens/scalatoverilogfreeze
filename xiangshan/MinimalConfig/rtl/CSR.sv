  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        robIdxReg_value = _RANDOM[4'h2][18:13];
        trapInstMod_io_fromDecode_trapInstInfo_next_valid_last_REG = _RANDOM[4'h2][19];
        trapInstMod_io_fromDecode_trapInstInfo_next_bits_r_instr =
          {_RANDOM[4'h2][31:20], _RANDOM[4'h3][19:0]};
        trapInstMod_io_fromDecode_trapInstInfo_next_bits_r_ftqPtr_flag =
          _RANDOM[4'h3][20];
        trapInstMod_io_fromDecode_trapInstInfo_next_bits_r_ftqPtr_value =
          _RANDOM[4'h3][23:21];
        ...
        trapInstMod_io_faultCsrUop_bits_fuOpType_r =
          {_RANDOM[4'h3][31:28], _RANDOM[4'h4][4:0]};
        trapInstMod_io_faultCsrUop_bits_imm_r =
          {_RANDOM[4'h4][31:5], _RANDOM[4'h5], _RANDOM[4'h6][4:0]};
        trapInstMod_io_faultCsrUop_bits_ftqInfo_ftqPtr_r_flag = _RANDOM[4'h6][5];
        trapInstMod_io_faultCsrUop_bits_ftqInfo_ftqPtr_r_value = _RANDOM[4'h6][8:6];
        trapInstMod_io_faultCsrUop_bits_ftqInfo_ftqOffset_r = _RANDOM[4'h6][12:9];
        exceptionVec_3_r = _RANDOM[4'h6][13];
        exceptionVec_11_r = _RANDOM[4'h6][14];
        exceptionVec_9_r = _RANDOM[4'h6][15];
        exceptionVec_10_r = _RANDOM[4'h6][16];
        exceptionVec_8_r = _RANDOM[4'h6][17];
        tlb_priv_virt_changed_old_data = _RANDOM[4'h6][18];
        isXRetReg = _RANDOM[4'h6][19];
        io_out_bits_res_redirect_bits_ftqIdx_r_flag = _RANDOM[4'h6][20];
        io_out_bits_res_redirect_bits_ftqIdx_r_value = _RANDOM[4'h6][23:21];
        io_out_bits_res_redirect_bits_ftqOffset_r = _RANDOM[4'h6][27:24];
        rfWenReg = _RANDOM[4'h6][28];
        pdestReg = {_RANDOM[4'h6][31:29], _RANDOM[4'h7][4:0]};
        io_out_bits_ctrl_toRobValid_r = _RANDOM[4'h7][5];
        io_out_bits_ctrl_pdest_r = _RANDOM[4'h7][13:6];
        io_error_0_REG = _RANDOM[4'h7][15];
        io_error_0_REG_1 = _RANDOM[4'h7][16];
        io_csrio_isPerfCnt_r = _RANDOM[4'h7][17];
        io_csrToDecode_REG_illegalInst_sfenceVMA = _RANDOM[4'h7][18];
        io_csrToDecode_REG_illegalInst_sfencePart = _RANDOM[4'h7][19];
        io_csrToDecode_REG_illegalInst_hfenceGVMA = _RANDOM[4'h7][20];
        io_csrToDecode_REG_illegalInst_hfenceVVMA = _RANDOM[4'h7][21];
        io_csrToDecode_REG_illegalInst_hlsv = _RANDOM[4'h7][22];
        io_csrToDecode_REG_illegalInst_fsIsOff = _RANDOM[4'h7][23];
        io_csrToDecode_REG_illegalInst_vsIsOff = _RANDOM[4'h7][24];
        io_csrToDecode_REG_illegalInst_wfi = _RANDOM[4'h7][25];
        io_csrToDecode_REG_illegalInst_wrs_nto = _RANDOM[4'h7][26];
        io_csrToDecode_REG_illegalInst_frm = _RANDOM[4'h7][27];
        io_csrToDecode_REG_illegalInst_cboZ = _RANDOM[4'h7][28];
        io_csrToDecode_REG_illegalInst_cboCF = _RANDOM[4'h7][29];
        io_csrToDecode_REG_illegalInst_cboI = _RANDOM[4'h7][30];
        io_csrToDecode_REG_virtualInst_sfenceVMA = _RANDOM[4'h7][31];
        io_csrToDecode_REG_virtualInst_sfencePart = _RANDOM[4'h8][0];
        io_csrToDecode_REG_virtualInst_hfence = _RANDOM[4'h8][1];
        io_csrToDecode_REG_virtualInst_hlsv = _RANDOM[4'h8][2];
        io_csrToDecode_REG_virtualInst_wfi = _RANDOM[4'h8][3];
        io_csrToDecode_REG_virtualInst_wrs_nto = _RANDOM[4'h8][4];
        io_csrToDecode_REG_virtualInst_cboZ = _RANDOM[4'h8][5];
        io_csrToDecode_REG_virtualInst_cboCF = _RANDOM[4'h8][6];
        io_csrToDecode_REG_virtualInst_cboI = _RANDOM[4'h8][7];
        io_csrToDecode_REG_special_cboI2F = _RANDOM[4'h8][8];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        waddrReg = 12'h0;
        wdataReg = 64'h0;
