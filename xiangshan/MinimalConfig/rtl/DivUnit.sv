  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_out_bits_ctrl_toRobValid_r = _RANDOM[/*Zero width*/ 1'b0][10];
        io_out_bits_ctrl_robIdx_r_flag = _RANDOM[/*Zero width*/ 1'b0][11];
        io_out_bits_ctrl_robIdx_r_value = _RANDOM[/*Zero width*/ 1'b0][17:12];
        io_out_bits_ctrl_pdest_r = _RANDOM[/*Zero width*/ 1'b0][25:18];
        io_out_bits_ctrl_rfWen_r = _RANDOM[/*Zero width*/ 1'b0][26];
      `endif // RANDOMIZE_REG_INIT
    end // initial
