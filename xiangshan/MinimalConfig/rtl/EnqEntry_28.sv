  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        enqDelayValidReg_last_REG = _RANDOM[3'h6][20];
        io_commonOut_entry_bits_payload_og1Payload_REG_fuOpType = _RANDOM[3'h6][29:21];
        io_commonOut_entry_bits_payload_og1Payload_REG_fpu_wflags = _RANDOM[3'h6][30];
        io_commonOut_entry_bits_payload_og1Payload_REG_fpu_fmt =
          {_RANDOM[3'h6][31], _RANDOM[3'h7][0]};
        io_commonOut_entry_bits_payload_og1Payload_REG_fpu_rm = _RANDOM[3'h7][3:1];
        io_commonOut_entry_bits_status_srcStatus_0_psrc_REG = _RANDOM[3'h7][10:5];
        io_commonOut_entry_bits_status_srcStatus_1_psrc_REG = _RANDOM[3'h7][16:11];
        io_commonOut_entry_bits_status_srcStatus_2_psrc_REG = _RANDOM[3'h7][22:17];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validReg_last_REG = 1'h0;
        enqDelayValidReg_last_REG = 1'h0;
