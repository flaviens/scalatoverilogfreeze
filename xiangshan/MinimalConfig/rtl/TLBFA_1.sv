...
module TLBFA_1(
                       ...
                       : io_sfence_bits_rs2
                           ...
                           : v_0
                             & ~((_v_0_T_39 | entries_0_perm_g)
                                 ...
                                 & (~io_csr_priv_virt | _v_0_T_41)
                                 & (~(io_csr_priv_virt & ~(|entries_0_level)
                                      & ~entries_0_n) | _GEN_31) & ~entries_0_perm_g))
                  : _GEN_27 | v_0;
      v_1 <=
        hfenceg_valid
          ? (io_sfence_bits_rs2
                       ...
                       : io_sfence_bits_rs2
                           ...
                           : v_1
                             & ~((_v_1_T_39 | entries_1_perm_g)
                                 ...
                                 & (~io_csr_priv_virt | _v_1_T_41)
                                 & (~(io_csr_priv_virt & ~(|entries_1_level)
                                      & ~entries_1_n) | _GEN_33) & ~entries_1_perm_g))
                  : _GEN_28 | v_1;
      v_2 <=
        hfenceg_valid
          ? (io_sfence_bits_rs2
                       ...
                       : io_sfence_bits_rs2
                           ...
                           : v_2
                             & ~((_v_2_T_39 | entries_2_perm_g)
                                 ...
                                 & (~io_csr_priv_virt | _v_2_T_41)
                                 & (~(io_csr_priv_virt & ~(|entries_2_level)
                                      & ~entries_2_n) | _GEN_35) & ~entries_2_perm_g))
                  : _GEN_29 | v_2;
      v_3 <=
        hfenceg_valid
          ? (io_sfence_bits_rs2
                       ...
                       : io_sfence_bits_rs2
                           ...
                           : v_3
                             & ~((_v_3_T_39 | entries_3_perm_g)
                                 ...
                                 & (~io_csr_priv_virt | _v_3_T_41)
                                 & (~(io_csr_priv_virt & ~(|entries_3_level)
                                      & ~entries_3_n) | _GEN_37) & ~entries_3_perm_g))
                  : _GEN_30 | v_3;
    end
    ...
    io_w_bits_data_s2xlate != 2'h3
      ...
      : (io_w_bits_data_s1_pf | io_w_bits_data_s1_af) & ~_allStage_level_T_3
        ...
        & ~((io_w_bits_data_s1_entry_perm_r | io_w_bits_data_s1_entry_perm_x
          ...
          ? io_w_bits_data_s1_entry_level
          : s2_exception & _allStage_level_T_3 ? 2'h3 : _GEN_40[io_w_bits_data_s2xlate];
  ...
  wire [32:0]      _entries_ppn_T_3 =
    _inner_n_T_4 | _entries_ppn_T_1
      ...
      : _GEN_42[io_w_bits_data_s2_entry_level];
  wire             _GEN_43 = _inner_n_T_4 | _entries_ppn_T_1;
  wire [2:0]       _GEN_44 =
    _GEN_43 ? io_w_bits_data_s1_ppn_low_0 : _GEN_41[io_w_bits_data_s2_entry_level][2:0];
  wire [2:0]       _GEN_45 =
    _GEN_43 ? io_w_bits_data_s1_ppn_low_1 : _GEN_41[io_w_bits_data_s2_entry_level][2:0];
  wire [2:0]       _GEN_46 =
    _GEN_43 ? io_w_bits_data_s1_ppn_low_2 : _GEN_41[io_w_bits_data_s2_entry_level][2:0];
  wire [2:0]       _GEN_47 =
    _GEN_43 ? io_w_bits_data_s1_ppn_low_3 : _GEN_41[io_w_bits_data_s2_entry_level][2:0];
  wire [2:0]       _GEN_48 =
    _GEN_43 ? io_w_bits_data_s1_ppn_low_4 : _GEN_41[io_w_bits_data_s2_entry_level][2:0];
  wire [2:0]       _GEN_49 =
    _GEN_43 ? io_w_bits_data_s1_ppn_low_5 : _GEN_41[io_w_bits_data_s2_entry_level][2:0];
  wire [2:0]       _GEN_50 =
    _GEN_43 ? io_w_bits_data_s1_ppn_low_6 : _GEN_41[io_w_bits_data_s2_entry_level][2:0];
  wire [2:0]       _GEN_51 =
    _GEN_43 ? io_w_bits_data_s1_ppn_low_7 : _GEN_41[io_w_bits_data_s2_entry_level][2:0];
  wire [3:0]       _GEN_52 =
    {{io_w_bits_data_s1_entry_n & (|io_w_bits_data_s2_entry_level)
     ...
     {io_w_bits_data_s1_entry_n}};
  wire             isSuperPage = (|inner_level) | _GEN_52[io_w_bits_data_s2xlate];
  wire [7:0]       _GEN_53 = 8'h1 << io_w_bits_data_s2_entry_tag[2:0];
  wire             _GEN_54 =
    isSuperPage | (_entries_vmid_T ? _GEN_53[0] : io_w_bits_data_s1_valididx_0);
  wire             _GEN_55 =
    isSuperPage | (_entries_vmid_T ? _GEN_53[1] : io_w_bits_data_s1_valididx_1);
  wire             _GEN_56 =
    isSuperPage | (_entries_vmid_T ? _GEN_53[2] : io_w_bits_data_s1_valididx_2);
  wire             _GEN_57 =
    isSuperPage | (_entries_vmid_T ? _GEN_53[3] : io_w_bits_data_s1_valididx_3);
  wire             _GEN_58 =
    isSuperPage | (_entries_vmid_T ? _GEN_53[4] : io_w_bits_data_s1_valididx_4);
  wire             _GEN_59 =
    isSuperPage | (_entries_vmid_T ? _GEN_53[5] : io_w_bits_data_s1_valididx_5);
  wire             _GEN_60 =
    isSuperPage | (_entries_vmid_T ? _GEN_53[6] : io_w_bits_data_s1_valididx_6);
  wire             _GEN_61 =
    isSuperPage | (_entries_vmid_T ? _GEN_53[7] : io_w_bits_data_s1_valididx_7);
  wire             _GEN_62 = _entries_vmid_T ? _GEN_53[0] : io_w_bits_data_s1_pteidx_0;
  wire             _GEN_63 = _entries_vmid_T ? _GEN_53[1] : io_w_bits_data_s1_pteidx_1;
  wire             _GEN_64 = _entries_vmid_T ? _GEN_53[2] : io_w_bits_data_s1_pteidx_2;
  wire             _GEN_65 = _entries_vmid_T ? _GEN_53[3] : io_w_bits_data_s1_pteidx_3;
  wire             _GEN_66 = _entries_vmid_T ? _GEN_53[4] : io_w_bits_data_s1_pteidx_4;
  wire             _GEN_67 = _entries_vmid_T ? _GEN_53[5] : io_w_bits_data_s1_pteidx_5;
  wire             _GEN_68 = _entries_vmid_T ? _GEN_53[6] : io_w_bits_data_s1_pteidx_6;
  wire             _GEN_69 = _entries_vmid_T ? _GEN_53[7] : io_w_bits_data_s1_pteidx_7;
  ...
  always @(posedge clock) begin
    if (_GEN_27) begin
      ...
      entries_0_n <= _GEN_52[io_w_bits_data_s2xlate];
      ...
      entries_0_valididx_0 <= _GEN_54;
      entries_0_valididx_1 <= _GEN_55;
      entries_0_valididx_2 <= _GEN_56;
      entries_0_valididx_3 <= _GEN_57;
      entries_0_valididx_4 <= _GEN_58;
      entries_0_valididx_5 <= _GEN_59;
      entries_0_valididx_6 <= _GEN_60;
      entries_0_valididx_7 <= _GEN_61;
      entries_0_pteidx_0 <= _GEN_62;
      entries_0_pteidx_1 <= _GEN_63;
      entries_0_pteidx_2 <= _GEN_64;
      entries_0_pteidx_3 <= _GEN_65;
      entries_0_pteidx_4 <= _GEN_66;
      entries_0_pteidx_5 <= _GEN_67;
      entries_0_pteidx_6 <= _GEN_68;
      entries_0_pteidx_7 <= _GEN_69;
      entries_0_ppn_low_0 <= _GEN_44;
      entries_0_ppn_low_1 <= _GEN_45;
      entries_0_ppn_low_2 <= _GEN_46;
      entries_0_ppn_low_3 <= _GEN_47;
      entries_0_ppn_low_4 <= _GEN_48;
      entries_0_ppn_low_5 <= _GEN_49;
      entries_0_ppn_low_6 <= _GEN_50;
      entries_0_ppn_low_7 <= _GEN_51;
    ...
    if (_GEN_28) begin
      ...
      entries_1_n <= _GEN_52[io_w_bits_data_s2xlate];
      ...
      entries_1_valididx_0 <= _GEN_54;
      entries_1_valididx_1 <= _GEN_55;
      entries_1_valididx_2 <= _GEN_56;
      entries_1_valididx_3 <= _GEN_57;
      entries_1_valididx_4 <= _GEN_58;
      entries_1_valididx_5 <= _GEN_59;
      entries_1_valididx_6 <= _GEN_60;
      entries_1_valididx_7 <= _GEN_61;
      entries_1_pteidx_0 <= _GEN_62;
      entries_1_pteidx_1 <= _GEN_63;
      entries_1_pteidx_2 <= _GEN_64;
      entries_1_pteidx_3 <= _GEN_65;
      entries_1_pteidx_4 <= _GEN_66;
      entries_1_pteidx_5 <= _GEN_67;
      entries_1_pteidx_6 <= _GEN_68;
      entries_1_pteidx_7 <= _GEN_69;
      entries_1_ppn_low_0 <= _GEN_44;
      entries_1_ppn_low_1 <= _GEN_45;
      entries_1_ppn_low_2 <= _GEN_46;
      entries_1_ppn_low_3 <= _GEN_47;
      entries_1_ppn_low_4 <= _GEN_48;
      entries_1_ppn_low_5 <= _GEN_49;
      entries_1_ppn_low_6 <= _GEN_50;
      entries_1_ppn_low_7 <= _GEN_51;
    ...
    if (_GEN_29) begin
      ...
      entries_2_n <= _GEN_52[io_w_bits_data_s2xlate];
      ...
      entries_2_valididx_0 <= _GEN_54;
      entries_2_valididx_1 <= _GEN_55;
      entries_2_valididx_2 <= _GEN_56;
      entries_2_valididx_3 <= _GEN_57;
      entries_2_valididx_4 <= _GEN_58;
      entries_2_valididx_5 <= _GEN_59;
      entries_2_valididx_6 <= _GEN_60;
      entries_2_valididx_7 <= _GEN_61;
      entries_2_pteidx_0 <= _GEN_62;
      entries_2_pteidx_1 <= _GEN_63;
      entries_2_pteidx_2 <= _GEN_64;
      entries_2_pteidx_3 <= _GEN_65;
      entries_2_pteidx_4 <= _GEN_66;
      entries_2_pteidx_5 <= _GEN_67;
      entries_2_pteidx_6 <= _GEN_68;
      entries_2_pteidx_7 <= _GEN_69;
      entries_2_ppn_low_0 <= _GEN_44;
      entries_2_ppn_low_1 <= _GEN_45;
      entries_2_ppn_low_2 <= _GEN_46;
      entries_2_ppn_low_3 <= _GEN_47;
      entries_2_ppn_low_4 <= _GEN_48;
      entries_2_ppn_low_5 <= _GEN_49;
      entries_2_ppn_low_6 <= _GEN_50;
      entries_2_ppn_low_7 <= _GEN_51;
    ...
    if (_GEN_30) begin
      ...
      entries_3_n <= _GEN_52[io_w_bits_data_s2xlate];
      ...
      entries_3_valididx_0 <= _GEN_54;
      entries_3_valididx_1 <= _GEN_55;
      entries_3_valididx_2 <= _GEN_56;
      entries_3_valididx_3 <= _GEN_57;
      entries_3_valididx_4 <= _GEN_58;
      entries_3_valididx_5 <= _GEN_59;
      entries_3_valididx_6 <= _GEN_60;
      entries_3_valididx_7 <= _GEN_61;
      entries_3_pteidx_0 <= _GEN_62;
      entries_3_pteidx_1 <= _GEN_63;
      entries_3_pteidx_2 <= _GEN_64;
      entries_3_pteidx_3 <= _GEN_65;
      entries_3_pteidx_4 <= _GEN_66;
      entries_3_pteidx_5 <= _GEN_67;
      entries_3_pteidx_6 <= _GEN_68;
      entries_3_pteidx_7 <= _GEN_69;
      entries_3_ppn_low_0 <= _GEN_44;
      entries_3_ppn_low_1 <= _GEN_45;
      entries_3_ppn_low_2 <= _GEN_46;
      entries_3_ppn_low_3 <= _GEN_47;
      entries_3_ppn_low_4 <= _GEN_48;
      entries_3_ppn_low_5 <= _GEN_49;
      entries_3_ppn_low_6 <= _GEN_50;
      entries_3_ppn_low_7 <= _GEN_51;
