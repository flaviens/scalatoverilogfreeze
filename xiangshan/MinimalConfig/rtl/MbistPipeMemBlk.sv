...
module MbistPipeMemBlk(
  ...
  output [87:0]  toNextPipeline_0_be,
  output [7:0]   toNextPipeline_0_addr,
  output [87:0]  toNextPipeline_0_indata,
  output         toNextPipeline_0_readen,
  output [7:0]   toNextPipeline_0_addr_rd,
  input  [87:0]  toNextPipeline_0_outdata,
  ...
  output [195:0] toNextPipeline_3_indata,
  output         toNextPipeline_3_readen,
  output [2:0]   toNextPipeline_3_addr_rd,
  input  [195:0] toNextPipeline_3_outdata,
  ...
  output [3:0]   toNextPipeline_4_be,
  output [2:0]   toNextPipeline_4_addr,
  output [227:0] toNextPipeline_4_indata,
  output         toNextPipeline_4_readen,
  output [2:0]   toNextPipeline_4_addr_rd,
  input  [227:0] toNextPipeline_4_outdata
);
  ...
  wire         activated =
    ...
    & (mbist_array == 7'h0 | mbist_array == 7'h1 | mbist_array == 7'h2
       ...
       | mbist_array == 7'h42 | mbist_array == 7'h43);
  reg  [6:0]   arrayReg;
  reg          reqReg;
  reg          allReg;
  reg          wenReg;
  ...
  always @(posedge clock) begin
    if (activated)
      pipelineDataOutReg <=
        {140'h0, selected ? toNextPipeline_0_outdata : 88'h0}
        | {142'h0, selected_1 ? toNextPipeline_1_outdata : 86'h0}
        | {138'h0, selected_2 ? toNextPipeline_2_outdata : 90'h0}
        | {32'h0, selected_3 ? toNextPipeline_3_outdata : 196'h0}
        | (selected_4 ? toNextPipeline_4_outdata : 228'h0);
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        arrayReg = _RANDOM[5'h0][6:0];
        reqReg = _RANDOM[5'h0][7];
        allReg = _RANDOM[5'h0][8];
        wenReg = _RANDOM[5'h0][9];
        beReg = {_RANDOM[5'h0][31:10], _RANDOM[5'h1], _RANDOM[5'h2], _RANDOM[5'h3][1:0]};
        addrReg = _RANDOM[5'h3][9:2];
        dataInReg =
          {_RANDOM[5'h3][31:10],
           _RANDOM[5'h4],
           _RANDOM[5'h5],
           ...
           _RANDOM[5'h9],
           _RANDOM[5'hA][13:0]};
        renReg = _RANDOM[5'hA][14];
        addrRdReg = _RANDOM[5'hA][22:15];
        pipelineDataOutReg =
          {_RANDOM[5'hA][31:23],
           _RANDOM[5'hB],
           _RANDOM[5'hC],
  ...
  assign toNextPipeline_0_addr = doSpread ? addrReg : 8'h0;
  assign toNextPipeline_0_indata = dataInReg[87:0];
  assign toNextPipeline_0_readen = doSpread & renReg;
  assign toNextPipeline_0_addr_rd = doSpread ? addrRdReg : 8'h0;
  ...
  assign toNextPipeline_1_addr = doSpread_1 ? addrReg : 8'h0;
  assign toNextPipeline_1_indata = dataInReg[85:0];
  assign toNextPipeline_1_readen = doSpread_1 & renReg;
  assign toNextPipeline_1_addr_rd = doSpread_1 ? addrRdReg : 8'h0;
  ...
  assign toNextPipeline_2_be = beReg[1:0];
  ...
  assign toNextPipeline_3_indata = dataInReg[195:0];
  ...
  assign toNextPipeline_4_be = beReg[3:0];
  assign toNextPipeline_4_addr = doSpread_4 ? addrReg[2:0] : 3'h0;
  assign toNextPipeline_4_indata = dataInReg;
  assign toNextPipeline_4_readen = doSpread_4 & renReg;
  assign toNextPipeline_4_addr_rd = doSpread_4 ? addrRdReg[2:0] : 3'h0;
endmodule
