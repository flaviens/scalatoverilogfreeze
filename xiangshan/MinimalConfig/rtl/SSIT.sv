...
module SSIT(
  ...
  wire [5:0]      _data_array_io_rdata_0_ssid;
  wire [5:0]      _data_array_io_rdata_1_ssid;
  ...
  reg  [5:0]      s2_loadOldSSID;
  reg  [5:0]      s2_storeOldSSID;
  wire [5:0]      s2_ldSsidAllocate =
    s2_mempred_update_req_ldpc[5:0] ^ {2'h0, s2_mempred_update_req_ldpc[9:6]};
  wire [5:0]      s2_stSsidAllocate =
    s2_mempred_update_req_stpc[5:0] ^ {2'h0, s2_mempred_update_req_stpc[9:6]};
  wire [5:0]      s2_allocSsid =
    s2_ldSsidAllocate < s2_stSsidAllocate ? s2_ldSsidAllocate : s2_stSsidAllocate;
  wire [5:0]      s2_winnerSSID =
  ...
  wire [3:0][5:0] _GEN_5 =
    {{(&_GEN) ? s2_winnerSSID : 6'h0}, {6'h0}, {s2_stSsidAllocate}, {s2_allocSsid}};
  ...
  wire [3:0][5:0] _GEN_8 =
    {{_GEN_7 ? 6'h0 : s2_winnerSSID}, {s2_ldSsidAllocate}, {6'h0}, {s2_allocSsid}};
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        resetCounter = _RANDOM[9'h100][19:0];
        resetStepCounter = _RANDOM[9'h100][30:20];
        state = _RANDOM[9'h100][31];
        REG = _RANDOM[9'h101][4:0];
        s1_mempred_update_req_valid = _RANDOM[9'h101][5];
        s1_mempred_update_req_ldpc = _RANDOM[9'h101][27:18];
        s1_mempred_update_req_stpc = {_RANDOM[9'h101][31:28], _RANDOM[9'h102][5:0]};
        s2_mempred_update_req_valid = _RANDOM[9'h102][6];
        s2_mempred_update_req_ldpc = _RANDOM[9'h102][28:19];
        s2_mempred_update_req_stpc = {_RANDOM[9'h102][31:29], _RANDOM[9'h103][6:0]};
        s2_loadAssigned = _RANDOM[9'h103][7];
        s2_storeAssigned = _RANDOM[9'h103][8];
        s2_loadOldSSID = _RANDOM[9'h103][14:9];
        s2_storeOldSSID = _RANDOM[9'h103][20:15];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        resetCounter = 20'h0;
        resetStepCounter = 11'h0;
  ...
  SyncDataModuleTemplate__1024entry_1 data_array (
    ...
    .io_waddr_1        (data_array_io_waddr_1),
    .io_wdata_0_ssid   (s2_mempred_update_req_valid ? _GEN_5[_GEN] : 6'h0),
    .io_wdata_0_strict
      (s2_mempred_update_req_valid & ~(_GEN_0 | _GEN_1 | _GEN_2) & (&_GEN)
       & s2_loadOldSSID == s2_storeOldSSID),
    .io_wdata_1_ssid   (s2_mempred_update_req_valid ? _GEN_8[_GEN] : 6'h0)
  );
