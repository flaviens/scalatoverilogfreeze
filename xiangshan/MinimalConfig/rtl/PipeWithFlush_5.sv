  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        bits_1_robIdx_value = _RANDOM[5'h7][26:21];
        bits_1_pdest = _RANDOM[5'h8][5:0];
        bits_1_rfWen = _RANDOM[5'h8][6];
        bits_1_loadDependency_0 = _RANDOM[5'h8][24:23];
        bits_1_loadDependency_1 = _RANDOM[5'h8][26:25];
        bits_1_loadDependency_2 = _RANDOM[5'h8][28:27];
        bits_2_is0Lat = _RANDOM[5'hE][10];
        bits_2_robIdx_flag = _RANDOM[5'h10][15];
        bits_2_robIdx_value = _RANDOM[5'h10][21:16];
        bits_2_pdest = {_RANDOM[5'h10][31:27], _RANDOM[5'h11][0]};
        bits_2_rfWen = _RANDOM[5'h11][1];
        bits_2_loadDependency_0 = _RANDOM[5'h11][19:18];
        bits_2_loadDependency_1 = _RANDOM[5'h11][21:20];
        bits_2_loadDependency_2 = _RANDOM[5'h11][23:22];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_1 = 1'h0;
        valids_2 = 1'h0;
