  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        fixValidVec_1 = _RANDOM[5'hA][4];
        fireReg_last_r = _RANDOM[5'hF][6];
        outIs16bits_REG = _RANDOM[5'hF][7];
        outIs16bits = _RANDOM[5'hF][8];
        outIs32bits_REG = _RANDOM[5'hF][9];
        outIs32bits = _RANDOM[5'hF][10];
        result_r = {_RANDOM[5'hF][31:21], _RANDOM[5'h10], _RANDOM[5'h11][20:0]};
        result_r_1 = {_RANDOM[5'h11][31:21], _RANDOM[5'h12], _RANDOM[5'h13][20:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validVecThisFu_1 = 1'h0;
        validVecThisFu_2 = 1'h0;
