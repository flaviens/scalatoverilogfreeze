  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_vaddr = {_RANDOM[7'h28][31:12], _RANDOM[7'h29][29:0]};
        req_fullva = {_RANDOM[7'h29][31:30], _RANDOM[7'h2A], _RANDOM[7'h2B][29:0]};
        req_paddr = {_RANDOM[7'h2B][31:30], _RANDOM[7'h2C], _RANDOM[7'h2D][13:0]};
        req_gpaddr = {_RANDOM[7'h2D][31:14], _RANDOM[7'h2E], _RANDOM[7'h2F][13:0]};
        req_mask = _RANDOM[7'h2F][29:14];
        req_nc = _RANDOM[7'h2F][30];
        req_mmio = _RANDOM[7'h2F][31];
        req_memBackTypeMM = _RANDOM[7'h30][0];
        req_isHyper = _RANDOM[7'h30][1];
        req_isForVSnonLeafPTE = _RANDOM[7'h30][2];
        slaveAccept = _RANDOM[7'h44][26];
        slaveId = _RANDOM[7'h44][30:27];
        uncacheState = {_RANDOM[7'h44][31], _RANDOM[7'h45][1:0]};
        uncacheData = {_RANDOM[7'h45][31:2], _RANDOM[7'h46], _RANDOM[7'h47][1:0]};
        nderr = _RANDOM[7'h47][2];
        derr = _RANDOM[7'h47][3];
        needFlushReg = _RANDOM[7'h47][4];
        pendingPtr_next_r_flag = _RANDOM[7'h47][5];
        pendingPtr_next_r_value = _RANDOM[7'h47][11:6];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        req_valid = 1'h0;
        slaveAccept = 1'h0;
