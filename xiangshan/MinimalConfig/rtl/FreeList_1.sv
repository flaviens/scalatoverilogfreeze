...
module FreeList_1(
  ...
  wire [3:0]      _GEN_0 = {3'h0, freeReq_next_nextVec_0_r};
  wire [3:0]      _GEN_1 = {3'h0, io_doAllocate_0};
  wire [3:0]      _headPtrNext_new_ptr_T_1 = 4'(_GEN_1 + {headPtr_flag, headPtr_value});
  wire [3:0]      _tailPtrNext_new_ptr_T_1 = 4'({tailPtr_flag, tailPtr_value} + _GEN_0);
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      freeSlotCnt <= 4'(4'(freeSlotCnt + _GEN_0) - _GEN_1);
    end
