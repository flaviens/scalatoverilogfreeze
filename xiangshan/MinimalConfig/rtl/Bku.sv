  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        validVecThisFu_1 = _RANDOM[4'h0][0];
        validVecThisFu_2 = _RANDOM[4'h0][1];
        funcReg = _RANDOM[4'hD][30:22];
        io_out_bits_res_data_r = {_RANDOM[4'hD][31], _RANDOM[4'hE], _RANDOM[4'hF][30:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validVecThisFu_1 = 1'h0;
        validVecThisFu_2 = 1'h0;
