  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        outCtrl_r_vpu_vma = _RANDOM[5'h0][28];
        outCtrl_r_vpu_vta = _RANDOM[5'h0][29];
        outCtrl_r_vpu_vsew = _RANDOM[5'h0][31:30];
        outCtrl_r_vpu_vm = _RANDOM[5'h1][11];
        outCtrl_r_vpu_vstart = _RANDOM[5'h1][19:12];
        outCtrl_r_vpu_vuopIdx = _RANDOM[5'h2][6:0];
        outCtrl_r_vpu_isNarrow = _RANDOM[5'h6][23];
        outCtrl_r_vpu_isDstMask = _RANDOM[5'h6][24];
        outData_r_src_3 =
          {_RANDOM[5'h7][31:18],
           _RANDOM[5'h8],
           _RANDOM[5'h9],
        ...
        outData_r_src_2 =
          {_RANDOM[5'hB][31:18],
           ...
           _RANDOM[5'hE],
           _RANDOM[5'hF][17:0]};
        outData_r_vl = _RANDOM[5'h17][25:18];
        io_out_bits_ctrl_toRobValid_r = _RANDOM[5'h1B][26];
        io_out_bits_ctrl_robIdx_r_flag = _RANDOM[5'h1B][27];
        io_out_bits_ctrl_robIdx_r_value = {_RANDOM[5'h1B][31:28], _RANDOM[5'h1C][1:0]};
