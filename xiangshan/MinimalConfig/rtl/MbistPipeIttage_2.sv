  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        beReg = {_RANDOM[3'h0][31:11], _RANDOM[3'h1], _RANDOM[3'h2][18:0]};
        addrReg = _RANDOM[3'h2][26:19];
        dataInReg =
          {_RANDOM[3'h2][31:27], _RANDOM[3'h3], _RANDOM[3'h4], _RANDOM[3'h5][2:0]};
        renReg = _RANDOM[3'h5][3];
        addrRdReg = _RANDOM[3'h5][11:4];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        arrayReg = 8'h0;
        reqReg = 1'h0;
