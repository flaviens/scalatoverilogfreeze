  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        dataBuffer_preIsSplit = _RANDOM[6'h3B][20];
        dataBuffer_mBIndex = _RANDOM[6'h3B][24:21];
        dataBuffer_alignedType = _RANDOM[6'h3B][27:25];
        dataBuffer_indexVlMaxInVd = {_RANDOM[6'h3B][31:28], _RANDOM[6'h3C][3:0]};
        dataBuffer_usLowBitsAddr = _RANDOM[6'h3C][7:4];
        dataBuffer_usAligned128 = _RANDOM[6'h3C][8];
        dataBuffer_usMask = {_RANDOM[6'h3C][31:9], _RANDOM[6'h3D][8:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        state = 1'h0;
    end // initial
