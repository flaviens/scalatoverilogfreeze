  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_in_r_fof = _RANDOM[6'h37][19];
        s1_in_r_vdIdxInField = _RANDOM[6'h37][22:20];
        s1_in_r_preIsSplit = _RANDOM[6'h3B][23];
        s1_in_r_alignedType = _RANDOM[6'h3B][30:28];
        s1_in_r_indexVlMaxInVd = {_RANDOM[6'h3B][31], _RANDOM[6'h3C][6:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        s1_valid = 1'h0;
    end // initial
