...
module Ras(
  ...
  input  [3:0]  io_specIn_bits_cfiPosition,
  input  [49:0] io_specIn_bits_startPc,
  input         io_commit_valid,
  input  [2:0]  io_commit_bits_meta_ras_ssp,
  input         io_commit_bits_meta_ras_tosw_flag,
  input  [3:0]  io_commit_bits_meta_ras_tosw_value,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        redirect_next_bits_r_meta_ras_ssp = _RANDOM[4'h7][6:4];
        redirect_next_bits_r_meta_ras_sctr = _RANDOM[4'h7][9:7];
        redirect_next_bits_r_meta_ras_tosw_flag = _RANDOM[4'h7][10];
        redirect_next_bits_r_meta_ras_tosw_value = _RANDOM[4'h7][14:11];
        redirect_next_bits_r_meta_ras_tosr_flag = _RANDOM[4'h7][15];
        redirect_next_bits_r_meta_ras_tosr_value = _RANDOM[4'h7][19:16];
        redirect_next_bits_r_meta_ras_nos_flag = _RANDOM[4'h7][20];
        redirect_next_bits_r_meta_ras_nos_value = _RANDOM[4'h7][24:21];
        commitValid = _RANDOM[4'h9][10];
        commitInfo_meta_ras_ssp = _RANDOM[4'h9][13:11];
        commitInfo_meta_ras_tosw_flag = _RANDOM[4'h9][14];
        commitInfo_meta_ras_tosw_value = _RANDOM[4'h9][18:15];
        commitInfo_attribute_rasAction = _RANDOM[4'h9][22:21];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        redirect_next_valid_last_REG = 1'h0;
        commitValid = 1'h0;
