  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uopq_preIsSplit = _RANDOM[7'h3B][19];
        uopq_mBIndex = _RANDOM[7'h3B][22:20];
        uopq_alignedType = _RANDOM[7'h3B][25:23];
        uopq_indexVlMaxInVd = {_RANDOM[7'h3B][31:26], _RANDOM[7'h3C][1:0]};
        uopq_usAligned128 = _RANDOM[7'h3C][6];
        uopq_usMask = {_RANDOM[7'h3C][31:7], _RANDOM[7'h3D][6:0]};
        allocated = _RANDOM[7'h3D][7];
        splitIdx = _RANDOM[7'h3D][12:8];
        strideOffsetReg =
          {_RANDOM[7'h3D][31:13],
           _RANDOM[7'h3E],
           _RANDOM[7'h3F],
