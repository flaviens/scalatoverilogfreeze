  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        enqDelayValidReg_last_REG = _RANDOM[3'h6][23];
        io_commonOut_entry_bits_payload_og1Payload_REG_fuOpType =
          {_RANDOM[3'h6][31:24], _RANDOM[3'h7][0]};
        io_commonOut_entry_bits_payload_og1Payload_REG_fpu_wflags = _RANDOM[3'h7][1];
        io_commonOut_entry_bits_payload_og1Payload_REG_fpu_fmt = _RANDOM[3'h7][3:2];
        io_commonOut_entry_bits_payload_og1Payload_REG_fpu_rm = _RANDOM[3'h7][6:4];
        io_commonOut_entry_bits_status_srcStatus_0_psrc_REG = _RANDOM[3'h7][13:8];
        io_commonOut_entry_bits_status_srcStatus_1_psrc_REG = _RANDOM[3'h7][19:14];
        io_commonOut_entry_bits_status_srcStatus_2_psrc_REG = _RANDOM[3'h7][25:20];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validReg_last_REG = 1'h0;
        enqDelayValidReg_last_REG = 1'h0;
