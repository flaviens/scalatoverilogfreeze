...
module IttageTable_2(
  ...
  input  [7:0]  io_req_bits_foldedHist_hist_12_foldedHist,
  input  [6:0]  io_req_bits_foldedHist_hist_11_foldedHist,
  input  [5:0]  io_req_bits_foldedHist_hist_10_foldedHist,
  ...
  input  [7:0]  io_update_foldedHist_hist_12_foldedHist,
  input  [6:0]  io_update_foldedHist_hist_11_foldedHist,
  input  [5:0]  io_update_foldedHist_hist_10_foldedHist,
  ...
  input  [71:0] boreChildrenBd_bore_be,
  ...
  wire [71:0] bd_be = boreChildrenBd_bore_be;
  ...
  wire [7:0]  s0_setIdx =
    io_req_bits_startPc_addr[8:1] ^ io_req_bits_foldedHist_hist_12_foldedHist;
  ...
  wire [7:0]  ittage_write_buffer_bank1_io_write_0_bits_setIdx =
    usefulCanReset
      ? resetSet
      : io_update_startPc_addr[8:1] ^ io_update_foldedHist_hist_12_foldedHist;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_tag = _RANDOM[/*Zero width*/ 1'b0][14:8];
        s1_bankMask = _RANDOM[/*Zero width*/ 1'b0][16:15];
        s1_valid = _RANDOM[/*Zero width*/ 1'b0][17];
        needReset = _RANDOM[/*Zero width*/ 1'b0][18];
        resetSet = _RANDOM[/*Zero width*/ 1'b0][26:19];
  ...
  wire [71:0] childBd_wmask;
  wire        childBd_re;
  wire        childBd_we;
  wire        childBd_ack;
  wire        childBd_selectedOH;
  wire [7:0]  childBd_array;
  FoldedSRAMTemplate_36 ittage_table_bank0 (
    .clock                                         (clock),
    .reset                                         (reset),
  ...
  wire [71:0] childBd_1_wmask;
  wire        childBd_1_re;
  wire        childBd_1_we;
  wire        childBd_1_ack;
  wire        childBd_1_selectedOH;
  wire [7:0]  childBd_1_array;
  FoldedSRAMTemplate_37 ittage_table_bank1 (
    .clock                                         (clock),
    .reset                                         (reset),
  ...
  WriteBuffer_32 ittage_write_buffer_bank0 (
    .clock                                          (clock),
    .reset                                          (reset),
    .io_write_0_valid
  ...
  WriteBuffer_32 ittage_write_buffer_bank1 (
    .clock                                          (clock),
    .reset                                          (reset),
    .io_write_0_valid
