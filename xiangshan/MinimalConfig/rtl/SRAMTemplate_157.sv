...
module SRAMTemplate_157(
  ...
  input  [35:0] boreChildrenBd_bore_wdata,
  input  [35:0] boreChildrenBd_bore_wmask,
  input         boreChildrenBd_bore_re,
  input         boreChildrenBd_bore_we,
  output [35:0] boreChildrenBd_bore_rdata,
  ...
  wire [35:0] mbistBd_wdata = boreChildrenBd_bore_wdata;
  wire [35:0] mbistBd_wmask = boreChildrenBd_bore_wmask;
  ...
  reg  [35:0] rdataReg;
  wire [35:0] mbistBd_rdata = rdataReg;
  ...
  sram_array_1p128x36m1s1h0l1b_bpu_ittage_bank1 array (
    ...
    .RW0_wmask
      (mbistBd_ack
         ...
         : _resetState ? 36'hFFFFFFFFF : io_w_req_bits_flattened_bitmask),
    .RW0_wdata
      (mbistBd_ack ? mbistBd_wdata : _resetState ? 36'h0 : io_w_req_bits_data_0),
