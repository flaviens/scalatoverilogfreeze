...
module FreeList_5(
  ...
  wire [5:0]       deqPtr_new_value =
    6'({1'h0, headPtr_value} + {4'h0, _numAllocate_T_2});
  ...
  wire [5:0]       tailPtrNext_new_value = 6'(_GEN_0 + {3'h0, 3'(_GEN_4 + _GEN_5)});
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      freeSlotCnt <=
        5'(5'(freeSlotCnt + {2'h0, 3'(_GEN_4 + _GEN_5)}) - {3'h0, _numAllocate_T_2});
    end
  ...
  always @(posedge clock) begin
    io_allocateSlot_0_r <=
      _GEN_6[$signed(_deqPtr_diff_T_10) > -7'sh1
               ? _deqPtr_diff_T_10[4:0]
               : _deqPtr_new_ptr_value_T_1];
    io_allocateSlot_1_r <=
      _GEN_6[$signed(_deqPtr_diff_T_22) > -7'sh1
               ? _deqPtr_diff_T_22[4:0]
               : deqPtr_new_value_3[4:0]];
    io_allocateSlot_2_r <=
      _GEN_6[$signed(_deqPtr_diff_T_34) > -7'sh1
