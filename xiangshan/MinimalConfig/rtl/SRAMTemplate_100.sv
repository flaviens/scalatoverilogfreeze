...
module SRAMTemplate_100(
  ...
  input  [3:0]  io_r_req_bits_setIdx,
  ...
  input  [3:0]  io_w_req_bits_setIdx,
  ...
  output        io_resetDone,
  input  [4:0]  boreChildrenBd_bore_addr,
  input  [4:0]  boreChildrenBd_bore_addr_rd,
  ...
  wire        _rcg_out_clock;
  wire [4:0]  mbistBd_addr_rd = boreChildrenBd_bore_addr_rd;
  ...
  wire [4:0]  mbistBd_addr = boreChildrenBd_bore_addr;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        _resetSet = _RANDOM[5'h0][4:1];
        respReg = _RANDOM[5'h1][6];
        rdataReg = _RANDOM[5'h11][22:7];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        _resetState = 1'h1;
        _resetSet = 4'h0;
  ...
  sram_array_1p16x16m2s1h0l1b_bpu_tage_useful array (
