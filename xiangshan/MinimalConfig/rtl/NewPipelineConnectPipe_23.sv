  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_vaddr = {_RANDOM[6'h28][31:21], _RANDOM[6'h29], _RANDOM[6'h2A][6:0]};
        data_fullva = {_RANDOM[6'h2A][31:7], _RANDOM[6'h2B], _RANDOM[6'h2C][6:0]};
        data_size = _RANDOM[6'h2C][9:7];
        data_mask = _RANDOM[6'h2C][25:10];
        data_elemIdx = _RANDOM[6'h2E][21:14];
        data_mbIndex = _RANDOM[6'h2E][25:22];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
