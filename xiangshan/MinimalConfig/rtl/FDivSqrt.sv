  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        outCtrl_r_robIdx_value = _RANDOM[3'h0][16:11];
        outCtrl_r_fpu_fmt = _RANDOM[3'h0][28:27];
        io_out_bits_ctrl_toRobValid_r = _RANDOM[3'h7][0];
        io_out_bits_ctrl_robIdx_r_flag = _RANDOM[3'h7][1];
        io_out_bits_ctrl_robIdx_r_value = _RANDOM[3'h7][7:2];
        io_out_bits_ctrl_pdest_r = _RANDOM[3'h7][15:8];
        io_out_bits_ctrl_fpWen_r = _RANDOM[3'h7][16];
        io_out_bits_ctrl_fpu_r_wflags = _RANDOM[3'h7][17];
      `endif // RANDOMIZE_REG_INIT
    end // initial
