  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        bits_1_robIdx_value = _RANDOM[4'h9][24:19];
        bits_1_pdest = {_RANDOM[4'h9][31], _RANDOM[4'hA][4:0]};
        bits_1_fpWen = _RANDOM[4'hA][5];
        bits_1_loadDependency_0 = _RANDOM[4'hB][2:1];
        bits_1_loadDependency_1 = _RANDOM[4'hB][4:3];
        bits_1_loadDependency_2 = _RANDOM[4'hB][6:5];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valids_1 = 1'h0;
    end // initial
