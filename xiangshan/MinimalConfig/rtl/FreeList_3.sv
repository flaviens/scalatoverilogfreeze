...
module FreeList_3(
  ...
  wire [5:0]       tailPtrNext_new_value = 6'(_GEN_1 + {3'h0, 3'(_GEN_5 + _GEN_6)});
  ...
  wire [5:0]       headPtrNext_new_value = 6'(_GEN + {4'h0, _numAllocate_T_2});
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (|_doAllocate_T)
        headPtr_value <=
          headPtrNext_reverse_flag
            ? _headPtrNext_diff_T_4[4:0]
            : headPtrNext_new_value[4:0];
      ...
      freeSlotCnt <=
        5'(5'(freeSlotCnt + {2'h0, 3'(_GEN_5 + _GEN_6)}) - {3'h0, _numAllocate_T_2});
    end
