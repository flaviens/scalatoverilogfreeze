  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        fixValidVec_1 = _RANDOM[5'hA][2];
        fireReg_last_r = _RANDOM[5'hF][3];
        result_r = {_RANDOM[5'hF][31:4], _RANDOM[5'h10], _RANDOM[5'h11][3:0]};
        result_r_1 = {_RANDOM[5'h11][31:4], _RANDOM[5'h12], _RANDOM[5'h13][3:0]};
        res1H_r = _RANDOM[5'h13][6:4];
        res1H = _RANDOM[5'h13][9:7];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validVecThisFu_1 = 1'h0;
        validVecThisFu_2 = 1'h0;
