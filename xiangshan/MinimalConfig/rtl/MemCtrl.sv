...
module MemCtrl(
  ...
  input  [5:0] io_stIn_0_bits_robIdx_value,
  input  [5:0] io_stIn_0_bits_ssid,
  input        io_stIn_0_bits_storeSetHit,
  input        io_stIn_1_valid,
  input  [5:0] io_stIn_1_bits_robIdx_value,
  input  [5:0] io_stIn_1_bits_ssid,
  ...
  reg [5:0] lfst_io_redirect_REG_bits_robIdx_value;
  reg       REG_0_valid;
  reg [5:0] REG_0_bits_robIdx_value;
  reg [5:0] REG_0_bits_ssid;
  reg       REG_0_bits_storeSetHit;
  reg       REG_1_valid;
  reg [5:0] REG_1_bits_robIdx_value;
  reg [5:0] REG_1_bits_ssid;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        lfst_io_redirect_REG_bits_level = _RANDOM[5'hF][3];
        lfst_io_redirect_REG_bits_robIdx_flag = _RANDOM[5'hF][7];
        lfst_io_redirect_REG_bits_robIdx_value = _RANDOM[5'hF][13:8];
        REG_0_valid = _RANDOM[5'h13][27];
        REG_0_bits_robIdx_value = {_RANDOM[5'h13][31:29], _RANDOM[5'h14][2:0]};
        REG_0_bits_ssid = _RANDOM[5'h14][8:3];
        REG_0_bits_storeSetHit = _RANDOM[5'h14][9];
        REG_1_valid = _RANDOM[5'h14][10];
        REG_1_bits_robIdx_value = _RANDOM[5'h14][17:12];
        REG_1_bits_ssid = _RANDOM[5'h14][23:18];
        REG_1_bits_storeSetHit = _RANDOM[5'h14][24];
        lfst_io_csrCtrl_REG_lvpred_disable = _RANDOM[5'h15][26];
        lfst_io_csrCtrl_REG_no_spec_load = _RANDOM[5'h15][27];
        lfst_io_csrCtrl_REG_storeset_wait_store = _RANDOM[5'h15][28];
      `endif // RANDOMIZE_REG_INIT
    end // initial
