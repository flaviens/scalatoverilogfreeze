...
module ICacheDataBank_5(
  ...
  input  [5:0]  io_read_req_bits_setIdx_0,
  input  [5:0]  io_read_req_bits_setIdx_1,
  input  [5:0]  io_read_req_bits_setIdx_2,
  input  [5:0]  io_read_req_bits_setIdx_3,
  input  [3:0]  io_read_req_bits_waymask,
  output [63:0] io_read_resp_entries_0_data,
  output        io_read_resp_entries_0_code,
  output [63:0] io_read_resp_entries_1_data,
  output        io_read_resp_entries_1_code,
  output [63:0] io_read_resp_entries_2_data,
  output        io_read_resp_entries_2_code,
  output [63:0] io_read_resp_entries_3_data,
  output        io_read_resp_entries_3_code,
  ...
  SRAMTemplate_16 ways_0 (
    ...
    .io_r_req_bits_setIdx           (io_read_req_bits_setIdx_0),
    .io_r_resp_data_0_data          (io_read_resp_entries_0_data),
    .io_r_resp_data_0_code          (io_read_resp_entries_0_code),
  ...
  SRAMTemplate_16 ways_1 (
    ...
    .io_r_req_bits_setIdx           (io_read_req_bits_setIdx_1),
    .io_r_resp_data_0_data          (io_read_resp_entries_1_data),
    .io_r_resp_data_0_code          (io_read_resp_entries_1_code),
  ...
  SRAMTemplate_16 ways_2 (
    ...
    .io_r_req_bits_setIdx           (io_read_req_bits_setIdx_2),
    .io_r_resp_data_0_data          (io_read_resp_entries_2_data),
    .io_r_resp_data_0_code          (io_read_resp_entries_2_code),
  ...
  SRAMTemplate_16 ways_3 (
    ...
    .io_r_req_bits_setIdx           (io_read_req_bits_setIdx_3),
    .io_r_resp_data_0_data          (io_read_resp_entries_3_data),
    .io_r_resp_data_0_code          (io_read_resp_entries_3_code),
