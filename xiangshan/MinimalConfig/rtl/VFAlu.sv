      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        vs1Reg =
          {_RANDOM[6'h1C][31:7],
           ...
           _RANDOM[6'h1F],
           _RANDOM[6'h20][6:0]};
        outWiden = _RANDOM[6'h20][7];
        outVlFix = _RANDOM[6'h20][15:8];
        allVmZero = _RANDOM[6'h20][16];
        mgu_io_in_info_eew_r = _RANDOM[6'h20][18:17];
        mgu_io_in_info_vdIdx_r = _RANDOM[6'h20][25:19];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        validVecThisFu_1 = 1'h0;
    end // initial
