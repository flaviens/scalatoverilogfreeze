  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uop_ctrl_robIdx_value = _RANDOM[4'h0][19:14];
        uop_ctrl_pdest = _RANDOM[4'h0][27:20];
        uop_ctrl_flushPipe = _RANDOM[4'h0][28];
        uop_data_imm = {_RANDOM[4'h4][31:29], _RANDOM[4'h5], _RANDOM[4'h6][28:0]};
        io_fenceio_sfence_bits_addr_r =
          {_RANDOM[4'h6][31:29], _RANDOM[4'h7], _RANDOM[4'h8][28:0]};
        io_fenceio_sfence_bits_id_r =
          {_RANDOM[4'h8][31:29], _RANDOM[4'h9], _RANDOM[4'hA][28:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        state = 3'h0;
    end // initial
