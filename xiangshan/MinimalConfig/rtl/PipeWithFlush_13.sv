  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        bits_1_robIdx_value = _RANDOM[6'h9][26:21];
        bits_1_pdest = _RANDOM[6'hA][6:1];
        bits_1_fpWen = _RANDOM[6'hA][7];
        bits_1_loadDependency_0 = _RANDOM[6'hB][4:3];
        bits_1_loadDependency_1 = _RANDOM[6'hB][6:5];
        bits_1_loadDependency_2 = _RANDOM[6'hB][8:7];
        bits_2_robIdx_flag = _RANDOM[6'h14][26];
        bits_2_robIdx_value = {_RANDOM[6'h14][31:27], _RANDOM[6'h15][0]};
        bits_2_pdest = _RANDOM[6'h15][12:7];
        bits_2_fpWen = _RANDOM[6'h15][13];
        bits_2_loadDependency_0 = _RANDOM[6'h16][10:9];
        bits_2_loadDependency_1 = _RANDOM[6'h16][12:11];
        bits_2_loadDependency_2 = _RANDOM[6'h16][14:13];
        bits_3_robIdx_flag = _RANDOM[6'h20][0];
        bits_3_robIdx_value = _RANDOM[6'h20][6:1];
        bits_3_pdest = _RANDOM[6'h20][18:13];
        bits_3_fpWen = _RANDOM[6'h20][19];
        bits_3_loadDependency_0 = _RANDOM[6'h21][16:15];
        bits_3_loadDependency_1 = _RANDOM[6'h21][18:17];
        bits_3_loadDependency_2 = _RANDOM[6'h21][20:19];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_1 = 1'h0;
        valids_2 = 1'h0;
